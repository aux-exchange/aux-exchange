    ...
    66664: (e, t, s) => {
      ...
      class w {
          ...
          ;(this._symbolDataHandlers = new Map()),
            ...
            (this._quoteSessionDataHandler = (e) => {
              const t = (0, o.ensureDefined)(e.symbolname),
                { filtered: s, keepSubscription: i } = this._applyDataFilters(e)
              i || this._unsubscribeSymbols([t]), this._setSymbolDataCache(t, s)
        ...
        _setSymbolDataCache(e, t) {
          ...
          this._resolvedSymbolsSet.add(e),
            this._lastSymbolData.set(e, { ...t, values: { ...o, ...t.values } })
        }
        _applyDataFilters(e) {
      ...
      const k = new (class {
        ...
        get(e, t = 'watchlist') {
          ...
          if (o) {
            const i = o.get(t)
            i ? (s = i) : ((s = new w(e, this._lastSymbolData, t)), o.set(t, s))
          } else {
