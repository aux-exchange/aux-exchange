    ...
    52444: (t, e, s) => {
      ...
      function f(t) {
        return i.createElement('div', {
          className: r(d.fadeLeft, t.className, { [d.isVisible]: t.isVisible })
        })
      }
      function w(t) {
        return i.createElement('div', {
          className: r(d.fadeRight, t.className, { [d.isVisible]: t.isVisible })
        })
      }
      function b(t) {
      ...
      function v(t) {
        return i.createElement(
          'div',
          {
            className: r(t.className, { [d.isVisible]: t.isVisible }),
            onClick: t.onClick
          },
          i.createElement(
            'div',
            { className: d.iconWrap },
            i.createElement(l.Icon, { icon: u, className: d.icon })
          )
        )
      }
          ...
          ((u = class extends i.PureComponent {
            constructor(t) {
              super(t),
                ...
                (this._checkButtonsVisibility = () => {
                  const { isVisibleLeftButton: t, isVisibleRightButton: e } =
                      this.state,
                    s = this.isAtLeft(),
                    i = this.isAtRight()
                  s || t
            ...
            animateTo(t, e = h.dur) {
              ...
              s &&
                ((0, c.isRtl)() && (t = (0, c.getLTRScrollLeftOffset)(s, t)),
                e <= 0
            ...
            render() {
              const {
                ...
                { isVisibleRightButton: R, isVisibleLeftButton: S } =
                  this.state,
                _ = p && f
              return i.createElement(
                o,
