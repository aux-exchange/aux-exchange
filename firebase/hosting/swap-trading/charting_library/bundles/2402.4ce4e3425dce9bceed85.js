;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [2402],
  {
    ...
    90714: (t, e, i) => {
      ...
      const s = i(67294).createContext(null)
    },
    32402: (t, e, i) => {
      'use strict'
      i.d(e, { PopupDialog: () => T })
                ...
                s.createElement(
                  ...
                  s.createElement(
                    d,
                    {
                      ...
                      className: o(M.dialog, this.props.className)
                    },
                    !1,
                    this.props.children
                  )
        ...
        _applyAppearanceAnimation(t) {
          if (this._resize && this._dialog) {
            ...
            this._dialog.style.setProperty(
              ...
              this._dialog.classList.add(M.dialogAnimatedAppearance)
          }
        }
        _handleTooltipFit() {
          0
      ...
      ;(w.contextType = x.PortalContext),
        (w.defaultProps = {
          boundByScreen: !0,
          draggable: !0,
          centeredOnMount: !0
        })
      const T = (0, c.makeOverlapable)(w)
    },
    13894: (t, e, i) => {
      'use strict'
