  ...
  [9772],
  {
    ...
    46146: (e) => {
      e.exports = {
        ...
        actionHandleWrap: 'actionHandleWrap-ZzQNZGNo',
        ...
        'highlight-animation-theme-light':
          'highlight-animation-theme-light-ZzQNZGNo',
        dark: 'dark-ZzQNZGNo',
        'highlight-animation-theme-dark':
          'highlight-animation-theme-dark-ZzQNZGNo',
        markedFlag: 'markedFlag-ZzQNZGNo',
        offset: 'offset-ZzQNZGNo',
        descriptionCell: 'descriptionCell-ZzQNZGNo',
        addition: 'addition-ZzQNZGNo',
        ...
        markedFlagWrap: 'markedFlagWrap-ZzQNZGNo',
        markedFlagMobile: 'markedFlagMobile-ZzQNZGNo'
      }
    },
    39916: (e) => {
      e.exports = {
    ...
    22582: (e) => {
      e.exports = { button: 'button-P2GOgq9R', desktop: 'desktop-P2GOgq9R' }
    },
    8183: (e) => {
      e.exports = {
    ...
    68865: (e) => {
      e.exports = {
        bubbles: 'bubbles-by4sobff',
        multiLine: 'multiLine-by4sobff',
        bubble: 'bubble-by4sobff'
      }
    },
    8182: (e) => {
      e.exports = {
        ...
        'fontSize-s': 'fontSize-s-3MTPKAgt',
        'fontSize-m': 'fontSize-m-3MTPKAgt',
    ...
    47218: (e, t, n) => {
      'use strict'
      n.d(t, {
        DEFAULT_TOOL_WIDGET_BUTTON_THEME: () => i,
        ToolWidgetButton: () => c
      })
      var r = n(67294),
        o = n(94184),
      ...
      const i = s,
        c = r.forwardRef((e, t) => {
          const {
            ...
            k = o(y, v.button, g && 'apply-common-tooltip', {
              [v.isActive]: i,
              [v.isOpened]: c,
              [v.isInteractive]: (b || Boolean(m)) && !u,
              [v.isDisabled]: u,
              [v.isGrouped]: d,
              [v.hover]: p,
              [v.newStyles]: l.hasNewHeaderToolbarStyles
            }),
            E =
              n &&
              ('string' == typeof n
                ? r.createElement(a.Icon, { className: v.icon, icon: n })
                : r.cloneElement(n, {
                    className: o(v.icon, n.props.className)
                  }))
          return r.createElement(
            ...
            f &&
              ...
              r.createElement(
                'div',
                { className: o('js-button-text', v.text) },
                h
              ),
            E,
            !f &&
    ...
    19470: (e, t, n) => {
      'use strict'
      n.d(t, { hasNewHeaderToolbarStyles: () => r })
      n(27490)
      const r = !1
    },
    2710: (e, t, n) => {
    ...
    40834: (e, t, n) => {
      ...
      var r = n(67294),
        ...
        c = n(6960)
      function u(e) {
        const { children: t, renderInput: n, onCancel: o, ...u } = e
        return r.createElement(
          'div',
          ...
          t,
          r.createElement(s.Icon, { className: c.icon, icon: i }),
          o &&
            r.createElement(
              'div',
              { className: c.cancel, onClick: o },
              (0, l.t)('Cancel')
            )
        )
      }
    ...
    311: (e, t, n) => {
      'use strict'
      n.d(t, { SymbolSearchDialogContentItem: () => v })
      var r = n(67294),
        o = n(94184),
        a = n.n(o),
        l = n(16282),
      ...
      function v(e) {
        const {
          ...
          { isSmallWidth: X, isMobile: Q } = (0, l.ensureNotNull)(
            (0, r.useContext)(u.SymbolSearchItemsDialogContext)
          ),
          H = Boolean(D),
          K = !C && !M && (Q || !H),
          q =
            (0, p.useWatchedValueReadonly)({ watchedValue: m.watchedTheme }) ===
            d.StdTheme.Dark
              ? g.dark
              : g.light,
          U = D
        return r.createElement(
          ...
          r.createElement(
            'div',
            { ref: Z, className: a()(g.itemInfoCell, g.cell, w && g.offset) },
            r.createElement(
              'div',
              { className: g.actionHandleWrap },
              r.createElement(
                r.Fragment,
                null,
                !1,
                _ &&
                  r.createElement(
                    ...
                    r.createElement(s.Icon, {
                      className: a()(g.expandHandle, R && g.expanded),
                      icon: f
                    })
                  )
              )
                ...
                r.createElement(
                  'div',
                  {
                    className: a()(
                      ...
                      N && g.active,
                      C && g.invalid,
                      !Boolean(o) && g.noDescription
                    ),
                    'data-name': 'list-item-title'
                  },
                  'string' == typeof n && y
                    ? r.createElement(i.HighlightedText, {
                        className: g.highlightedText,
                        text: n,
                        queryString: y,
                        rules: (0, c.createRegExpList)(y)
                      })
                    : n,
                  E && r.createElement('span', { className: g.dataMode }, 'E')
                ),
              !n &&
                t &&
                r.createElement(
          ...
          K &&
            r.createElement(
              'div',
              { className: a()(g.exchangeCell, g.cell) },
              r.createElement(
                'div',
                { className: a()(g.exchangeDescription) },
                r.createElement(
                  'div',
                  { className: a()(g.marketType, N && g.active) },
                  x
                ),
                r.createElement(
                  'div',
                  { className: a()(g.exchangeName, N && g.active) },
                  b
                )
              ),
              !1
          ...
          r.createElement(
            'div',
            { className: a()(g.cell, Boolean(O) && g.actionsCell) },
            O
          )
        )
        function j() {
    ...
    38972: (e, t, n) => {
      'use strict'
      n.d(t, { qualifyProName: () => l, QualifiedSources: () => r })
      var r,
        o = n(16282),
        a = n(27490)
      function l(e) {
    ...
    89085: (e, t, n) => {
      'use strict'
      n.d(t, { QuoteSessionContext: () => r })
      const r = n(67294).createContext(null)
    },
    9772: (e, t, n) => {
      'use strict'
      n.d(t, { showSymbolSearchItemsDialog: () => c })
      var r = n(67294),
        o = n(73935),
        a = n(78106),
        l = n(89085),
      ...
      function c(e) {
        ...
        const I = document.createElement('div'),
          _ = r.createElement(
            ...
            { value: null != M ? M : null },
            r.createElement(
              l.QuoteSessionContext.Provider,
              { value: null },
              r.createElement(i.SymbolSearchItemsDialog, {
                onClose: R,
                initialMode: t,
                defaultValue: c,
                showSpreadActions: u,
    ...
    56161: (e, t, n) => {
      ...
      function b(e) {
        ...
        return r.createElement(
          ...
          r.createElement('div', { className: y.childrenWrapper }, t)
        )
      }
      var x = n(11945),
        S = n(65802),
      ...
      function N(e) {
        const {
          ...
          p = (0, r.useMemo)(() => (0, S.createRegExpList)(d), [d]),
          m = l && !i,
          f = a()(
            E.container,
            c ? E.mobile : E.desktop,
            s && E.selected,
            i && E.allExchange,
            i && E.libAllExchange,
            !i && c && E.bordered
        ...
        return r.createElement(
          'div',
          { className: a()(!c && E.wrap, i && E.libAllExchange), onClick: u },
          r.createElement(
            'div',
            { className: f },
            r.createElement(
              ...
              !!i &&
                r.createElement(h.Icon, {
                  className: a()(E.icon, E.allExchangesIcon),
                  icon: k
                })
            ),
            r.createElement(
              ...
              r.createElement(
                'div',
                { className: a()(E.title, !m && !c && E.titleWithoutDesc) },
                r.createElement(x.HighlightedText, {
                  className: a()(s && E.highlighted),
                  queryString: d,
                  text: o,
                  rules: p
                })
      ...
      var w = n(27278),
        ...
        R = n(67192),
        D = n(39916)
      const z = { emptyTextClassName: D.emptyText }
      function L(e) {
        const { exchanges: t } = e,
          {
            selectedExchange: n,
            ...
            emptyState: c,
            autofocus: u
          } = (0, C.useEnsuredContext)(f.SymbolSearchItemsDialogContext),
          d =
            (0, w.useWatchedValueReadonly)({ watchedValue: T.watchedTheme }) ===
            M.StdTheme.Dark
              ? _
              : R,
          [p, y] = (0, r.useState)(''),
          x = (0, r.useCallback)(
            (e) => {
              const { name: t, desc: n, searchTerms: r } = e,
                o = p.toLowerCase()
              return (
                t.toLowerCase().includes(o) ||
          ...
          S = (0, r.useMemo)(() => [[...t]], [t]),
          k = (0, r.useMemo)(() => {
            const e = S.filter((e) => e.some(x))
            return e
          }, [S, x]),
          E = (0, m.ensureNotNull)(n).value,
          L = (0, r.useRef)(null),
          A = (0, r.useRef)(null)
        ;(0, r.useLayoutEffect)(() => {
          var e
          u &&
            (null === (e = null == L ? void 0 : L.current) ||
              void 0 === e ||
              e.focus())
        }, [])
        const F = c
          ...
          : r.createElement(
              b,
              { className: D.noResultsDesktop },
              r.createElement(h.Icon, { icon: d }),
              r.createElement(
                'div',
                { className: D.emptyText },
                (0, l.t)('No exchanges match your criteria')
              )
            )
        return r.createElement(
          ...
          k.length
            ? r.createElement(
                ...
                {
                  ref: A,
                  className: a()(D.contentList, !i && D.contentListDesktop),
                ...
                k.map((e) => {
                  ...
                  return r.createElement(
                    ...
                    r.createElement(
                      ...
                      {
                        className: a()(
                          D.exchangeItemsContainer,
                          !i && D.exchangeItemsContainerDesktop
                        )
                      },
                      e.filter(x).map((e) => {
                        const t = (0, v.isAllExchanges)(e)
                        return r.createElement(N, {
                          key: e.desc,
                          country: e.country,
                          providerId: e.providerId,
                          title: t ? (0, l.t)('All sources') : e.name,
                          description: e.desc,
                          isActive: e.value === E,
                          isAllExchanges: t,
                          isMobile: i,
                          queryString: p,
                          onClick: Z.bind(null, e)
                        })
                      })
                    )
                  )
      ...
      function F(e) {
        return (null == e ? void 0 : e.aborted)
          ...
          : new Promise((t, n) => {
              null == e ||
                e.addEventListener('abort', () => n(Z()), { once: !0 })
            })
      }
      function Z() {
        ...
        const { state: n, update: o } = e,
          {
            ...
            (0, r.useContext)(f.SymbolSearchItemsDialogContext)
          ),
          d = (0, s.tokenize)(
            null === (t = a.current) || void 0 === t ? void 0 : t.value
          ),
          p = (0, i.validate)(d)
        let h = [
          { icon: H, insert: '/', type: 'binaryOp', name: 'division' },
          { icon: K, insert: '-', type: 'binaryOp', name: 'subtraction' },
          { icon: q, insert: '+', type: 'binaryOp', name: 'addition' },
          { icon: U, insert: '*', type: 'binaryOp', name: 'multiplication' }
        ]
        return (
          u.enabled('hide_exponentiation_spread_operator') ||
            (h = h.concat([
              { icon: j, insert: '^', type: 'binaryOp', name: 'exponentiation' }
            ])),
            ...
            (h = h.concat([
              {
                ...
                callback: () => {
                  !a.current ||
                    p.errors.length ||
                    p.warnings.length ||
                    ((a.current.value = (0, i.stringifyTokens)((0, i.flip)(d))),
                    l())
                }
              }
            ])),
          r.createElement(
            ...
            { className: Y.actions },
            h.map((e) =>
              r.createElement(Q.ToolWidgetButton, {
                  ...
                  (function (e) {
                    ...
                    if (!ee(e, p)) {
                      if (e.insert && a.current) {
                        ...
                        ;(a.current.value = t),
                          a.current.setSelectionRange(t.length, t.length)
                        const [r, , s] = (0, i.getCurrentTokenParamsFromInput)(
                          a.current,
                          c
                        )
                        n.current &&
                          ((n.current.selectedIndexValue = -1),
                          (n.current.searchSpreadsValue = (0, i.isSpread)(s)),
      ...
      function oe(e) {
        ...
        return r.createElement(
          'span',
          {
            ...(0, te.filterAriaProps)(p),
            ...(0, te.filterDataProps)(p),
            id: t,
            title: n,
            tabIndex: o,
            role: l,
          ...
          r.createElement('span', { className: a()(ne.content, s) }, i)
        )
      }
      var ae = n(68865)
      function le(e) {
        const {
          ...
          multiline: m,
          children: h,
          BubbleComponent: f = oe,
          reference: g,
          fontSize: v
        } = e
        return r.createElement(
          'div',
          { className: o(t, ae.bubbles, m && ae.multiLine), ref: g },
          l.map((e, t) =>
            r.createElement(
              f,
              {
      ...
      function me(e) {
        const {
          ...
          u = (0, m.ensureNotNull)(i),
          d = 'symbolSearch' === t,
          p = (0, v.isAllExchanges)(u),
          { country: g, providerId: y } = u
        return d
          ? r.createElement(
              'div',
              {
                className: a()(pe.flagWrap, 'apply-common-tooltip'),
                title: (0, l.t)('Select source'),
                onClick: function () {
                  o.current &&
                    (s.current = c
                      ? o.current.value.toUpperCase()
                      : o.current.value)
                  n('exchange')
                }
              },
              !!p && r.createElement(h.Icon, { className: pe.icon, icon: k }),
              r.createElement(
                'div',
                { className: pe.title },
                p ? (0, l.t)('All sources') : u.name
              ),
              r.createElement(de.ToolWidgetCaret, {
                className: pe.caret,
                dropped: !1
              })
            )
      ...
      var he = n(90734)
      const fe = (0, v.getAvailableExchanges)()
      function ge(e) {
        const { isSmallWidth: t, selectedExchange: n } = (0, m.ensureNotNull)(
            (0, r.useContext)(f.SymbolSearchItemsDialogContext)
          ),
          o = n && fe.length > 1 && !(0, v.exchangeSelectDisabled)()
        return r.createElement(
          'div',
          ...
          r.createElement(
            ...
            r.createElement(
              'div',
              { className: he.text },
              t ? (0, l.t)('Symbol & description') : (0, l.t)('Symbol')
            )
          ),
          r.createElement(
            'div',
      ...
      function be(e) {
        const {
          ...
          b = (0, r.useCallback)((e) => (0, m.ensure)(i[e].key), [i]),
          x = 'watchlist' === d && null !== g
        return r.createElement(
          ue(),
          {
            onMeasure: function (e) {
              v(e.height), h(e.width)
            }
          },
          r.createElement(
            'div',
            {
              ref: l,
              className: a()(ye.wrap, x && ye.watchlist, u && ye.noFeed, o),
              onTouchMove: t
            },
            r.createElement(
              'div',
              ...
              x
                ? r.createElement(ie.VariableSizeList, {
                    key: s,
                    ref: n,
                    className: ye.listContainer,
                    width: '100%',
                    height: (0, m.ensureNotNull)(g),
                    itemCount: i.length,
                    itemSize: c,
                    children: y,
                    itemKey: b,
      ...
      function ke(e) {
        const {
          ...
          k =
            i &&
            r.createElement(BrokerCheckbox, {
              brokerTitle: i,
              checked: c,
              onCheckboxChange: u
            }),
          E = 'symbolSearch' === m && 'good' === n,
          N = null != x ? x : xe.SymbolSearchDialogContentItem,
          w = (0, r.useMemo)(
            () => b.map((e) => r.createElement(N, { ...e, searchToken: t })),
            [b]
          )
        return r.createElement(
          r.Fragment,
            ...
            r.createElement(
              ...
              y.length > 0 &&
                r.createElement(
                  le,
                  {
                    itemClassName: Se.symbolType,
                    items: y,
                    getItemTitle: (e) => e.name,
                    getItemKey: (e) => e.value,
                    checkItemIsActive: (e) => e.value === v,
                    onBubbleClick: a,
                    multiline: !h
                  },
                  !h && k
              ...
              h &&
                y.length > 0 &&
                i &&
                r.createElement('div', { className: Se.brokerCheckboxWrap }, k)
            ),
          r.createElement(be, {
            listRef: d,
            listWrapRef: p,
          ...
          'symbolSearch' === m &&
            r.createElement(
              ...
              null,
              !1,
              'empty' === n && r.createElement(S, null)
            )
        )
      }
      function Ee(e) {
        ...
        return r.createElement(
          b,
          { className: Se.noResultsDesktop },
          r.createElement(h.Icon, { icon: t }),
          r.createElement(
            'div',
            { className: Se.emptyText },
            (0, l.t)('No symbols match your criteria')
          )
        )
      }
      const Ne = (0, v.getDefaultExchange)(),
        we = 52
      function Ce(e) {
        const {
            mode: t,
          ...
          L = (0, r.useRef)(t)
        L.current = t
        const F = (0, r.useRef)(new AbortController()),
          [Z, Q] = (0, r.useState)(0),
          [H, K] = (0, r.useState)('noop'),
          q = (0, r.useRef)(0),
          [U, j] = (0, r.useState)(b.current),
          $ = (0, r.useRef)(null),
          Y = (0, r.useRef)(null),
          ee = (0, r.useRef)({
          ...
          ne = (0, r.useRef)(null),
          {
            ...
            brokerId: oe,
            brokerTitle: ae,
            isBrokerChecked: le = !1,
            setIsBrokerChecked: se = () => {},
        ...
        ;(0, r.useEffect)(
          ...
          (0, r.useEffect)(() => {
            ;(null == y ? void 0 : y.current) && j(y.current.value)
          }, []),
          (0, r.useEffect)(() => {
            const e = y.current
            if (e)
              return (
                e.addEventListener('input', ge),
                e.addEventListener('focus', xe),
                e.addEventListener('select', fe),
                e.addEventListener('click', fe),
                e.addEventListener('keyup', Ee),
                D && z && e.addEventListener('keydown', z),
                () => {
                  e &&
                    (e.removeEventListener('input', ge),
                    e.removeEventListener('focus', xe),
                    e.removeEventListener('select', fe),
                    e.removeEventListener('click', fe),
                    e.removeEventListener('keyup', Ee),
                    D && z && e.removeEventListener('keydown', z))
                }
              )
          }, [z]),
          (0, r.useEffect)(() => {
            ;(Boolean(T) && '' === U.trim()) ||
              (ye(U, p, null == c ? void 0 : c.value),
              $.current && ($.current.scrollTop = 0))
          }, [U, p, c, le, T]),
          (0, r.useEffect)(() => {
            if (!k || !y.current) return
            if (!u.enabled('show_spread_operators'))
              return (y.current.value = k.symbol), void N()
            const e = V(k) ? k.exchange : k.parent.exchange,
              t = {
                name: k.symbol,
                exchange: e,
                prefix: k.prefix,
              ...
              [n, r] = (0, i.getNextSymbolInputValueAndPosition)(
                y.current,
                t,
                R
              )
            ;(y.current.value = n), y.current.setSelectionRange(r, r), N()
          }, [k])
        const ce = (0, r.useCallback)((e) => (E ? E(e) : e), [E]),
          ue = null != T ? T : 'div',
          de = Boolean(T) && 'symbolSearch' !== t,
          pe = null != _ ? _ : g.DialogSearch,
          me = (0, r.useMemo)(
            () => ({
              listRef: Y,
              resetRecommends: be,
              updateRecommends: ye,
              searchToken: U,
              emptyTextClassName: Se.emptyText,
              isBrokerChecked: le,
              symbolSearchState: H,
              currentMode: L
            }),
        ...
        return r.createElement(
          ...
          !(D && 'symbolSearch' === t) &&
            r.createElement(
              ...
              {
                reference: y,
                className: a()(Se.search, R && Se.upperCase),
                placeholder: w || (0, l.t)('Search')
              },
              S && r.createElement(J, { state: ee, update: ve })
            ),
          de
            ...
            : r.createElement(ke, {
                ...
                onResetFilters: function () {
                  var e
                  m((0, v.getAllSymbolTypesValue)()), Ne && d(Ne)
                  se(!1),
        ...
        function he() {
          if (!y.current) return
          const [e, t, n] = (0, i.getCurrentTokenParamsFromInput)(y.current, R)
          ;(q.current = t),
            (ee.current = {
              selectedIndexValue: -1,
              searchSpreadsValue: (0, i.isSpread)(n),
              searchTokenValue: e
            }),
            te.current || (te.current = setTimeout(ve, 0))
        }
        function fe() {
          if (!y.current) return
          const [, e] = (0, i.getCurrentTokenParamsFromInput)(y.current, R)
          e !== q.current && he()
        }
        function ge() {
        ...
        async function ye(e, t, n) {
          try {
            ...
            const r = await (async function (e, t, n, r) {
                var o, a, l
                const s = u.enabled('show_spread_operators')
                  ? (0, i.shortName)(t)
                ...
                let d
                if (le && re) {
                  const t = await P(e, re.accountMetainfo())
                  d = t.prefix
                }
                const p = u.enabled('show_spread_operators')
                    ? null !==
                        (l =
                          null !== (a = (0, i.getExchange)(t)) && void 0 !== a
                            ? a
                            : d) && void 0 !== l
                      ? l
                      : r
                  ...
                  m = {
                    ...
                    brokerId: oe,
                    onlyTradable: Boolean(oe) && le,
                    unhideSymbolSearchGroups: ie,
                    signal: e
                  },
                  h = (0, W.getSearchRequestDelay)()
                void 0 !== h &&
              ...
              o = ce(
                (function (e, t = window.ChartApiInstance.symbolsGrouping()) {
                  ...
                  for (let a = 0; a < e.length; ++a) {
                    const l = e[a]
                    if (l.prefix || Array.isArray(l.contracts)) return e
                    const s = t[l.type]
                    if (void 0 === s) {
                      o.push(l)
                      continue
                    }
                    const i = s.exec(l.symbol)
                    if (i) {
                      const e = i[1]
                      let t
                      r.hasOwnProperty(e)
                        ...
                        : ((t = o.length),
                          ...
                          o.push({
                            ...
                            full_name: l.exchange + ':' + e,
                            contracts: []
                          })),
                        null === (n = o[t].contracts) ||
                          void 0 === n ||
                          n.push(l)
                    } else o.push(l)
                  }
            ...
            if (!o.length) return we(), void K('empty')
            we(), h(o), K('good')
          } catch (e) {
            !(function (e) {
              if (!B(e)) throw e
        ...
        function xe() {
          'watchlist' === L.current &&
            (n('symbolSearch'),
            (0, G.trackEvent)('Watchlist', 'Mobile SS', 'Go to SS page'))
        }
        function Ee(e) {
          switch ((0, X.hashFromEvent)(e)) {
            case 37:
            case 39:
              fe()
          }
      ...
      function Ie(e) {
        const { theme: t = Me } = e,
          { setMode: n, isMobile: o } = (0, C.useEnsuredContext)(
      ...
      function ze(e) {
        const [t, n] = (0, r.useState)(() => {
          const t = De.getValue('symboledit.exchangefilter', '')
      ...
      var Ae = n(77727),
        Fe = n(17923)
      const Ze = (0, v.getAvailableExchanges)(),
        Be = (0, v.getDefaultExchange)(),
      ...
      function Ve(e) {
        ...
        const {
            ...
            selectSearchOnInit: h = !0,
            onSearchComplete: g,
            onSearchFeedReady: y,
            dialogTitle: b = (0, l.t)('Symbol Search'),
            placeholder: x,
            fullscreen: S,
            initialScreen: k,
            wrapper: E,
          ...
          z = (0, r.useMemo)(
            () =>
              e.symbolTypes ? e.symbolTypes : (0, v.getAvailableSymbolTypes)(),
            []
          ),
          A = void 0 !== e.input,
          [F, Z] = (0, r.useState)(o),
          B = (0, r.useRef)(a),
          [P, W] = ze({ exchanges: Ze, defaultExchange: Be }),
          [G, Q] = Le({ types: z }),
          [H, K] = (0, r.useState)([]),
          [q, U] = (0, r.useState)(!1),
          [j, $] = (0, r.useState)(-1),
          Y = (0, r.useRef)(null !== (t = e.input) && void 0 !== t ? t : null),
          [J, ee] = (0, r.useState)(!1),
          te = (0, Ae.useForceUpdate)(),
          [ne, re] = (0, r.useState)(new Set()),
          {
            broker: oe = null,
            brokerId: ae,
            unhideSymbolSearchGroups: le = '',
        ...
        ;(0, r.useLayoutEffect)(() => {
          ...
          !(null == Y ? void 0 : Y.current) ||
            ...
            (A || 'compare' === F || (Y.current.value = B.current),
            !I || (A && 'symbolSearch' !== F) || Y.current.focus())
        }, [F]),
          (0, r.useEffect)(() => {
            ;(null == Y ? void 0 : Y.current) && h && I && Y.current.select()
          }, [])
        const ie = (0, r.useMemo)(
            () =>
              H.reduce((e, t) => {
                const n = Ge(t),
                  r = ne.has(n)
        ...
        const ue = (0, r.useMemo)(
            () =>
              ie.map((e, t) => {
                var n, r, o, a
                if (V(e)) {
                  const o = Ge(e),
                    a = e.contracts ? ne.has(o) : void 0,
                    l = t === j
                  return {
                    key: t,
                    id: o,
                    ...
                    country:
                      null === (n = e.country) || void 0 === n
                        ? void 0
                        : n.toLocaleLowerCase(),
                    type: e.type,
                    exchangeName: e.exchange,
                    marketType: (0, _e.marketType)(e.type, e.typespecs),
                    isEod:
                      null === (r = e.params) || void 0 === r
                        ? void 0
                        : r.includes('eod'),
                    isExpanded: a,
                    onExpandClick: e.contracts ? ye.bind(null, o) : void 0,
                    fullSymbolName:
                      Re.QualifiedSources.fromSymbolSearchResult(e),
                    itemRef: l ? ce : void 0,
                    isSelected: t === j,
                    hideMarkedListFlag: m,
                    item: e
                  ...
                  return {
                    ...
                    isEod:
                      null === (o = e.params) || void 0 === o
                        ? void 0
                        : o.includes('eod'),
                    onClick: be.bind(null, e.parent, e),
                    providerId: n.provider_id,
                    country:
                      null === (a = n.country) || void 0 === a
                        ? void 0
                        : a.toLowerCase(),
                    type: n.type,
                    exchangeName: n.exchange,
                    marketType: (0, _e.marketType)(n.type, e.typespecs),
                    fullSymbolName: Re.QualifiedSources.fromSymbolSearchResult(
                      e.parent,
                      e
                    ),
                    itemRef: l ? ce : void 0,
          ...
          me = (e, t) => ({
            ...
            setMode: Z,
            selectedExchange: P,
            setSelectedExchange: W,
            selectedSymbolType: G,
            setSelectedSymbolType: Q,
            selectedIndex: j,
            setSelectedIndex: $,
            onClose: n,
            setRenderSymbolSearchList: K,
            searchRef: Y,
            cachedInputValue: B,
            searchSpreads: q,
            setSearchSpreads: U,
          ...
          fe =
            'exchange' === F
              ? {
                  ...
                  render: () => r.createElement(he, { exchanges: Ze }),
                  additionalHeaderElement: r.createElement(Ie, null),
                  additionalElementPos: 'before'
                }
              : {
                  title: b,
                  dataName: 'symbol-search-items-dialog',
                  render: () => r.createElement(Ce, null),
        ...
        return r.createElement(
          ...
          r.createElement(
            ...
            ({ TabletSmall: e, TabletNormal: t }) =>
              r.createElement(
                f.SymbolSearchItemsDialogContext.Provider,
                { value: me(e, t) },
                r.createElement(de, {
                  ...fe,
                  fullScreen: S,
        ...
        function be(e, t) {
          ...
          if (u.enabled('show_spread_operators')) {
            ...
            if (q) return Se(e), void te()
            if (Y.current && Y.current.value.includes(',')) return void Se(e)
          }
          const a = [
            {
              resolved: !0,
              symbol: Re.QualifiedSources.fromSymbolSearchResult(e, t),
              result: r
            }
          ]
          g(a), n()
        ...
        function Se(e) {
          if (!Y.current) return
          const [t, n] = (0, i.getNextSymbolInputValueAndPosition)(
            Y.current,
            e,
            Pe
          )
          ;(Y.current.value = t),
            Y.current.setSelectionRange(n, n),
            Y.current.focus()
        }
        function ke(e) {
          switch ((0, X.hashFromEvent)(e)) {
            case 38:
              ...
              if (-1 === j) return void $(0)
              $(j - 1)
              break
            case 40:
              if ((e.preventDefault(), j === ue.length - 1)) return
              $(j + 1)
              break
            case 37: {
              if (-1 === j) return
              ...
              if (
                (!r &&
                  ...
                  ne.has(n) &&
                  Boolean(o) &&
                  (e.preventDefault(), ye(n)),
                o)
              )
                return void (null == R || R(e, !0))
              break
            }
            case 39: {
              if (-1 === j) return
        ...
        function Ee(e) {
          if (!Y.current) return
          const t = Y.current.value
          if (u.enabled('show_spread_operators') && q && t) {
            if (t.includes(',')) {
              const r = Xe(t)
              if (r.some((e) => !Ne(e))) return
              return g(r.map(Oe)), void (e && n())
            }
            if (!Ne(t)) return
            return (
              g([{ symbol: Pe ? t.toUpperCase() : t, resolved: !1 }]),
              void (e && n())
            )
          }
          if (t.includes(',')) return g(Xe(t).map(Oe)), void (e && n())
          if (-1 !== j) {
            ue[j].onClick()
          } else {
                          ...
                          (async function (e) {
                            ...
                            if (0 !== n.length) {
                              ...
                              if (o && a)
                                return {
                                  symbol:
                                    Re.QualifiedSources.fromSymbolSearchResult(
                                      e,
                                      r
                                    ),
                                  resolved: !0,
      ...
      function Oe(e) {
        return { symbol: Pe ? e.toUpperCase() : e, resolved: !1 }
      }
      function We(e, t) {
      ...
      function Qe(e) {
        const { isMobile: t, isTablet: n } = (0, C.useEnsuredContext)(
          f.SymbolSearchItemsDialogContext
        )
        return r.createElement(p.AdaptivePopupDialog, {
          ...e,
          className: a()(
            Fe.dialog,
            !t && (n ? Fe.tabletDialog : Fe.desktopDialog)
          ),
          backdrop: !0,
          draggable: !1
        })
    ...
    38208: (e, t, n) => {
      ...
      function l(e) {
        ...
        if (
          ...
          !r.enabled('show_spread_operators')
        )
          return t
        let n = 'init'
        const o = []
          ...
          switch (a.type) {
            ...
            case 'closeBrace': {
              ...
              ;(!c(null == l ? void 0 : l.type) ||
                (null == l ? void 0 : l.precedence) <= r.minPrecedence) &&
                (!c(null == a ? void 0 : a.type) ||
                  (null == a ? void 0 : a.precedence) <
                    (null == r ? void 0 : r.minPrecedence) ||
                  ((null == a ? void 0 : a.precedence) ===
                    (null == r ? void 0 : r.minPrecedence) &&
                    s)) &&
    ...
    3627: (e, t, n) => {
      ...
      n.d(t, {
        getSymbolFullName: () => r,
        isAllExchanges: () => o,
        getDefaultExchange: () => a,
        getAvailableExchanges: () => l,
        getAvailableSymbolTypes: () => i,
    ...
    65955: (e, t, n) => {
      'use strict'
      n.d(t, { symbolTokenEscapeRe: () => a, tokenize: () => i })
      var r = n(27490)
                    ...
                    ? ((u = 3),
                      void (c =
                        null === (n = t.match(p)) || void 0 === n
                          ? void 0
                          : n.index))
                    : (0, r.isString)(t) && p.test(t)
                    ? ((u = 2),
                      void (c =
                        null === (l = t.match(p)) || void 0 === l
                          ? void 0
                          : l.index))
                    : (0, r.isString)(a) && p.test(a)
                    ? ((u = 1),
                      void (c =
                        null === (s = a.match(p)) || void 0 === s
                          ? void 0
                          : s.index))
                    : void (
                        (0, r.isString)(a) &&
    ...
    11945: (e, t, n) => {
      ...
      var r = n(67294),
        ...
        l = n(75695)
      function s(e) {
        const { queryString: t, rules: n, text: s, className: i } = e,
          c = (0, r.useMemo)(
            () => (0, a.getHighlightedChars)(t, s, n),
            [t, n, s]
          )
        return r.createElement(
          r.Fragment,
    ...
    88262: (e, t, n) => {
      ...
      function i(e) {
        ...
        return r.createElement(a.Icon, {
          className: o(n, l.icon, { [l.dropped]: t }),
          icon: s
        })
      }
    },
