;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [7078],
  {
    ...
    45745: (e, t, i) => {
      'use strict'
      i.d(t, {
        DialogSidebarContainer: () => m,
        DialogSidebarWrapper: () => h,
        DialogSidebarItem: () => d
      })
      var n = i(67294),
        l = i(94184),
      ...
      function m(e) {
        const { mode: t, className: i, ...l } = e,
          { isMobile: o, isTablet: s } = c(t),
          m = a()(r.container, s && r.isTablet, o && r.isMobile, i)
      ...
      function h(e) {
        return n.createElement('div', { className: r.wrapper, ...e })
      }
      function d(e) {
        const { mode: t, title: i, icon: l, isActive: m, onClick: h, ...d } = e,
          { isMobile: p, isTablet: u } = c(t)
        return n.createElement(
          ...
          n.createElement(o.Icon, { className: r.icon, icon: l }),
          !u &&
            n.createElement(
              'span',
              { className: r.title },
              n.createElement('span', { className: r.titleText }, i),
              p && n.createElement(o.Icon, { className: r.nested, icon: s })
            )
        )
      }
    },
    76270: (e, t, i) => {
      'use strict'
      i.r(t), i.d(t, { GeneralChartPropertiesDialogRenderer: () => J })
      var n = i(79881),
        l = i(67294),
        a = i(73935),
        o = i(80511),
        ...
        _ = i(99182),
        y = (i(95068), i(87614))
      const v = (0, n.t)("Do you really want to delete Color Theme '{name}' ?")
      var S = i(78106),
        k = i(22675),
        A = i(14303),
        f = i(87438),
      ...
      function M(e) {
        const {
          ...
          c = l.useCallback(() => {
            ;(0, _.loadTheme)(t, !1, !1, i).then(() => {
              i.readOnly() || window.saver.saveChartSilently(),
        ...
        return l.createElement(
          'div',
          { ...s },
          l.createElement(T.PopupMenuItem, {
            className: E.defaultsButtonItem,
            isActive: !1,
            label: t,
            onClick: c,
            toolbox: l.createElement(A.RemoveButton, {
              hidden: !w.mobiletouch && !o,
              onClick: r
            })
          })
        )
      ...
      var B = i(22775)
      const D = (0, n.t)('Template'),
        x = (0, n.t)('Apply defaults'),
        I =
          ((0, k.appendEllipsis)((0, n.t)('Save as')), (0, n.t)('Apply to all'))
        ...
        constructor(e) {
          super(e),
            ...
            (this._handleApplyDefaults = () => {
              ...
              const i = (0, _.getCurrentTheme)().name
              ;(0, _.loadTheme)(i, !0, !0, t, void 0, void 0, !0)
            }),
            (this._handleSaveAs = () => {
              0
            }),
          ...
          return l.createElement(
            ...
            a.length > 0 &&
              l.createElement(
                l.Fragment,
                null,
                l.createElement(C.PopupMenuSeparator, { key: 'separator' }),
                a.map((e) =>
                  l.createElement(M, {
                    key: e,
                    themeName: e,
      ...
      class H extends l.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._renderApplyToAllButton = () =>
              l.createElement(
                u.MatchMedia,
                { rule: L.DialogBreakpoints.TabletNormal },
            ...
            (this._selectPage = (e) => {
              ...
              e !== t &&
                (t &&
                  t.definitions.unsubscribe(
                    this._onChangeActivePageDefinitions
                  ),
                d().setValue('properties_dialog.last_page_id', e.id),
            ...
            (this._syncApplyToAllVisibility = () => {
              ...
              this.setState({
                isApplyToAllVisible: (0, p.isMultipleLayout)(e.layout.value())
              })
            }),
          ...
          let n = t.find((e) => e.id === i)
          if (!n) {
            const e = d().getValue('properties_dialog.last_page_id'),
              i = t.find((t) => t.id === e)
            n = i || t[0]
          }
          this.state = {
            activePage: n,
            isApplyToAllVisible: (0, p.isMultipleLayout)(
        ...
        render() {
          ...
          return l.createElement(
            ...
            (a) =>
              l.createElement(r.AdaptiveConfirmDialog, {
                className: G.withSidebar,
                dataName: 'series-properties-dialog',
                onClose: t,
                isOpened: e,
                title: null !== i && a ? i.title : (0, n.t)('Chart settings'),
                footerLeftRenderer: this._renderFooterLeft,
                additionalButtons: this._renderApplyToAllButton(),
                additionalHeaderElement:
                  null !== i && a
                    ? l.createElement(U, { onClick: this._handleBackClick })
                    : void 0,
        ...
        _renderTabContent(e) {
          ...
          if (i) {
            ...
            return l.createElement(
              ...
              { className: G.tabContent, onScroll: this._handleScroll },
              l.createElement(
                ...
                l.createElement(
                  ...
                  n.map((e) =>
                    l.createElement(s.Section, { key: e.id, definition: e })
                  )
                )
              )
            )
          ...
          return l.createElement(
            ...
            (e) =>
              l.createElement(
                ...
                { rule: L.DialogBreakpoints.TabletSmall },
                (i) => {
                  const a = i ? 'mobile' : e ? 'tablet' : void 0
                  return l.createElement(
                    R.DialogSidebarContainer,
                    { mode: a, onScroll: this._handleScroll },
                    t.map((e) =>
                      l.createElement(R.DialogSidebarItem, {
                        key: e.id,
                        mode: a,
                        'data-name': e.id,
                        title: e.title,
      ...
      var F = i(18437),
        K = i(58738)
      const j = (0, n.t)('Chart settings')
      class J extends K.DialogRenderer {
        constructor(e) {
          super(),
            (this._handleClose = () => {
    ...
    10869: (e, t, i) => {
      'use strict'
      i.d(t, { PopupMenuSeparator: () => s })
      var n = i(67294),
        l = i(94184),
        a = i.n(l),
        o = i(78706)
      function s(e) {
        const { size: t = 'normal', className: i } = e
        return n.createElement('div', {
          className: a()(
            o.separator,
            'small' === t && o.small,
