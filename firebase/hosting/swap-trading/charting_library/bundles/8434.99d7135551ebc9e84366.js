;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [8434],
  {
    ...
    66406: (e) => {
      e.exports = {
        loaderWrap: 'loaderWrap-2SapxxDI',
        big: 'big-2SapxxDI',
        loader: 'loader-2SapxxDI'
      }
    },
    30160: (e) => {
      e.exports = {
    ...
    87361: (e, t, n) => {
            ...
            s.createElement(
              ...
              void 0 !== r &&
                s.createElement(
                  'td',
                  null,
                  s.createElement(m.FavoriteButton, {
              ...
              s.createElement(
                ...
                s.createElement(
                  ...
                  !e &&
                    t &&
                    !u.CheckMobile.any() &&
                    s.createElement(d.Hint, {
                      className: i(o && a.invisibleHotkey),
                      text: t
                    }),
                  !e && !t && n && s.createElement(d.Hint, { text: n })
                )
              )
            ),
            s.createElement(
      ...
      function N(e) {
        ...
        return s.createElement(x, {
          ...
          label: s.createElement(
            'div',
            { className: l()(y.loaderWrap, y[t]) },
            s.createElement(w.Loader, { className: y.loader })
          ),
          noInteractive: !0,
              ...
              (function (e, t, n = { x: 0, y: 10 }) {
                if (t) {
                  const {
                    ...
                    a = { x: n - e, y: o },
                    i = { x: s, y: o }
                  return (0, k.isRtl)() ? (n <= e ? i : a) : r - s >= e ? i : a
                }
                return n
              })(e, this._itemRef)),
            (this._updateState = (e) => {
      ...
      I.contextType = S.SubmenuContext
    ...
    56806: (e, t, n) => {
      'use strict'
      n.d(t, { ContextMenu: () => S, OverlapContextMenu: () => w })
      var s = n(67294),
        o = n(94184),
        r = n.n(o),
        a = n(36668),
        ...
        return s.createElement(
          ...
          s.createElement(
            ...
            t.map((e) => {
              switch (e.type) {
                case 'action':
                  return s.createElement(_, { key: e.id, action: e })
                case 'separator':
                  return s.createElement(d, { key: e.id })
              }
            })
          )
        )
                            ...
                            (t) =>
                              s.createElement(
                                i.Menu,
                                {
                                  ...v,
                                  reference: t,
                                  className: r()(k.menu, 'context-menu'),
                                  onClose: this._handleClose,
    ...
    57330: (e, t, n) => {
      ...
      function i(e) {
        ...
        return s.createElement('span', { className: r()(a.shortcut, n) }, t)
      }
    },
    90590: (e, t, n) => {
      'use strict'
      n.d(t, { ContextMenuItem: () => d })
      var s = n(67294),
        o = n(94184),
        r = n.n(o),
        a = n(49775),
      ...
      function d(e) {
        ...
        return n
          ? s.createElement(
              'li',
              { className: r()(m.item, m.loading, m[N]) },
          ...
          : s.createElement(
              ...
              M && s.createElement(a.Icon, { className: m.nested, icon: h }),
              S
            )
      }
    },
    23060: (e, t, n) => {
      ...
      const s = n(67294).createContext(!1)
    },
    80556: (e, t, n) => {
      'use strict'
      ...
      function r(e) {
        return class extends s.PureComponent {
          render() {
            ...
            if (!t) return null
            const r = s.createElement(e, { ...this.props, zIndex: 150 })
            return 'parent' === n ? r : s.createElement(o.Portal, null, r)
          }
        }
      }
    },
