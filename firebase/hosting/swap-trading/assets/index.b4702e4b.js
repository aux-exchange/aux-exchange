...
import { j as jsx, q as qe, E as EllipsisVerticalIcon, a as jsxs, r as react, c as create, R as React, b as React$1, W as We$1, g as gt, d as reactDom, u as useAnimationControls, m as motion, e as useNavigate, f as useLocation, p as pt, h as be$1, i as qe$1, S as Slider, k as useReactTable, l as flexRender, n as mt, o as getCoreRowModel, s as getSortedRowModel, O as Oe, t as useQuery, v as useSubscription, w as dist, x as useMutation, F as Fragment, T as Tooltip, I as InformationCircleIcon, A as ArrowLongRightIcon, L as Lo, C as ChevronDownIcon, _, y as AptosClient, z as FaucetClient, B as BN, H as HexString, D as AptosAccount, G as CoinClient, J as WaitForTransactionError, K as sha3, M as aptos_types_exports, N as dist$1, P as assert, Q as makeExecutableSchema, U as ApolloClient, V as InMemoryCache, X as SchemaLink, Y as ApolloProvider, Z as CheckCircleIcon, $ as LockClosedIcon, a0 as createColumnHelper, a1 as ArrowsUpDownIcon, a2 as CogIcon, a3 as DateTime, a4 as Link, a5 as XMarkIcon, a6 as ChevronUpIcon, a7 as MagnifyingGlassIcon, a8 as ArrowTopRightOnSquareIcon, a9 as ArrowLongRightIcon$1, aa as ArrowDownIcon, ab as ArrowLongLeftIcon, ac as FireIcon, ad as linear, ae as ArrowLongRightIcon$2, af as NavLink, ag as Bars3Icon, ah as XMarkIcon$1, ai as reactResponsive, aj as useGeoLocation, ak as BrowserRouter, al as Routes, am as Route, an as client$1 } from "./vendor.6a1c5122.js";
...
(function polyfill() {
  ...
  new MutationObserver((mutations) => {
    for (const mutation2 of mutations) {
      ...
      for (const node of mutation2.addedNodes) {
...
var OrderType$2 = /* @__PURE__ */ ((OrderType2) => {
...
var RatingColor$1 = /* @__PURE__ */ ((RatingColor2) => {
  RatingColor2["Green"] = "GREEN";
  RatingColor2["Red"] = "RED";
  RatingColor2["Yellow"] = "YELLOW";
  return RatingColor2;
})(RatingColor$1 || {});
var Resolution$1 = /* @__PURE__ */ ((Resolution2) => {
...
const TradeControlsProvider = function TradeControlProvider({
  ...
  const balances2 = useBalances();
  const {
    firstCoin,
    secondCoin,
    lastTradePrice
  } = useCoinXYParamState();
  const quantX = (_d = (_c = (_b = (_a2 = balances2.data) == null ? void 0 : _a2.account) == null ? void 0 : _b.balances) == null ? void 0 : _c.find((b2) => {
    var _a3;
  ...
  const [orderType, setOrderType] = react.exports.useState(OrderType$2.Limit);
  const market2 = useQuery(MarketSimpleDocument, {
    variables: {
      marketInput: {
  ...
  const pythRatingQuery = useQuery(PythRatingDocument, {
    variables: {
      ...
      side: !activeTab ? Side$1.Buy : Side$1.Sell
    },
  ...
  const step = react.exports.useMemo(() => {
    var _a3, _b2, _c2;
    return Number((_c2 = (_b2 = (_a3 = market2 == null ? void 0 : market2.data) == null ? void 0 : _a3.market) == null ? void 0 : _b2.lotSizeDecimals) != null ? _c2 : 0);
  }, [market2 == null ? void 0 : market2.data]);
  const tick = react.exports.useMemo(() => {
    var _a3, _b2, _c2;
    return Number((_c2 = (_b2 = (_a3 = market2 == null ? void 0 : market2.data) == null ? void 0 : _a3.market) == null ? void 0 : _b2.tickSizeDecimals) != null ? _c2 : 0);
  }, [market2 == null ? void 0 : market2.data]);
  ...
  const resetForm = () => {
    ...
    setPost(false);
    setIOC(false);
    setOrderType(OrderType$2.Limit);
  };
  ...
  const onChangeIOC = (val) => {
    ...
    if (pj && val)
      setPj(false);
    setIOC(val);
    setOrderType(OrderType$2.ImmediateOrCancel);
  ...
  const onChangePost = (val) => {
    ...
    if (pj && val)
      setPj(false);
    setPost(val);
    setOrderType(OrderType$2.PostOnly);
  ...
  const onChangeFok = (val) => {
    ...
    if (pj && val)
      setPj(false);
    setFok(val);
    setOrderType(OrderType$2.FillOrKill);
  ...
  const onChangePassiveJoin = (val) => {
    ...
    if (fok && val)
      setFok(false);
    setPj(val);
    setOrderType(OrderType$2.PassiveJoin);
  ...
  const wallet = dist.useWallet();
  const placeOrder2 = async (placeOrderInput) => {
    var _a3;
  ...
  const submitTrade = async () => {
    ...
    if (firstCoin && secondCoin && wallet.account && cxAmount && price) {
      await placeOrder2({
        ...
        side: activeTab === 0 ? Side$1.Buy : Side$1.Sell
      }).then(() => {
        resetForm();
...
function SwapDetailsView({
  ...
  const getPythColor = (color) => {
    switch (color) {
      case RatingColor$1.Green:
        return "text-green-300";
      case RatingColor$1.Red:
        return "text-red-300";
      case RatingColor$1.Yellow:
...
function CoinSearchModalContainer({
  ...
  const [query2, setQuery] = react.exports.useState("");
  const filteredCoins = coins.filter((c) => {
    var _a2;
    return query2 === "" ? true : (_a2 = c.name.toLowerCase().match(query2.toLowerCase())) != null ? _a2 : c.symbol.toLowerCase().match(query2.toLowerCase());
  });
...
function DepositInput({
  ...
  const findBalance = (coin2) => {
    var _a3, _b2;
    return (_b2 = (_a3 = balances2.data) == null ? void 0 : _a3.account) == null ? void 0 : _b2.walletBalances.find((b2) => b2.coinInfo.symbol === coin2);
  };
  return /* @__PURE__ */ jsxs("div", {
...
const USDC_ETH_WH = "0x5e156f1207d0ebfa19a9eeff00d62a282278fb8719f4fab3a586a0a2c0fffbea::coin::T";
const USDC_SOL_WH = "0xc91d826e29a3183eb3b6f6aa3a722089fdffb8e9642b94c5fcd4c48d035c0080::coin::T";
const USDT_WH = "0xa2eda21a58856fda86451436513b867c97eecb4ba099da5775520e0f7492e852::coin::T";
const USDC_L0 = "0xf22bede237a07e121b56d91a491eb7bcdfd1f5907926a9e58338f964a01b17fa::asset::USDC";
const USDT_L0 = "0xf22bede237a07e121b56d91a491eb7bcdfd1f5907926a9e58338f964a01b17fa::asset::USDT";
const SOL_WH = "0xdd89c0e695df0692205912fb69fc290418bed0dbe6e4573d744a6d5e6bab6c13::coin::T";
const WETH_WH = "0xcc8a89c8dce9693d354449f1f73e60e14e347417854f029db5bc8e7454008abb::coin::T";
const WBTC_WH = "0xae478ff7d83ed072dbc5e264250e67ef58f57c99d89b447efd8a0a2e8b2be76e::coin::T";
const USDA = "0x1000000fa32d122c18a6a31c009ce5e71674f22d06a581bb0a15575e6addadcc::usda::USDA";
const ALL_USD_STABLES = [
  USDC_ETH_WH,
  USDC_SOL_WH,
  USDT_WH,
  USDC_L0,
...
const COIN_MAPPING = /* @__PURE__ */ new Map();
...
const ALL_FAKE_STABLES = ["USDC", "USDT"];
function fakeStableTypes(auxClient2) {
  const types = [];
  for (let coin of ALL_FAKE_STABLES) {
    types.push(auxClient2.getWrappedFakeCoinType(coin));
  }
  return types;
}
const ALL_FAKE_VOLATILES = [
  "BTC",
  "ETH",
  "SOL",
  "AUX"
];
const ALL_FAKE_COINS = ALL_FAKE_STABLES.concat(ALL_FAKE_VOLATILES);
const APTOS_COIN_TYPE = "0x1::aptos_coin::AptosCoin";
function fakeMapping(auxClient2) {
  const [fakeBtc, fakeEth, fakeSol, fakeUsdc] = [
    auxClient2.getWrappedFakeCoinType("BTC"),
    auxClient2.getWrappedFakeCoinType("ETH"),
    auxClient2.getWrappedFakeCoinType("SOL"),
    auxClient2.getWrappedFakeCoinType("USDC")
  ];
  const FAKE_MAPPING = /* @__PURE__ */ new Map();
...
class AuxEnv {
  constructor(aptosNetwork, aptosProfile) {
    __publicField(this, "aptosNetwork");
    __publicField(this, "aptosProfile");
    __publicField(this, "aptosClient");
    __publicField(this, "faucetClient");
    var _a2, _b;
    const aptosNetworkEnv = window.currentEnvironment.network;
    ...
    } else if (!(aptosNetworkEnv === "mainnet" || aptosNetworkEnv === "testnet" || aptosNetworkEnv === "devnet" || aptosNetworkEnv === "local")) {
      throw new Error(
        `Invalid network \`${aptosNetworkEnv}\`: must be one of ${APTOS_NETWORKS}`
      );
    }
    aptosNetwork = aptosNetwork != null ? aptosNetwork : aptosNetworkEnv;
    aptosProfile = aptosProfile != null ? aptosProfile : getAptosProfile(aptosNetworkEnv);
    const restUrls = {
      mainnet: "https://fullnode.mainnet.aptoslabs.com/v1",
      testnet: "https://fullnode.testnet.aptoslabs.com/v1",
      devnet: "https://fullnode.devnet.aptoslabs.com/v1",
    ...
    const restUrl = (_a2 = aptosProfile.rest_url) != null ? _a2 : restUrls[aptosNetwork];
    const faucetUrl = (_b = aptosProfile.faucet_url) != null ? _b : faucetUrls[aptosNetwork];
    this.aptosNetwork = aptosNetwork;
    this.aptosProfile = aptosProfile;
    this.aptosClient = new AptosClient(restUrl);
    this.faucetClient = _.isUndefined(faucetUrl) ? void 0 : new FaucetClient(restUrl, faucetUrl);
  }
}
function getAptosProfile(aptosProfile) {
  if (defaultUrls[aptosProfile] !== void 0) {
    return {
...
const MAX_U64$1 = "18446744073709551615";
class Pct {
  constructor(percent) {
    __publicField(this, "pct");
...
function toAtomicUnitsRatio(amount, numeratorDecimals, denominatorDecimals) {
  if (amount === void 0) {
  ...
  if (numeratorDecimals == denominatorDecimals) {
    const gcd2 = atomicUnits.gcd(divisor);
    return [
      new AtomicUnits(atomicUnits.div(gcd2)),
      new AtomicUnits(divisor.div(gcd2))
    ];
  }
  if (numeratorDecimals > denominatorDecimals) {
    const powerTen2 = new BN(10).pow(
      new BN(numeratorDecimals - denominatorDecimals)
    );
    const numerator = atomicUnits.mul(powerTen2);
    const gcd2 = numerator.gcd(divisor);
    return [
      new AtomicUnits(numerator.div(gcd2)),
      new AtomicUnits(divisor.div(gcd2))
    ];
  }
...
class AtomicUnits {
  ...
  static fromDecimalUnits(amount, decimals) {
    ...
    const beforeDecimal = findDecimal < 0 ? amount : amount.substring(0, findDecimal);
    const afterDecimal = findDecimal < 0 ? "" : amount.substring(findDecimal + 1);
    const paddedAfterDecimal = afterDecimal.length < decimals ? afterDecimal + "0".repeat(decimals - afterDecimal.length) : afterDecimal;
  ...
  toDecimalUnits(decimals) {
    const atomicString = this.toString();
    const paddedString = atomicString.length < decimals ? "0".repeat(decimals - atomicString.length) + atomicString : atomicString;
    const decimalLocation = paddedString.length - decimals;
    const paddedDecimalString = (decimalLocation == 0 ? "0" : "") + paddedString.substring(0, decimalLocation) + "." + paddedString.substring(decimalLocation);
    let lastZeroIndex = paddedDecimalString.length;
    while (paddedDecimalString[lastZeroIndex - 1] === "0") {
      lastZeroIndex--;
    }
    const lastCharacterIsDecimal = paddedDecimalString[lastZeroIndex - 1] === ".";
    return new DecimalUnits(
      paddedDecimalString.substring(0, lastZeroIndex) + (lastCharacterIsDecimal ? "0" : "")
    );
  }
  toNumber() {
...
function parseRawSwapEvent(event) {
  return {
    kind: "SwapEvent",
...
function parseRawAddLiquidityEvent(event) {
  return {
...
function parseRawRemoveLiquidityEvent(event) {
  return {
...
function createPoolPayload(moduleAddress, input) {
  return {
...
function swapExactCoinForCoinPayload$1(moduleAddress, input) {
  return {
...
function swapCoinForExactCoinPayload$1(moduleAddress, input) {
  return {
...
function swapExactCoinForCoinLimitPayload(moduleAddress, input) {
  return {
...
function swapCoinForExactCoinLimitPayload(moduleAddress, input) {
  return {
...
function addLiquidityPayload(moduleAddress, input) {
  return {
...
function addExactLiquidityPayload(moduleAddress, input) {
  return {
...
function addApproximateLiquidityPayload(moduleAddress, input) {
  return {
...
function addLiquidityWithAccountPayload(moduleAddress, input) {
  return {
...
function removeLiquidityPayload(moduleAddress, input) {
  return {
...
function removeLiquidityWithAccountPayload(moduleAddress, input) {
  return {
...
function resetPoolPayload(moduleAddress, input) {
  return {
...
const _ConstantProductClient = class {
  constructor(auxClient2, { coinTypeX, coinTypeY }) {
    __publicField(this, "auxClient");
    __publicField(this, "type");
    __publicField(this, "coinTypeX");
    __publicField(this, "coinTypeY");
    __publicField(this, "coinTypeLP");
    this.auxClient = auxClient2;
    this.type = `${auxClient2.moduleAddress}::amm::Pool<${coinTypeX}, ${coinTypeY}>`;
    this.coinTypeX = coinTypeX;
    this.coinTypeY = coinTypeY;
    this.coinTypeLP = `${auxClient2.moduleAddress}::amm::LP<${coinTypeX}, ${coinTypeY}>`;
  }
  async transpose() {
    try {
      await this.query();
      ...
      const transposed = new _ConstantProductClient(this.auxClient, {
        coinTypeX: this.coinTypeY,
        coinTypeY: this.coinTypeX
      });
      try {
        await transposed.query();
        return transposed;
      } catch {
  ...
  async query() {
    const coinInfoX = await this.auxClient.getCoinInfo(this.coinTypeX);
    const coinInfoY = await this.auxClient.getCoinInfo(this.coinTypeY);
    const coinInfoLP = await this.auxClient.getCoinInfo(this.coinTypeLP, true);
    const resource = await this.auxClient.aptosClient.getAccountResource(
      this.auxClient.moduleAddress,
      this.type
    );
    const rawPool = resource.data;
    return {
  ...
  async create({ fee }, options = {}) {
    const input = {
      coinTypeX: this.coinTypeX,
      coinTypeY: this.coinTypeY,
      feeBps: (fee.toNumber() * 1e4).toString()
    };
  ...
  async swap(input, options = {}) {
    if ("coinTypeIn" in input) {
      return this.swapExactIn(input, options);
    }
    return this.swapExactOut(input, options);
  }
  async addLiquidity({ amountX, amountY, slippage, useAuxAccount }, options = {}) {
    const pool2 = await this.query();
    const amountAuX = toAtomicUnits(amountX, pool2.coinInfoX.decimals).toU64();
    const amountAuY = toAtomicUnits(amountY, pool2.coinInfoY.decimals).toU64();
    const input = {
      coinTypeX: pool2.coinInfoX.coinType,
      coinTypeY: pool2.coinInfoY.coinType,
      amountAuX,
      amountAuY,
      maxSlippageBps: (slippage != null ? slippage : _ConstantProductClient.defaultSlippage).toBps().toString()
    };
    const payload = (useAuxAccount != null ? useAuxAccount : false) ? addLiquidityWithAccountPayload(this.auxClient.moduleAddress, input) : addLiquidityPayload(this.auxClient.moduleAddress, input);
    const transaction = await this.auxClient.sendOrSimulateTransaction(
      payload,
      options
    );
  ...
  async addExactLiquidity({ amountX, amountY }, options = {}) {
    const pool2 = await this.query();
    const amountAuX = toAtomicUnits(amountX, pool2.coinInfoX.decimals).toU64();
    const amountAuY = toAtomicUnits(amountY, pool2.coinInfoY.decimals).toU64();
    const input = {
  ...
  async addApproximateLiquidity({
    ...
    const input = {
      coinTypeX: pool2.coinInfoX.coinType,
      coinTypeY: pool2.coinInfoY.coinType,
      maxAuX: toAtomicUnits(maxX, pool2.coinInfoX.decimals).toString(),
      maxAuY: toAtomicUnits(maxY, pool2.coinInfoY.decimals).toString(),
      minAuLP: toAtomicUnits(minLP, pool2.coinInfoLP.decimals).toString(),
      maxPoolAuLP: toAtomicUnits(
        maxPoolLP,
        pool2.coinInfoLP.decimals
      ).toString(),
      minPoolAuX: toAtomicUnits(minPoolX, pool2.coinInfoX.decimals).toString(),
      minPoolAuY: toAtomicUnits(minPoolY, pool2.coinInfoY.decimals).toString()
    };
    const transaction = await this.auxClient.sendOrSimulateTransaction(
  ...
  async removeLiquidity({
    ...
    const pool2 = await this.query();
    const amountAuLP = toAtomicUnits(amountLP, pool2.coinInfoLP.decimals).toU64();
    const input = {
      amountAuLP,
      coinTypeX: pool2.coinInfoX.coinType,
      coinTypeY: pool2.coinInfoY.coinType,
      coinInfoLP: pool2.coinInfoLP
    };
    const payload = (useAuxAccount != null ? useAuxAccount : false) ? removeLiquidityWithAccountPayload(this.auxClient.moduleAddress, input) : removeLiquidityPayload(this.auxClient.moduleAddress, input);
    const transaction = await this.auxClient.sendOrSimulateTransaction(
      payload,
      options
    );
  ...
  async position(owner) {
    ...
    const position = resources.find((resource) => resource.type === coinStoreLP);
    if (_.isUndefined(position)) {
      return void 0;
    }
    const amountLP = AU(position.data.coin.value).toDecimalUnits(
      pool2.coinInfoLP.decimals
    );
    const share = amountLP.toNumber() === 0 ? 0 : amountLP.toNumber() / pool2.amountLP.toNumber();
    return {
      owner,
      coinInfoX: pool2.coinInfoX,
      coinInfoY: pool2.coinInfoY,
      coinInfoLP: pool2.coinInfoLP,
      amountX: DU(share * pool2.amountX.toNumber()),
      amountY: DU(share * pool2.amountY.toNumber()),
      amountLP,
      share
    };
  }
  ...
  async poolEvents(query2) {
    const [swaps, adds, removes] = await Promise.all([
      this.swapEvents(query2),
      this.addLiquidityEvents(query2),
      this.removeLiquidityEvents(query2)
    ]);
    return [swaps, adds, removes].flat();
  }
  async swapEvents(query2) {
    query2 = query2 != null ? query2 : { limit: new BN(100) };
    const queryParameter = "limit" in query2 ? query2.limit : query2.start;
    const queryFunction = "limit" in query2 ? this.auxClient.getEventsByEventHandleWithLookback.bind(this.auxClient) : this.auxClient.getEventsByEventHandleSince.bind(this.auxClient);
    const events2 = await queryFunction(
      this.auxClient.moduleAddress,
      this.type,
      "swap_events",
      queryParameter
    );
    return events2.map(parseRawSwapEvent);
  }
  async addLiquidityEvents(query2) {
    query2 = query2 != null ? query2 : { limit: new BN(100) };
    const queryParameter = "limit" in query2 ? query2.limit : query2.start;
    const queryFunction = "limit" in query2 ? this.auxClient.getEventsByEventHandleWithLookback.bind(this.auxClient) : this.auxClient.getEventsByEventHandleSince.bind(this.auxClient);
    const events2 = await queryFunction(
    ...
    return events2.map(parseRawAddLiquidityEvent);
  }
  async removeLiquidityEvents(query2) {
    query2 = query2 != null ? query2 : { limit: new BN(100) };
    const queryParameter = "limit" in query2 ? query2.limit : query2.start;
    const queryFunction = "limit" in query2 ? this.auxClient.getEventsByEventHandleWithLookback.bind(this.auxClient) : this.auxClient.getEventsByEventHandleSince.bind(this.auxClient);
    const events2 = await queryFunction(
    ...
    return events2.map(parseRawRemoveLiquidityEvent);
  }
  async swapExactIn({ coinTypeIn, exactAmountIn, parameters }, options = {}) {
    var _a2;
    ...
    if ("minAmountOut" in parameters) {
      payload = swapExactCoinForCoinPayload$1(this.auxClient.moduleAddress, {
        coinTypeIn,
        coinTypeOut,
        exactAmountAuIn,
      ...
      if (!_.isUndefined(parameters.priceImpact)) {
        const pool2 = await this.query();
        const spotPrice = pool2.amountY.toNumber() / pool2.amountX.toNumber();
      ...
      const slippageMultiplier = 1 - ((_a2 = parameters.slippage) != null ? _a2 : _ConstantProductClient.defaultSlippage).toNumber();
      const minAmountAuOut = DU(quote.toNumber() * slippageMultiplier).toAtomicUnits(coinInfoOut.decimals).toString();
      payload = swapExactCoinForCoinPayload$1(this.auxClient.moduleAddress, {
        coinTypeIn,
        coinTypeOut,
        exactAmountAuIn,
  ...
  async swapExactOut({ coinTypeOut, exactAmountOut, parameters }, options = {}) {
    var _a2;
    parameters = parameters != null ? parameters : {};
    ...
    if ("maxAmountIn" in parameters && "maxAmountInPerOut" in parameters) {
      ...
      payload = swapCoinForExactCoinPayload$1(this.auxClient.moduleAddress, {
        coinTypeIn,
        coinTypeOut,
        exactAmountAuOut,
        maxAmountAuIn: toAtomicUnits(
      ...
      const slippageMultiplier = 1 + ((_a2 = parameters.slippage) != null ? _a2 : _ConstantProductClient.defaultSlippage).toNumber();
      const maxAmountAuIn = DU(quote.toNumber() * slippageMultiplier).toAtomicUnits(coinInfoIn.decimals).toString();
      payload = swapCoinForExactCoinPayload$1(this.auxClient.moduleAddress, {
        coinTypeIn,
        coinTypeOut,
        exactAmountAuOut,
  ...
  async quoteExactIn({
    ...
    const pool2 = await this.query();
    const [coinInfoIn, _2] = await this.exactInCoinInfos(coinTypeIn);
    const [reserveIn, reserveOut] = coinTypeIn === pool2.coinInfoX.coinType ? [pool2.amountX, pool2.amountY] : [pool2.amountY, pool2.amountX];
    const amountIn = toAtomicUnits(exactAmountIn, coinInfoIn.decimals).toDecimalUnits(coinInfoIn.decimals).toNumber() * (1 - pool2.fee.toNumber() / 100);
    const expectedAmountOut = amountIn * reserveOut.toNumber() / (reserveIn.toNumber() + amountIn);
  ...
  async quoteExactOut({
    ...
    const pool2 = await this.query();
    const [_2, coinInfoOut] = await this.exactOutCoinInfos(coinTypeOut);
    const [reserveIn, reserveOut] = coinTypeOut === pool2.coinInfoY.coinType ? [pool2.amountX, pool2.amountY] : [pool2.amountY, pool2.amountX];
    const feeRatio = 1 - pool2.fee.toNumber() / 100;
    const amountOut = toAtomicUnits(exactAmountOut, coinInfoOut.decimals).toDecimalUnits(coinInfoOut.decimals).toNumber();
    const expectedAmountOut = reserveIn.toNumber() * amountOut / ((reserveOut.toNumber() - amountOut) * feeRatio);
    return DU(expectedAmountOut);
  }
  async exactInCoinInfos(coinTypeIn) {
    const pool2 = await this.query();
    const [coinInfoIn, coinInfoOut] = coinTypeIn === pool2.coinInfoX.coinType ? [pool2.coinInfoX, pool2.coinInfoY] : [pool2.coinInfoY, pool2.coinInfoX];
    return [coinInfoIn, coinInfoOut];
  }
  async exactOutCoinInfos(coinTypeOut) {
    const pool2 = await this.query();
    const [coinInfoIn, coinInfoOut] = coinTypeOut === pool2.coinInfoY.coinType ? [pool2.coinInfoX, pool2.coinInfoY] : [pool2.coinInfoY, pool2.coinInfoX];
    return [coinInfoIn, coinInfoOut];
  }
  ...
  parseAddLiquidityTransaction(transaction) {
    return this.parsePoolTransaction(
      transaction,
  ...
  parseRemoveLiquidityTransaction(transaction) {
    return this.parsePoolTransaction(
      transaction,
  ...
  parsePoolTransaction(transaction, poolEventType, parse) {
    const events2 = transaction.events.filter(
      (event) => event.type === poolEventType
    );
    if (!transaction.success) {
      return { transaction, result: void 0 };
    }
    if (events2.length > 1) {
      throw new Error(
    ...
    return {
      transaction,
      result: parse(events2[0])
    };
  }
};
let ConstantProductClient = _ConstantProductClient;
__publicField(ConstantProductClient, "defaultSlippage", new Bps(50));
function parseRawEventsFromTx(auxClient2, tx) {
  return parseRawEvents(auxClient2, tx.events);
}
function parseRawEvents(auxClient2, rawEvent) {
  return rawEvent.map((event) => {
    switch (event.type) {
      case `${auxClient2.moduleAddress}::clob_market::OrderFillEvent`: {
        return parseRawOrderFillEvent(event);
      }
      case `${auxClient2.moduleAddress}::clob_market::OrderCancelEvent`: {
        return parseRawOrderCancelEvent(event);
      }
      case `${auxClient2.moduleAddress}::clob_market::OrderPlacedEvent`: {
        return parseRawOrderPlacedEvent(event);
      }
      default:
...
function parseRawOrderFillEvents(events2) {
  return events2.map((event) => parseRawOrderFillEvent(event));
}
function parseRawOrderCancelEvents(events2) {
  return events2.map((event) => parseRawOrderCancelEvent(event));
}
function parseRawOrderPlacedEvents(events2) {
  return events2.map((event) => parseRawOrderPlacedEvent(event));
}
function parseRawOrderFillEvent(raw) {
  return {
    type: "OrderFillEvent",
...
function parseRawOrderCancelEvent(raw) {
  return {
...
function parseRawOrderPlacedEvent(raw) {
  return {
...
async function swapExactCoinForCoin(auxClient2, swapInput, options = {}) {
  const tx = auxClient2.sendOrSimulateTransaction(
    swapExactCoinForCoinPayload(auxClient2, swapInput),
    options
  );
  return tx.then(async (tx2) => {
    return parseRouterEvents(auxClient2, tx2);
  });
}
async function swapCoinForExactCoin(auxClient2, swapInput, options = {}) {
  const tx = auxClient2.sendOrSimulateTransaction(
    swapCoinForExactCoinPayload(auxClient2, swapInput),
    options
  );
  return tx.then(async (tx2) => {
    return parseRouterEvents(auxClient2, tx2);
...
function swapExactCoinForCoinPayload(auxClient2, swapInput) {
  return {
    function: `${auxClient2.moduleAddress}::router::swap_exact_coin_for_coin_with_signer`,
    type_arguments: [swapInput.coinTypeIn, swapInput.coinTypeOut],
    arguments: [swapInput.exactAmountAuIn, swapInput.minAmountAuOut]
  };
}
function swapCoinForExactCoinPayload(auxClient2, swapInput) {
  return {
    function: `${auxClient2.moduleAddress}::router::swap_coin_for_exact_coin_with_signer`,
    type_arguments: [swapInput.coinTypeIn, swapInput.coinTypeOut],
    arguments: [swapInput.maxAmountAuIn, swapInput.exactAmountAuOut]
  };
}
function parseRouterEvents(auxClient2, tx) {
  const payload = tx.events.reverse().filter(
    (e2) => e2.type == `${auxClient2.moduleAddress}::clob_market::OrderFillEvent` || e2.type == `${auxClient2.moduleAddress}::amm::SwapEvent`
  ).map((ev) => {
    switch (ev.type) {
      case `${auxClient2.moduleAddress}::clob_market::OrderFillEvent`: {
        return parseRawOrderFillEvent(ev);
      }
      case `${auxClient2.moduleAddress}::amm::SwapEvent`: {
        return {
          kind: "SwapEvent",
          type: ev.type,
...
async function getRouterQuote(auxClient2, type, txResult, combine, coinIn, coinOut) {
  const tx = txResult.transaction;
  if (_.isUndefined(txResult.result)) {
    return { transaction: tx, result: void 0 };
  }
  let quote = {
    type,
  ...
  for (let event of txResult.result) {
    ...
    if ("owner" in event) {
      ...
      route = await orderFillEventToRoute(auxClient2, event, coinIn, coinOut);
    } else {
    ...
    if (combine) {
      let maybeRoute = quote.routes.find((r) => {
        return r.coinIn === route.coinIn && r.coinOut === route.coinOut && r.venue === route.venue;
      });
      if (maybeRoute !== void 0) {
        ...
        if (route.initPriceNum < maybeRoute.initPriceNum || route.initPriceDenom > maybeRoute.initPriceDenom) {
        ...
        let finalPrice = maybeRoute.amountIn.toNumber() / maybeRoute.amountOut.toNumber();
        maybeRoute.priceImpactPct = (finalPrice - initPrice) / initPrice * 100;
        continue;
      }
    }
...
function swapEventToRoute(swapEvent) {
  let initPrice = swapEvent.reserveIn.toNumber() / swapEvent.reserveOut.toNumber();
  let finalPrice = (swapEvent.reserveIn.toNumber() + swapEvent.amountIn.toNumber()) / (swapEvent.reserveOut.toNumber() - swapEvent.amountOut.toNumber());
  ...
  return {
    ...
    feeAmount: AU(swapEvent.feeBps * swapEvent.amountIn.toNumber() / 1e4),
    rebateAmount: AU(0),
...
async function orderFillEventToRoute(auxClient2, fillEvent, coinIn, coinOut) {
  let amountIn;
  let amountOut;
  let initPriceNum;
  let initPriceDenom;
  ...
  let quoteCoinInfo;
  if (fillEvent.isBid) {
    baseCoinInfo = await auxClient2.getCoinInfo(coinOut);
    quoteCoinInfo = await auxClient2.getCoinInfo(coinIn);
    const baseDecimals = baseCoinInfo.decimals;
    amountIn = AU(
      fillEvent.price.toNumber() * fillEvent.baseQuantity.toNumber() / Math.pow(10, baseDecimals) + fillEvent.fee.toNumber() - fillEvent.rebate.toNumber()
    );
    amountOut = fillEvent.baseQuantity;
    initPriceNum = fillEvent.price.toNumber();
    initPriceDenom = Math.pow(10, baseDecimals);
  } else {
    baseCoinInfo = await auxClient2.getCoinInfo(coinIn);
    quoteCoinInfo = await auxClient2.getCoinInfo(coinIn);
    const baseDecimals = baseCoinInfo.decimals;
  ...
  async swapExactCoinForCoin({
    ...
    return swapExactCoinForCoin(
      this.client,
      {
        ...
        coinTypeIn,
        coinTypeOut,
        exactAmountAuIn: (await this.client.toAtomicUnits(coinTypeIn, exactAmountIn)).toU64(),
        minAmountAuOut: (await this.client.toAtomicUnits(coinTypeOut, minAmountOut)).toU64()
      },
      options
    );
  }
  async swapCoinForExactCoin({
    ...
    return swapCoinForExactCoin(
      this.client,
      {
        coinTypeIn,
        coinTypeOut,
        maxAmountAuIn: (await this.client.toAtomicUnits(coinTypeIn, maxAmountIn)).toU64(),
        exactAmountAuOut: (await this.client.toAtomicUnits(coinTypeOut, exactAmountOut)).toU64()
      },
      options
    );
  }
...
class AuxClient {
  constructor(aptosNetwork, aptosClient, faucetClient) {
    __publicField(this, "moduleAddress");
    __publicField(this, "moduleAuthority");
    __publicField(this, "simulator");
    __publicField(this, "options");
    __publicField(this, "coinInfo");
    __publicField(this, "vaults");
    this.aptosNetwork = aptosNetwork;
    this.aptosClient = aptosClient;
    this.faucetClient = faucetClient;
    this.options = {};
    this.coinInfo = /* @__PURE__ */ new Map();
    this.vaults = /* @__PURE__ */ new Map();
    switch (aptosNetwork) {
      case "mainnet":
        this.moduleAddress = "0xbd35135844473187163ca197ca93b2ab014370587bb0ed3befff9e902d6bb541";
        this.simulator = {
          address: "0x73daac91bd205cec351524974cfae156985f947e07d55f2acfcb38981fdb8898",
        ...
        break;
      case "testnet":
        this.moduleAddress = "0x8b7311d78d47e37d09435b8dc37c14afd977c5cfa74f974d45f0258d986eef53";
        this.simulator = {
          address: "0x490d9592c7f246ecd5eef80e0e5592fef813d0adb43b26dbedc0d045282c36b8",
          publicKey: toEd25519PublicKey(
        ...
        break;
      case "devnet":
        this.moduleAddress = "0xea383dc2819210e6e427e66b2b6aa064435bf672dc4bdc55018049f0c361d01a";
        this.simulator = {
          address: "0x84f372536c73df84327d2af63992f4443e2bd1aec8695fa85693e256fc1f904f",
          publicKey: toEd25519PublicKey(
      ...
      case "custom":
        ...
        if (_.isUndefined(profile)) {
          throw new Error(
            `Failed to create localnet AuxClient: Could not find required profile ${profile} in ~/.aptos/config.yaml`
          );
        }
        for (const [key, value] of Object.entries(profile)) {
          if (_.isUndefined(value)) {
            throw new Error(
              `Failed to create localnet AuxClient: Missing required key ${key} on profile ${profile} in ~/.aptos/config.yaml`
            );
          }
        }
        ...
        break;
      default:
        const exhaustiveCheck = aptosNetwork;
  ...
  async pools() {
    ...
    return resources.filter(
      (resource) => resource.type.startsWith(`${this.moduleAddress}::amm::Pool`)
    ).map((resource) => resource.type).map(parsePoolType);
  }
  async stakePools() {
    const resources = await this.aptosClient.getAccountResources(
      this.moduleAddress
    ...
    return resources.filter(
      (resource) => resource.type.startsWith(`${this.moduleAddress}::stake::Pool`)
    ).map((resource) => resource.type).map(parsePoolType);
  }
  async getAccountResourceOptional(accountAddress, resourceType, query2) {
    try {
  ...
  async getEventsByEventHandleRange(address, eventHandleStruct, fieldName, firstSequenceNumber, lastSequenceNumber) {
    const allEvents = [];
    for (let s2 = firstSequenceNumber; s2.lt(lastSequenceNumber); s2 = s2.addn(100)) {
      const distance = lastSequenceNumber.sub(s2);
      const limit = distance.ltn(100) ? distance.toNumber() : 100;
      const events2 = await this.aptosClient.getEventsByEventHandle(
        address,
        eventHandleStruct,
        fieldName,
        {
          start: BigInt(s2.toString()),
          limit
        }
      );
  ...
  async getEventsByEventHandleSince(address, eventHandleStruct, fieldName, firstSequenceNumber) {
    firstSequenceNumber = firstSequenceNumber != null ? firstSequenceNumber : new BN(0);
    const allEvents = [];
  ...
  async getEventsByEventHandleWithLookback(address, eventHandleStruct, fieldName, maxLookback) {
    maxLookback = maxLookback != null ? maxLookback : new BN(100);
    const allEvents = [];
    const tailEvents = await this.aptosClient.getEventsByEventHandle(
      address,
      eventHandleStruct,
    ...
    if (tailEvents.length > 0) {
      ...
      const firstSequenceNumberToQuery = firstEventSequenceNumber.gt(
        remainderToQuery
      ) ? firstEventSequenceNumber.sub(remainderToQuery) : new BN(0);
      allEvents.push(
        ...await this.getEventsByEventHandleRange(
          address,
          eventHandleStruct,
  ...
  async getVaultAddress(account2) {
    const got = this.vaults.get(account2.toShortString());
    if (got !== void 0) {
      return got;
    }
    const type = `${this.moduleAddress}::onchain_signer::OnchainSigner`;
    const signer = await this.getAccountResourceOptional(account2, type);
    if (signer === void 0) {
      return void 0;
    }
    const signerHex = new HexString(signer.data.account_address);
    this.vaults.set(account2.toShortString(), signerHex);
    return signerHex;
  }
  getAuxCoin() {
  ...
  async getCoinBalance({
    ...
    if (coinResource === void 0) {
      return AU(0);
    }
    const coinBalance = coinResource.data.coin.value;
  ...
  async getCoinBalanceDecimals({
    ...
    const auBalance = await this.getCoinBalance({ account: account2, coinType });
    return auBalance.toDecimalUnits(
      (await this.getCoinInfo(coinType)).decimals
    );
  }
  async getCoinInfo(coinType, refresh) {
    const got = this.coinInfo.get(coinType);
    if ((refresh === void 0 || !refresh) && got !== void 0) {
      return got;
    }
  ...
  async fundAccount({
    ...
    return this.faucetClient.fundAccount(account2, au.toNumber());
  }
  async ensureMinimumFakeCoinBalance({
    ...
    if (balance.amount.lt(minAu.amount)) {
      const amount = replenishQuantity === void 0 ? minQuantity : replenishQuantity;
      await this.registerAndMintFakeCoin(coin, amount);
    }
    return balance;
  }
  async burnAllFakeCoin(coin, options = {}) {
    var _a2;
    const sender = (_a2 = options.sender) != null ? _a2 : this.sender;
  ...
  getUnwrappedFakeCoinType(coin) {
    return `${this.moduleAddress}::fake_coin::${coin}`;
  }
  getWrappedFakeCoinType(coin) {
    return `${this.moduleAddress}::fake_coin::FakeCoin<${this.getUnwrappedFakeCoinType(coin)}>`;
  }
  async getFakeCoinInfo(coin) {
    const coinType = this.getWrappedFakeCoinType(coin);
    return this.getCoinInfo(coinType);
  }
  async toAtomicUnits(coin, amount) {
    if (amount instanceof AtomicUnits) {
      return amount;
    }
  ...
  async toDecimalUnits(coin, amount) {
  ...
  async registerAndMintFakeCoin(coin, amount, options = {}) {
    const coinType = this.getWrappedFakeCoinType(coin);
  ...
  async getFakeCoinBalance(owner, coin) {
    const account2 = await this.getAccountResourceOptional(
      owner,
    ...
    return AU(account2.data.coin.value);
  }
  async burnFakeCoin(coin, amount, options = {}) {
  ...
  async mintAux(recipient, amount, options = {}) {
  ...
  async sendOrSimulateTransaction(payload, options = {}) {
    var _a2, _b;
    _.defaults(options, this.options);
    const simulate = (_a2 = options == null ? void 0 : options.simulate) != null ? _a2 : false;
    const sender = (_b = options == null ? void 0 : options.sender) != null ? _b : this.sender;
    if (!simulate && _.isUndefined(sender)) {
      throw new Error(`Error sending tx. Sender is undefined but required.`);
    }
    return simulate ? this.simulateTransaction(payload, this.simulator) : this.sendTransaction(payload, options);
  }
  async simulateTransaction(payload, simulator) {
    var _a2;
    const simulator_ = simulator != null ? simulator : this.simulator;
    ...
    const userTransaction = await this.aptosClient.simulateTransaction(
      (_a2 = simulator == null ? void 0 : simulator.publicKey) != null ? _a2 : this.simulator.publicKey,
      rawTransaction,
      {
  ...
  toSubmitTransactionRequest(options) {
    var _a2, _b, _c, _d, _e2;
    return _.pickBy(
      {
        sender: (_a2 = this.sender) == null ? void 0 : _a2.address().toString(),
        sequence_number: (_b = options == null ? void 0 : options.sequenceNumber) == null ? void 0 : _b.toString(),
        max_gas_amount: (_c = options == null ? void 0 : options.maxGasAmount) == null ? void 0 : _c.toString(),
        gas_unit_price: (_d = options == null ? void 0 : options.gasUnitPrice) == null ? void 0 : _d.toString(),
        expiration_timestamp_secs: (_e2 = options == null ? void 0 : options.expirationTimestampSecs) == null ? void 0 : _e2.toString()
      },
  ...
  toExtraArgs(options) {
    return _.pickBy(
      {
        timeoutSecs: options == null ? void 0 : options.timeoutSecs,
...
class AuxClientError extends Error {
  constructor(msg) {
    super(msg);
    Object.setPrototypeOf(this, AuxClientError.prototype);
  }
}
function parseTypeArgs(typeName) {
  const types = [];
...
function deriveModuleAddress(sender) {
  return deriveResourceAccountAddress(sender.address().toString(), "aux");
}
function deriveResourceAccountAddress(originAddress, seed) {
  ...
  return "0x" + sha3.exports.sha3_256(mergedArray);
}
function toEd25519PublicKey(hexString) {
  return new aptos_types_exports.Ed25519PublicKey(
    new HexString(hexString).toUint8Array()
  );
}
function parsePoolType(poolType) {
  const [coinTypeX, coinTypeY] = parseTypeArgs(poolType);
  if (coinTypeX === void 0 || coinTypeY === void 0) {
...
var OrderType$1 = /* @__PURE__ */ ((OrderType2) => {
  OrderType2[OrderType2["LIMIT_ORDER"] = 100] = "LIMIT_ORDER";
  OrderType2[OrderType2["FILL_OR_KILL_ORDER"] = 101] = "FILL_OR_KILL_ORDER";
  OrderType2[OrderType2["IMMEDIATE_OR_CANCEL_ORDER"] = 102] = "IMMEDIATE_OR_CANCEL_ORDER";
  OrderType2[OrderType2["POST_ONLY_ORDER"] = 103] = "POST_ONLY_ORDER";
  OrderType2[OrderType2["PASSIVE_JOIN_ORDER"] = 104] = "PASSIVE_JOIN_ORDER";
  return OrderType2;
})(OrderType$1 || {});
var STPActionType = /* @__PURE__ */ ((STPActionType2) => {
  STPActionType2[STPActionType2["CANCEL_PASSIVE"] = 200] = "CANCEL_PASSIVE";
  STPActionType2[STPActionType2["CANCEL_AGGRESSIVE"] = 201] = "CANCEL_AGGRESSIVE";
  STPActionType2[STPActionType2["CANCEL_BOTH"] = 202] = "CANCEL_BOTH";
  return STPActionType2;
})(STPActionType || {});
async function createMarket(auxClient2, createMarketInput, options = {}) {
  return auxClient2.sendOrSimulateTransaction(
    createMarketPayload(auxClient2, createMarketInput),
    { ...options, sender: createMarketInput.sender }
  );
}
async function placeOrder(auxClient2, placeOrderInput, options = {}) {
  const tx = auxClient2.sendOrSimulateTransaction(
    placeOrderPayload(auxClient2, placeOrderInput),
    { ...options, sender: placeOrderInput.sender }
  );
  return tx.then((tx2) => {
    return {
      transaction: tx2,
      result: parseRawEventsFromTx(auxClient2, tx2)
    };
  });
}
async function cancelOrder(auxClient2, cancelOrderInput, options = {}) {
  return auxClient2.sendOrSimulateTransaction(
    cancelOrderPayload(auxClient2, cancelOrderInput),
    { ...options, sender: cancelOrderInput.sender }
  );
}
async function cancelAll(auxClient2, cancelAllInput, options = {}) {
  return auxClient2.sendOrSimulateTransaction(
    cancelAllPayload(auxClient2, cancelAllInput),
    { ...options, sender: cancelAllInput.sender }
  );
}
function createMarketPayload(auxClient2, createMarketInput) {
  return {
    function: `${auxClient2.moduleAddress}::clob_market::create_market`,
    type_arguments: [
...
function placeOrderPayload(auxClient2, placeOrderInput) {
  return {
    function: `${auxClient2.moduleAddress}::clob_market::place_order`,
    type_arguments: [
      placeOrderInput.market.baseCoinInfo.coinType,
      placeOrderInput.market.quoteCoinInfo.coinType
    ],
    arguments: [
      placeOrderInput.delegator !== void 0 ? placeOrderInput.delegator : placeOrderInput.sender.address().toString(),
      ...
      placeOrderInput.directionAggressive !== void 0 ? placeOrderInput.directionAggressive : false,
      placeOrderInput.timeoutTimestamp !== void 0 ? placeOrderInput.timeoutTimestamp : MAX_U64$1,
      placeOrderInput.stpActionType !== void 0 ? placeOrderInput.stpActionType : 200
    ]
  };
}
function cancelOrderPayload(auxClient2, cancelOrderInput) {
  return {
    function: `${auxClient2.moduleAddress}::clob_market::cancel_order`,
    type_arguments: [
      cancelOrderInput.baseCoinType,
      cancelOrderInput.quoteCoinType
    ],
    arguments: [
      cancelOrderInput.delegator !== void 0 ? cancelOrderInput.delegator : cancelOrderInput.sender.address().toString(),
      cancelOrderInput.orderId
    ]
  };
}
function cancelAllPayload(auxClient2, cancelAllInput) {
  return {
    function: `${auxClient2.moduleAddress}::clob_market::cancel_all`,
    type_arguments: [cancelAllInput.baseCoinType, cancelAllInput.quoteCoinType],
    arguments: [
      cancelAllInput.delegator !== void 0 ? cancelAllInput.delegator : cancelAllInput.sender.address().toString()
    ]
  };
}
async function orderFillEvents(auxClient2, clobAddress, market2, pagination) {
  pagination = pagination != null ? pagination : { limit: new BN(100) };
  const queryFunction = "start" in pagination ? auxClient2.getEventsByEventHandleSince.bind(auxClient2) : auxClient2.getEventsByEventHandleWithLookback.bind(auxClient2);
  const queryValue = "start" in pagination ? pagination.start : pagination.limit;
  const fillEvents = await queryFunction(
    clobAddress,
    market2.type,
    "fill_events",
    queryValue
...
async function orderPlacedEvents(auxClient2, clobAddress, market2, pagination) {
  pagination = pagination != null ? pagination : { limit: new BN(100) };
  const queryFunction = "start" in pagination ? auxClient2.getEventsByEventHandleSince.bind(auxClient2) : auxClient2.getEventsByEventHandleWithLookback.bind(auxClient2);
  const queryValue = "start" in pagination ? pagination.start : pagination.limit;
  const placedEvents = await queryFunction(
    clobAddress,
    market2.type,
    "placed_events",
    queryValue
...
async function orderCancelEvents(auxClient2, clobAddress, market2, pagination) {
  pagination = pagination != null ? pagination : { limit: new BN(100) };
  const queryFunction = "start" in pagination ? auxClient2.getEventsByEventHandleSince.bind(auxClient2) : auxClient2.getEventsByEventHandleWithLookback.bind(auxClient2);
  const queryValue = "start" in pagination ? pagination.start : pagination.limit;
  const cancelEvents = await queryFunction(
    clobAddress,
    market2.type,
    "cancel_events",
    queryValue
...
async function market$1(auxClient2, baseCoinType, quoteCoinType) {
  var _a2, _b;
  const type = `${auxClient2.moduleAddress}::clob_market::Market<${baseCoinType}, ${quoteCoinType}>`;
  const [resource, baseCoinInfo, quoteCoinInfo] = await Promise.all([
    auxClient2.aptosClient.getAccountResource(auxClient2.moduleAddress, type),
    auxClient2.getCoinInfo(baseCoinType),
    auxClient2.getCoinInfo(quoteCoinType)
  ]);
  const rawMarket = resource;
  const tickSize = new AtomicUnits(rawMarket.data.tick_size);
  const payload = {
    function: `${auxClient2.moduleAddress}::clob_market::load_market_into_event`,
    type_arguments: [baseCoinType, quoteCoinType],
    arguments: []
  };
  const txResult = await auxClient2.simulateTransaction(payload);
  const l2 = txResult.events[0];
  const bids = ((_a2 = l2 == null ? void 0 : l2.data.bids) != null ? _a2 : []).map((bid) => ({
    price: AU(bid.price).toDecimalUnits(quoteCoinInfo.decimals),
    quantity: AU(bid.quantity).toDecimalUnits(baseCoinInfo.decimals)
  }));
  const asks = ((_b = l2 == null ? void 0 : l2.data.asks) != null ? _b : []).map((ask) => ({
...
async function orderbook(auxClient2, baseCoinType, quoteCoinType, simulator) {
  const payload = {
    function: `${auxClient2.moduleAddress}::clob_market::load_all_orders_into_event`,
    type_arguments: [baseCoinType, quoteCoinType],
    arguments: []
  };
  const txResult = await auxClient2.simulateTransaction(payload, simulator);
  const event = txResult.events[0];
  const bids = event.data.bids.map((level) => {
    return {
  ...
  const asks = event.data.asks.map((level) => {
    return {
      price: AU(level[0].price),
      orders: level.map((order) => {
        const auxBurned = order.aux_au_to_burn_per_lot;
...
async function openOrders(auxClient2, owner, baseCoinType, quoteCoinType, simulator) {
  const payload = {
    function: `${auxClient2.moduleAddress}::clob_market::load_open_orders_into_event_for_address`,
    type_arguments: [baseCoinType, quoteCoinType],
    arguments: [owner]
  };
  simulator = simulator != null ? simulator : auxClient2.simulator;
  const txResult = await auxClient2.simulateTransaction(payload, simulator);
  const event = txResult.events[0];
...
async function orderHistory(auxClient2, baseCoinType, quoteCoinType, owner, pagination) {
  const market_ = await market$1(auxClient2, baseCoinType, quoteCoinType);
  const orders = await orderPlacedEvents(
    auxClient2,
    auxClient2.moduleAddress,
    market_,
    pagination
  );
...
async function fillHistory(auxClient2, baseCoinType, quoteCoinType, owner, pagination) {
  const fills = await orderFillEvents(
    auxClient2,
    auxClient2.moduleAddress,
    await market$1(auxClient2, baseCoinType, quoteCoinType),
    pagination
  );
  if (_.isUndefined(owner)) {
    return fills;
...
async function markets(auxClient2) {
  const resources = await auxClient2.aptosClient.getAccountResources(
    auxClient2.moduleAddress
  );
  return resources.filter((resource) => resource.type.includes("Market<")).map((resource) => resource.type).map(parseMarketType);
}
function parseMarketType(marketType) {
  const [baseCoinType, quoteCoinType] = parseTypeArgs(marketType);
  if (baseCoinType === void 0 || quoteCoinType === void 0) {
...
class Market {
  constructor(kwargs) {
    __publicField(this, "auxClient");
    __publicField(this, "clobAddress");
    __publicField(this, "baseDecimals");
    __publicField(this, "quoteDecimals");
    __publicField(this, "lotSize");
    __publicField(this, "tickSize");
    __publicField(this, "nextOrderId");
    __publicField(this, "type");
    __publicField(this, "baseCoinInfo");
    __publicField(this, "quoteCoinInfo");
  ...
  static async index(auxClient2) {
    return markets(auxClient2);
  }
  static async create(auxClient2, createParams) {
    await createMarket(auxClient2, {
      ...createParams,
      baseLotSize: createParams.baseLotSize.toString(),
      quoteLotSize: createParams.quoteLotSize.toString()
    });
    return await Market.read(auxClient2, createParams);
  }
  static async read(auxClient2, { baseCoinType, quoteCoinType }) {
    const clobAddress = auxClient2.moduleAddress;
    const market2 = await market$1(
      auxClient2,
      baseCoinType,
      quoteCoinType
    );
    return new Market({
      auxClient: auxClient2,
      clobAddress,
      ...market2
    });
  }
  makeRoundLot(quantity) {
  ...
  async placeOrder({
    ...
    const limitPriceAu = this.makeRoundTick(
      toAtomicUnits(limitPrice, this.quoteDecimals)
    ).toU64();
    const quantityAu = this.makeRoundLot(
      toAtomicUnits(quantity, this.baseDecimals)
    ).toU64();
    const auxToBurnAu = toAtomicUnits(
      auxToBurn,
      6
    ).toU64();
    return placeOrder(
      ...
      {
        sender,
        delegator: delegator !== void 0 ? delegator : sender.address().toString(),
        isBid,
        limitPriceAu,
        quantityAu,
        auxToBurnAu,
        ...
        directionAggressive: directionAggressive !== void 0 ? directionAggressive : false,
        timeoutTimestamp: timeoutTimestamp !== void 0 ? timeoutTimestamp : MAX_U64,
        stpActionType: stpActionType !== void 0 ? stpActionType : STPActionType.CANCEL_PASSIVE
      },
      options
    );
  }
  async cancelOrder({
    ...
    return cancelOrder(this.auxClient, {
      sender,
      delegator: delegator !== void 0 ? delegator : sender.address().toString(),
  ...
  async cancelAll(sender, delegator) {
    return cancelAll(this.auxClient, {
      sender,
      delegator: delegator !== void 0 ? delegator : sender.address().toString(),
      baseCoinType: this.baseCoinInfo.coinType,
      quoteCoinType: this.quoteCoinInfo.coinType
  ...
  async update() {
    ...
    this.lotSize = market2.lotSize;
    this.tickSize = market2.tickSize;
    this.nextOrderId = market2.nextOrderId;
    this.l2 = market2.l2;
  }
  async fills(pagination) {
    return orderFillEvents(
      this.auxClient,
      this.clobAddress,
      this,
      pagination
  ...
  async orderbook(simulator) {
    return orderbook(
      ...
      this.baseCoinInfo.coinType,
      this.quoteCoinInfo.coinType,
      simulator != null ? simulator : this.auxClient.simulator
    );
  }
  async orderHistory(owner, pagination) {
    return orderHistory(
      this.auxClient,
      this.baseCoinInfo.coinType,
      this.quoteCoinInfo.coinType,
  ...
  async fillHistory(owner, pagination) {
    return fillHistory(
      this.auxClient,
      this.baseCoinInfo.coinType,
      this.quoteCoinInfo.coinType,
  ...
  static l2(market2, levels) {
    return levels.map((level) => {
      const sum = level.orders.map(
        (order) => order.quantity.toDecimalUnits(market2.baseCoinInfo.decimals).toNumber()
      ).reduce((a2, b2) => a2 + b2, 0);
      const quantity = DU(sum);
      return {
        price: level.price.toDecimalUnits(market2.quoteCoinInfo.decimals),
        quantity
      };
    });
  }
}
function createAuxAccountPayload(auxClient2) {
  return {
    function: `${auxClient2.moduleAddress}::vault::create_aux_account`,
    type_arguments: [],
    arguments: []
  };
}
function depositPayload$1(auxClient2, depositInput) {
  return {
    function: `${auxClient2.moduleAddress}::vault::deposit`,
    type_arguments: [depositInput.coinType],
    arguments: [
      depositInput.to !== void 0 ? depositInput.to : depositInput.sender.address().toString(),
      depositInput.amountAu
    ]
  };
}
function withdrawPayload$1(auxClient2, withdrawInput) {
  return {
    function: `${auxClient2.moduleAddress}::vault::withdraw`,
    type_arguments: [withdrawInput.coinType],
    arguments: [withdrawInput.amountAu]
  };
}
function transferPayload(auxClient2, transferInput) {
  return {
    function: `${auxClient2.moduleAddress}::vault::transfer`,
    type_arguments: [transferInput.coinType],
    arguments: [transferInput.recipient, transferInput.amountAu]
  };
}
async function balances(auxClient2, owner) {
  const address = await auxClient2.getVaultAddress(new HexString(owner));
  if (address === void 0) {
    return {
      balances: []
    };
  ...
  const balancePrefix = `${auxClient2.moduleAddress}::vault::CoinBalance<`;
  const balances2 = resources.filter((res) => {
    return res.type.startsWith(balancePrefix);
  });
  return {
    balances: balances2.map((res) => {
      return {
        key: {
          name: res.type
        },
        value: {
          balance: AU(res.data.balance),
          available_balance: AU(res.data.available_balance)
        }
      };
    })
  };
}
async function events(auxClient2, fieldName, predicate) {
  const events2 = await auxClient2.aptosClient.getEventsByEventHandle(
    auxClient2.moduleAddress,
    `${auxClient2.moduleAddress}::vault::Vault`,
    fieldName
  );
  ...
  const decimals = (await auxClient2.getCoinInfo(first.data.coinType)).decimals;
  return events2.filter(predicate).map((event) => {
    event.data.amount = AU(event.data.amount_au).toDecimalUnits(decimals);
    return event.data;
  });
}
async function transferEvents(auxClient2, owner) {
  return events(
    auxClient2,
    "transfer_events",
...
async function depositEvents(auxClient2, owner) {
  return events(
    auxClient2,
    "deposit_events",
    (event) => event.data.to === owner
  );
}
async function withdrawEvents(auxClient2, owner) {
  return events(
    auxClient2,
    "withdraw_events",
    (event) => event.data.owner === owner
  );
}
class AuxAccount {
  constructor(auxClient2, owner) {
    __publicField(this, "auxClient");
  ...
  async balances() {
    return balances(this.auxClient, this.owner);
  }
  async deposits() {
    return depositEvents(this.auxClient, this.owner);
  }
  async withdrawals() {
    return withdrawEvents(this.auxClient, this.owner);
  }
  async transfers() {
    return transferEvents(this.auxClient, this.owner);
  }
  poolPosition(poolInput) {
  ...
  async poolPositions() {
    ...
    const positions = await Promise.all(
      resources.filter(
        (resource) => resource.type.includes("amm::LP") && resource.type.includes("0x1::coin::CoinStore")
      ).map((resource) => resource.data).map(async (positionResource) => {
  ...
  async openOrders(marketInput) {
    const market2 = await Market.read(this.auxClient, marketInput);
    return market2.openOrders(this.owner);
  }
  async orderHistory(marketInput) {
    const market2 = await Market.read(this.auxClient, marketInput);
    return market2.orderHistory(this.owner);
  }
  async tradeHistory(marketInput) {
    const market2 = await Market.read(this.auxClient, marketInput);
    return market2.fillHistory(this.owner);
  }
}
...
class _fakeRedis {
  async get(v) {
    try {
      ...
      console.error(`failed to query ${v} because: ${e2}`);
      return "0";
    }
  }
}
const dataClient = new _fakeRedis();
const pubSubClient = new dist$1.PubSub();
var FeaturedStatus = /* @__PURE__ */ ((FeaturedStatus2) => {
  FeaturedStatus2["Hot"] = "HOT";
  FeaturedStatus2["None"] = "NONE";
  FeaturedStatus2["Promoted"] = "PROMOTED";
  return FeaturedStatus2;
})(FeaturedStatus || {});
...
function orderToOrder(order, baseCoinInfo, quoteCoinInfo) {
  const price = order.price.toDecimalUnits(quoteCoinInfo.decimals).toNumber();
  const quantity = order.quantity.toDecimalUnits(baseCoinInfo.decimals).toNumber();
  return {
    ...
    auxBurned: 0,
    time: order.timestamp.divn(1e3).toString(),
    price,
    quantity,
    value: price * quantity
  };
}
function orderPlacedEventToOrder(orderEvent, baseCoinInfo, quoteCoinInfo) {
  const price = orderEvent.price.toDecimalUnits(quoteCoinInfo.decimals).toNumber();
  const quantity = orderEvent.quantity.toDecimalUnits(baseCoinInfo.decimals).toNumber();
  return {
    baseCoinType: baseCoinInfo.coinType,
    quoteCoinType: quoteCoinInfo.coinType,
    ...
    auxBurned: 0,
    time: orderEvent.timestamp.divn(1e3).toString(),
    price: orderEvent.price.toDecimalUnits(quoteCoinInfo.decimals).toNumber(),
    quantity,
    value: price * quantity
  };
}
function orderFillEventToOrder(orderEvent, baseCoinInfo, quoteCoinInfo) {
  const price = orderEvent.price.toDecimalUnits(quoteCoinInfo.decimals).toNumber();
  const quantity = orderEvent.baseQuantity.toDecimalUnits(baseCoinInfo.decimals).toNumber();
  return {
    baseCoinType: baseCoinInfo.coinType,
    quoteCoinType: quoteCoinInfo.coinType,
    orderId: orderEvent.orderId.toString(),
...
const LATEST_PYTH_PRICE = /* @__PURE__ */ new Map();
function getRecognizedTVL(coinType, amount) {
  var _a2;
  if (ALL_USD_STABLES.includes(coinType)) {
    return amount;
  } else {
    const pythSymbol = (_a2 = COIN_MAPPING.get(coinType)) == null ? void 0 : _a2.pythSymbol;
    if (pythSymbol !== void 0) {
...
async function getUsdPrice(auxClient2, coinType) {
  var _a2, _b;
  const FAKE_STABLES = fakeStableTypes(auxClient2);
  if (ALL_USD_STABLES.includes(coinType) || FAKE_STABLES.includes(coinType)) {
    return 1;
  } else {
    const FAKE_MAPPING = await fakeMapping(auxClient2);
    const newCoinType = FAKE_MAPPING.get(coinType);
    if (!!newCoinType) {
      coinType = newCoinType;
    }
    const symbol = (_a2 = COIN_MAPPING.get(coinType)) == null ? void 0 : _a2.pythSymbol;
    if (!!symbol) {
      return LATEST_PYTH_PRICE.get(symbol);
    } else {
      const pools = await auxClient2.pools();
      for (let pool2 of pools) {
        let isX;
        if (pool2.coinTypeX === coinType && pool2.coinTypeY in ALL_USD_STABLES || pool2.coinTypeY in COIN_MAPPING.keys()) {
          isX = true;
        } else if (pool2.coinTypeY === coinType && pool2.coinTypeX in ALL_USD_STABLES || pool2.coinTypeX in COIN_MAPPING.keys()) {
          isX = false;
        }
        if (isX !== void 0) {
          let usdPriceOther;
          let otherCoinType;
          if (isX) {
            otherCoinType = pool2.coinTypeY;
          } else {
            otherCoinType = pool2.coinTypeX;
          }
          if (otherCoinType in ALL_USD_STABLES) {
            usdPriceOther = 1;
          } else {
            const pythSymbolOther = (_b = COIN_MAPPING.get(otherCoinType)) == null ? void 0 : _b.pythSymbol;
            if (!!pythSymbolOther) {
              usdPriceOther = LATEST_PYTH_PRICE.get(pythSymbolOther);
            }
          }
          if (!!usdPriceOther) {
            const client2 = new ConstantProductClient(auxClient2, pool2);
            const info = await client2.query();
            let usdPrice;
            if (isX) {
              usdPrice = info.amountY.toNumber() * usdPriceOther / info.amountX.toNumber();
            } else {
              usdPrice = info.amountX.toNumber() * usdPriceOther / info.amountY.toNumber();
            }
            return usdPrice;
          }
        }
...
function parseRawCreatePoolEvent(event, moduleAddress) {
...
function parseRawStakeDepositEvent(event, moduleAddress) {
  const coinTypes = parseEventType(event.type, moduleAddress);
  return {
...
function parseRawStakeWithdrawEvent(event, moduleAddress) {
  const coinTypes = parseEventType(event.type, moduleAddress);
  return {
...
function parseRawClaimEvent(event, moduleAddress) {
  const coinTypes = parseEventType(event.type, moduleAddress);
  return {
    kind: "ClaimEvent",
    type: event.type,
...
function parseRawModifyPoolEvent(event, moduleAddress) {
  const coinTypes = parseEventType(event.type, moduleAddress);
  return {
...
function parseEventType(type, moduleAddress) {
  var _a2, _b;
  const poolRegex = new RegExp(
    `${moduleAddress}::stake::(?<event>[a-zA-Z]+)<(?<stake>.*), (?<reward>.*)>`
  );
  const found = type.match(poolRegex);
  let stakeCoinType = (_a2 = found == null ? void 0 : found.groups) == null ? void 0 : _a2["stake"];
  let rewardCoinType = (_b = found == null ? void 0 : found.groups) == null ? void 0 : _b["reward"];
  return {
    stakeCoinType,
    rewardCoinType
  };
}
function createStakePoolPayload(moduleAddress, input) {
  return {
...
function depositPayload(moduleAddress, input) {
  return {
...
function withdrawPayload(moduleAddress, input) {
  return {
...
function claimPayload(moduleAddress, input) {
  return {
...
function modifyAuthorityPayload(moduleAddress, input) {
  return {
...
function modifyPoolPayload(moduleAddress, input) {
  return {
...
function deleteEmptyPoolPayload(moduleAddress, input) {
  return {
...
function endRewardEarlyPayload(moduleAddress, input) {
  return {
...
class StakePoolClient {
  constructor(auxClient2, { coinInfoReward, coinInfoStake }) {
    __publicField(this, "auxClient");
    __publicField(this, "type");
    __publicField(this, "coinInfoStake");
    __publicField(this, "coinInfoReward");
    this.auxClient = auxClient2;
    this.type = `${auxClient2.moduleAddress}::stake::Pool<${coinInfoStake.coinType}, ${coinInfoReward.coinType}>`;
    this.coinInfoStake = coinInfoStake;
    this.coinInfoReward = coinInfoReward;
  }
  async query() {
    const pool2 = (await this.auxClient.aptosClient.getAccountResource(
      this.auxClient.moduleAddress,
      this.type
    )).data;
    return {
      ...
      authority: pool2.authority,
      startTime: new BN(pool2.start_time),
      endTime: new BN(pool2.end_time),
      amountStaked: new AtomicUnits(pool2.stake.value).toDecimalUnits(
        this.coinInfoStake.decimals
      ),
      amountReward: new AtomicUnits(pool2.reward.value).toDecimalUnits(
        this.coinInfoReward.decimals
      ),
      rewardRemaining: new AtomicUnits(pool2.reward_remaining).toDecimalUnits(
        this.coinInfoReward.decimals
      ),
      lastUpdateTime: new BN(pool2.last_update_time),
      accRewardPerShare: new BN(pool2.acc_reward_per_share)
    };
  }
  async calcAccRewardPerShare({
    ...
    let pool2 = lastPoolState;
    if (!pool2) {
      pool2 = await this.query();
    }
    ...
    const timeSinceUpdate = timestamp.sub(pool2.lastUpdateTime);
    if (pool2.endTime.lte(timestamp)) {
      return pool2.accRewardPerShare;
    }
    const durationReward = Math.floor(
      timeSinceUpdate.toNumber() * pool2.rewardRemaining.toAtomicUnits(this.coinInfoReward.decimals).toNumber() / pool2.endTime.sub(pool2.lastUpdateTime).toNumber()
    );
    const stakeAu = pool2.amountStaked.toAtomicUnits(this.coinInfoStake.decimals).toBN();
    ...
    return pool2.accRewardPerShare.add(new BN(accRewardPerShare));
  }
  async calcApr(poolState, currentTimeUs) {
    let pool2 = poolState;
    if (!pool2) {
      pool2 = await this.query();
    }
    assert.exports.ok(!!pool2);
    ...
    if (!!rewardUsdPrice && !!stakeUsdPrice) {
      const remainingRewardUSD = pool2.rewardRemaining.toNumber() * rewardUsdPrice;
      const remainingDays = pool2.endTime.sub(currentTime).toNumber() / (24 * 3600 * 1e6);
      const dailyReward = remainingRewardUSD / remainingDays;
      const dailyRewardPerShare = pool2.amountStaked.toNumber() == 0 ? dailyReward : dailyReward / pool2.amountStaked.toNumber();
      const dailyReturn = dailyRewardPerShare / stakeUsdPrice;
      return dailyReturn * 365 * 100;
    }
    return void 0;
  }
  async queryUserPosition(userAddress) {
    ...
    const position = (await this.auxClient.aptosClient.getAccountResource(
      userAddress,
      userPositionType
    )).data;
    return {
  ...
  async calcPendingUserReward({
    ...
    const stakeAu = userPositionState.amountStaked.toAtomicUnits(this.coinInfoStake.decimals).toNumber();
    return AU(
      Math.floor(
        (accRewardPerShare.toNumber() - userPositionState.lastAccRewardPerShare.toNumber()) * stakeAu / 1e12
      )
    ).toDecimalUnits(this.coinInfoReward.decimals);
  }
  async createEvents(query2) {
    query2 = query2 != null ? query2 : { limit: new BN(100) };
    const queryParameter = "limit" in query2 ? query2.limit : query2.start;
    const queryFunction = "limit" in query2 ? this.auxClient.getEventsByEventHandleWithLookback.bind(this.auxClient) : this.auxClient.getEventsByEventHandleSince.bind(this.auxClient);
    const events2 = await queryFunction(
    ...
    const ret = events2.map(
      (e2) => parseRawCreatePoolEvent(e2, this.auxClient.moduleAddress)
    );
    return ret;
  }
  async depositEvents(query2) {
    query2 = query2 != null ? query2 : { limit: new BN(100) };
    const queryParameter = "limit" in query2 ? query2.limit : query2.start;
    const queryFunction = "limit" in query2 ? this.auxClient.getEventsByEventHandleWithLookback.bind(this.auxClient) : this.auxClient.getEventsByEventHandleSince.bind(this.auxClient);
    const events2 = await queryFunction(
    ...
    const ret = events2.map(
      (e2) => parseRawStakeDepositEvent(e2, this.auxClient.moduleAddress)
    );
    return ret;
  }
  async withdrawEvents(query2) {
    query2 = query2 != null ? query2 : { limit: new BN(100) };
    const queryParameter = "limit" in query2 ? query2.limit : query2.start;
    const queryFunction = "limit" in query2 ? this.auxClient.getEventsByEventHandleWithLookback.bind(this.auxClient) : this.auxClient.getEventsByEventHandleSince.bind(this.auxClient);
    const events2 = await queryFunction(
    ...
    const ret = events2.map(
      (e2) => parseRawStakeWithdrawEvent(e2, this.auxClient.moduleAddress)
    );
    return ret;
  }
  async claimEvents(query2) {
    query2 = query2 != null ? query2 : { limit: new BN(100) };
    const queryParameter = "limit" in query2 ? query2.limit : query2.start;
    const queryFunction = "limit" in query2 ? this.auxClient.getEventsByEventHandleWithLookback.bind(this.auxClient) : this.auxClient.getEventsByEventHandleSince.bind(this.auxClient);
    const events2 = await queryFunction(
    ...
    const ret = events2.map(
      (e2) => parseRawClaimEvent(e2, this.auxClient.moduleAddress)
    );
    return ret;
  }
  async modifyPoolEvents(query2) {
    query2 = query2 != null ? query2 : { limit: new BN(100) };
    const queryParameter = "limit" in query2 ? query2.limit : query2.start;
    const queryFunction = "limit" in query2 ? this.auxClient.getEventsByEventHandleWithLookback.bind(this.auxClient) : this.auxClient.getEventsByEventHandleSince.bind(this.auxClient);
    const events2 = await queryFunction(
    ...
    const ret = events2.map(
      (e2) => parseRawModifyPoolEvent(e2, this.auxClient.moduleAddress)
    );
    return ret;
  }
  async create({ rewardAmount, durationUs }, options = {}) {
  ...
  async modifyPool({
    ...
    const input = {
      coinTypeStake: this.coinInfoStake.coinType,
      coinTypeReward: this.coinInfoReward.coinType,
      rewardAmount: rewardAmount ? (_a2 = toAtomicUnits(rewardAmount, this.coinInfoReward.decimals).toU64()) != null ? _a2 : "0" : "0",
      rewardIncrease: rewardIncrease != null ? rewardIncrease : false,
      timeAmountUs: (_b = timeAmountUs == null ? void 0 : timeAmountUs.toString()) != null ? _b : "0",
      timeIncrease: timeIncrease != null ? timeIncrease : false
    };
    const transaction = await this.auxClient.sendOrSimulateTransaction(
  ...
  async modifyAuthority(newAuthority, options = {}) {
    const input = {
      coinTypeStake: this.coinInfoStake.coinType,
      coinTypeReward: this.coinInfoReward.coinType,
      newAuthority
  ...
  parseCreatePoolTransaction(transaction) {
  ...
  parseStakeDepositTransaction(transaction) {
    return this.parseStakePoolTransaction(
      transaction,
  ...
  parseStakeWithdrawTransaction(transaction) {
    return this.parseStakePoolTransaction(
      transaction,
  ...
  parseClaimTransaction(transaction) {
    return this.parseStakePoolTransaction(
      transaction,
  ...
  parseModifyPoolTransaction(transaction) {
    return this.parseStakePoolTransaction(
      transaction,
  ...
  parseStakePoolTransaction(transaction, poolEventType, parse) {
    const events2 = transaction.events.filter(
    ...
    return {
      transaction,
      result: parse(events2[0], this.auxClient.moduleAddress)
    };
  }
}
const HOT_POOLS = [];
const PROMOTED_POOLS = [];
const query = {
  address() {
    return auxClient.moduleAddress;
  },
  async summaryStatistics(_parent) {
    const getSummaryStatistic = async function(name, period) {
      if (name === "tvl") {
  ...
  async coins(parent) {
    ...
    const coinInfo = /* @__PURE__ */ new Map();
    for (const pool2 of allPools) {
      for (const coin of [
        pool2.coinInfos[0].coinType,
        pool2.coinInfos[1].coinType
      ]) {
        if (!coinInfo.has(coin)) {
          coinInfo.set(coin, {
            recognizedLiquidity: pool2.recognizedLiquidity,
            auLiquidity: pool2.auLiquidity,
            priority: getFeaturedPriority(pool2.featuredStatus)
          });
        } else {
          const info = coinInfo.get(coin);
          info.recognizedLiquidity += pool2.recognizedLiquidity;
          info.auLiquidity += pool2.auLiquidity;
          info.priority = Math.max(
            info.priority,
            getFeaturedPriority(pool2.featuredStatus)
          );
        }
      }
    }
    const allCoins = coins.map((coin) => {
      ...
      const recognizedLiquidity = thisCoinInfo === void 0 ? 0 : thisCoinInfo.recognizedLiquidity;
      const auLiquidity = thisCoinInfo === void 0 ? 0 : thisCoinInfo.auLiquidity;
      const priority = thisCoinInfo === void 0 ? 0 : thisCoinInfo.priority;
      return {
  ...
  async pool(_parent, { poolInput }) {
    ...
    const pool2 = await poolClient.query();
    const coins = await coinsWithoutLiquidity();
    const coinTypeToHippoNameSymbol = Object.fromEntries(
      coins.map((coin) => [coin.coinType, [coin.name, coin.symbol]])
    );
    return formatPool(pool2, coinTypeToHippoNameSymbol);
  },
  async pools(_parent, args) {
    const poolInputs = args.poolInputs ? args.poolInputs : (await auxClient.pools()).map((input) => ({
    ...
    const coinTypeToHippoNameSymbol = Object.fromEntries(
      hippoCoins.map((coin) => [coin.coinType, [coin.name, coin.symbol]])
    );
    const formattedPools = pools.filter((maybePool) => maybePool !== void 0 && maybePool !== null).map((pool2) => formatPool(pool2, coinTypeToHippoNameSymbol));
    formattedPools.sort((lhs, rhs) => {
      if (lhs.featuredStatus != rhs.featuredStatus) {
        return getFeaturedPriority(rhs.featuredStatus) - getFeaturedPriority(lhs.featuredStatus);
      }
      if (lhs.recognizedLiquidity != rhs.recognizedLiquidity) {
        return rhs.recognizedLiquidity - lhs.recognizedLiquidity;
      }
  ...
  async market(_parent, { marketInput }) {
    let market2;
    try {
      market2 = await Market.read(auxClient, marketInput);
    } catch (err) {
      return null;
    }
    const { baseCoinType, quoteCoinType } = marketInput;
    return {
      name: `${market2.baseCoinInfo.symbol}-${market2.quoteCoinInfo.symbol}`,
      baseCoinInfo: market2.baseCoinInfo,
      quoteCoinInfo: market2.quoteCoinInfo,
      lotSize: market2.lotSize.toNumber(),
      tickSize: market2.tickSize.toNumber(),
      lotSizeDecimals: market2.lotSize.toDecimalUnits(market2.baseCoinInfo.decimals).toString(),
      tickSizeDecimals: market2.tickSize.toDecimalUnits(market2.quoteCoinInfo.decimals).toString(),
      lotSizeString: market2.lotSize.toString(),
      tickSizeString: market2.tickSize.toString(),
      orderbook: {
        baseCoinType,
        quoteCoinType,
        bids: market2.l2.bids.map((l2Quote) => ({
          price: l2Quote.price.toNumber(),
          quantity: l2Quote.quantity.toNumber()
        })),
        asks: market2.l2.asks.map((l2Quote) => ({
          price: l2Quote.price.toNumber(),
          quantity: l2Quote.quantity.toNumber()
        }))
      }
  ...
  async markets(_parent, args) {
    const markets$1 = await markets(auxClient);
    ...
    if (marketInputs === void 0 || marketInputs === null) {
      return (await Promise.all(
        markets$1.map(
          (market2) => Market.read(auxClient, {
            baseCoinType: market2.baseCoinType,
            quoteCoinType: market2.quoteCoinType
          })
        )
      )).map((market2) => {
        return {
      ...
      return (await Promise.all(
        marketInputs.map(
          (marketInput) => Market.read(auxClient, marketInput)
        )
      )).filter(
        (maybeMarket) => maybeMarket !== void 0 && maybeMarket !== null
      ).map((market2) => {
        return {
          name: `${market2.baseCoinInfo.name}-${market2.quoteCoinInfo.name}`,
          baseCoinInfo: market2.baseCoinInfo,
          quoteCoinInfo: market2.quoteCoinInfo,
          lotSize: market2.lotSize.toNumber(),
          tickSize: market2.tickSize.toNumber(),
  ...
  async account(_parent, { owner }) {
    ...
    return {
      address: owner,
      hasAuxAccount: auxAccount !== void 0
    };
  },
  async stakePool(_parent, { stakePoolInput }) {
    ...
    const pool2 = await poolClient.query();
    return {
      accRewardPerShare: pool2.accRewardPerShare.toNumber(),
      amountStake: pool2.amountStaked.toNumber(),
      authority: pool2.authority,
      coinInfoReward: pool2.coinInfoReward,
      coinInfoStake: pool2.coinInfoStake,
      startTime: pool2.startTime.divn(1e3).toString(),
      endTime: pool2.endTime.divn(1e3).toString(),
      rewardRemaining: pool2.rewardRemaining.toNumber(),
      lastUpdateTime: pool2.lastUpdateTime.divn(1e3).toString(),
      type: poolClient.type
    };
  },
  async stakePools(_parent, args) {
    const poolInputs = args.stakePoolInputs ? args.stakePoolInputs : (await auxClient.stakePools()).map((input) => ({
    ...
    const pools = await Promise.all(
      poolInputs.map(async (poolInput) => {
        ...
        let pool2 = await poolClient.query();
        return {
          accRewardPerShare: pool2.accRewardPerShare.toNumber(),
          amountStake: pool2.amountStaked.toNumber(),
          authority: pool2.authority,
...
function getFeaturedPriority(status) {
  switch (status) {
...
function formatPool(pool2, coinTypeToHippoNameSymbol) {
  let featuredStatus = FeaturedStatus.None;
  for (const [x, y] of PROMOTED_POOLS) {
    if (pool2.coinInfoX.coinType == x && pool2.coinInfoY.coinType == y || pool2.coinInfoX.coinType == y && pool2.coinInfoY.coinType == x) {
  ...
  const recognizedLiquidity = Math.max(
    getRecognizedTVL(pool2.coinInfoX.coinType, pool2.amountX.toNumber()),
    getRecognizedTVL(pool2.coinInfoY.coinType, pool2.amountY.toNumber())
  );
  const auLiquidity = Math.max(
    pool2.amountX.toAtomicUnits(pool2.coinInfoX.decimals).toNumber(),
    pool2.amountY.toAtomicUnits(pool2.coinInfoY.decimals).toNumber()
  );
  const coinXNameSymbol = coinTypeToHippoNameSymbol[pool2.coinInfoX.coinType];
  const coinInfoX = pool2.coinInfoX;
  if (!_.isUndefined(coinXNameSymbol)) {
    const [name, symbol] = coinXNameSymbol;
    coinInfoX.name = name;
    coinInfoX.symbol = symbol;
  }
  const coinYNameSymbol = coinTypeToHippoNameSymbol[pool2.coinInfoY.coinType];
  const coinInfoY = pool2.coinInfoY;
  ...
  return {
    ...
    coinInfoLP: pool2.coinInfoLP,
    amounts: [pool2.amountX.toNumber(), pool2.amountY.toNumber()],
    amountLP: pool2.amountLP.toNumber(),
    feePercent: pool2.fee.toPercent(),
    featuredStatus,
    auLiquidity,
    recognizedLiquidity
  };
}
async function coinsWithoutLiquidity() {
  if (window.currentEnvironment.network === "devnet") {
    let result = [
      await auxClient.getCoinInfo("0x1::aptos_coin::AptosCoin")
    ];
    for (const fakeCoin of ALL_FAKE_COINS) {
      result.push(await auxClient.getFakeCoinInfo(fakeCoin));
    }
    return result;
  }
  let coins;
  const url = "https://raw.githubusercontent.com/hippospace/aptos-coin-list/main/typescript/src/defaultList.mainnet.json";
...
const account = {
  ...
  async walletBalances(parent) {
    ...
    const balances2 = await Promise.all(
      coinStores.map(async (coinStore) => {
        ...
        const balance = AU(coinStore.data.coin.value).toDecimalUnits(coinInfo.decimals).toString();
        return {
          balance,
    ...
    return balances2.filter((i2) => i2 !== void 0);
  },
  async balances(parent) {
    const account2 = new AuxAccount(auxClient, parent.address);
    const balances2 = await account2.balances();
    const allBalances = await Promise.all(
      balances2.balances.map(async (e2) => {
        const [coinType] = parseTypeArgs(e2.key.name);
        let coinInfo;
        try {
          coinInfo = await auxClient.getCoinInfo(coinType);
        } catch {
        ...
        return {
          coinInfo,
          availableBalance: e2.value.available_balance.toDecimalUnits(coinInfo.decimals).toString(),
          balance: e2.value.balance.toDecimalUnits(coinInfo.decimals).toString()
        };
      })
    );
    return allBalances.filter((i2) => i2 !== void 0);
  },
  async deposits(parent) {
    const account2 = new AuxAccount(auxClient, parent.address);
    const deposits = await account2.deposits();
  ...
  async withdrawals(parent) {
    const account2 = new AuxAccount(auxClient, parent.address);
    const withdrawals = await account2.withdrawals();
  ...
  async transfers(parent) {
    const account2 = new AuxAccount(auxClient, parent.address);
    const transfers = await account2.transfers();
  ...
  async poolPositions(parent, { poolInputs }) {
    const positions = await new AuxAccount(
      auxClient,
      parent.address
    ).poolPositions();
    return positions.filter(
      (auxPosition) => _.some(
        poolInputs,
        (poolInput) => poolInput.coinTypes[0] === auxPosition.coinInfoX.coinType && poolInput.coinTypes[1] === auxPosition.coinInfoY.coinType
      )
    ).map((auxPosition) => {
  ...
  async openOrders(parent, args) {
    var _a2;
    const marketInputs = (_a2 = args.marketInputs) != null ? _a2 : await Market.index(auxClient);
    const account2 = new AuxAccount(auxClient, parent.address);
    const orderss = await Promise.all(
      marketInputs.map(async (marketInput) => {
        ...
        const orders = await account2.openOrders({
          baseCoinType,
          quoteCoinType
        });
        return orders.map(
          (order) => orderToOrder(order, baseCoinInfo, quoteCoinInfo)
        );
      })
    );
    return orderss.flat();
  },
  async orderHistory(parent, args) {
    var _a2;
    const marketInputs = (_a2 = args.marketInputs) != null ? _a2 : await Market.index(auxClient);
    const account2 = new AuxAccount(auxClient, parent.address);
    const orderss = await Promise.all(
      marketInputs.map(async (marketInput) => {
        const market2 = await Market.read(auxClient, marketInput);
        const orders = await account2.orderHistory(marketInput);
        return orders.map(
          (order) => orderPlacedEventToOrder(order.order, market2.baseCoinInfo, market2.quoteCoinInfo)
        );
      })
    );
    return orderss.flat();
  },
  async tradeHistory(parent, args) {
    var _a2;
    const marketInputs = (_a2 = args.marketInputs) != null ? _a2 : await Market.index(auxClient);
    const account2 = new AuxAccount(auxClient, parent.address);
    const fillss = await Promise.all(
      marketInputs.map(async (marketInput) => {
        const market2 = await Market.read(auxClient, marketInput);
        const fills = await account2.tradeHistory(marketInput);
        return fills.map(
          (fill) => orderFillEventToOrder(fill, market2.baseCoinInfo, market2.quoteCoinInfo)
        );
      })
    );
    return fillss.flat();
...
function resolutionToString(resolution) {
  switch (resolution) {
    case Resolution.Seconds_15:
      return "15s";
    case Resolution.Minutes_1:
      return "1m";
    case Resolution.Minutes_5:
      return "5m";
    case Resolution.Minutes_15:
      return "15m";
    case Resolution.Hours_1:
      return "1h";
    case Resolution.Hours_4:
      return "4h";
    case Resolution.Days_1:
      return "1d";
    case Resolution.Weeks_1:
      return "1w";
    default:
      const _exhaustive_check = resolution;
      return _exhaustive_check;
  }
}
const market = {
  async lastTradePrice({ baseCoinInfo, quoteCoinInfo }) {
    return dataClient.get(
      `${baseCoinInfo.coinType}-${quoteCoinInfo.coinType}-last-trade-price`
    );
  },
  async openOrders(parent, { owner }) {
    const account2 = new AuxAccount(auxClient, owner);
    const orders = await account2.openOrders({
      baseCoinType: parent.baseCoinInfo.coinType,
      quoteCoinType: parent.quoteCoinInfo.coinType
    });
    return orders.map(
      (order) => orderToOrder(order, parent.baseCoinInfo, parent.quoteCoinInfo)
    );
  },
  async orderHistory(parent, { owner }) {
    const market2 = await Market.read(auxClient, {
      baseCoinType: parent.baseCoinInfo.coinType,
      quoteCoinType: parent.quoteCoinInfo.coinType
    });
    const orders = await market2.orderHistory(owner);
    return orders.map(
      (order) => orderPlacedEventToOrder(
        order.order,
        market2.baseCoinInfo,
        market2.quoteCoinInfo
      )
    );
  },
  async tradeHistory(parent, { owner }) {
    const market2 = await Market.read(auxClient, {
      baseCoinType: parent.baseCoinInfo.coinType,
      quoteCoinType: parent.quoteCoinInfo.coinType
    });
    const fills = await market2.fillHistory(owner);
    return fills.filter((fill) => fill.sequenceNumber.toNumber() % 2 === 0).map(
      (fill) => orderFillEventToOrder(fill, market2.baseCoinInfo, market2.quoteCoinInfo)
    );
  },
  high24h(parent) {
  ...
  async volume24h(parent) {
    return analytic24h("volume", parent);
  },
  isRoundLot(parent, { quantity }) {
    return DU(quantity).toAtomicUnits(parent.baseCoinInfo.decimals).toBN().mod(AU(parent.lotSizeString).toBN()).eqn(0);
  },
  isRoundTick(parent, { quantity }) {
    return DU(quantity).toAtomicUnits(parent.quoteCoinInfo.decimals).toBN().mod(AU(parent.tickSizeString).toBN()).eqn(0);
  },
  async bars({ baseCoinInfo, quoteCoinInfo }, { resolution, from, to: to2, countBack, firstDataRequest }) {
    return [];
  },
  async pythRating(parent, { price, side }) {
    var _a2, _b, _c;
    const FAKE_MAPPING = fakeMapping(auxClient);
    const mappedQuote = (_a2 = FAKE_MAPPING.get(parent.quoteCoinInfo.coinType)) != null ? _a2 : parent.quoteCoinInfo.coinType;
    let pythPrice = void 0;
    if (ALL_USD_STABLES.includes(mappedQuote)) {
      const mappedBase = (_b = FAKE_MAPPING.get(parent.baseCoinInfo.coinType)) != null ? _b : parent.baseCoinInfo.coinType;
      const pythSymbol = (_c = COIN_MAPPING.get(mappedBase)) == null ? void 0 : _c.pythSymbol;
      if (pythSymbol !== void 0) {
...
async function analytic24h(name, market2) {
  const value = dataClient.get(
    `${market2.baseCoinInfo.coinType}-${market2.quoteCoinInfo.coinType}-${name}-24h`
  );
  return value ? Number(value) : null;
}
const mutation = {
  registerCoin(_parent, { registerCoinInput }) {
    return {
  ...
  async createPool(_parent, { createPoolInput: { poolInput, feeBasisPoints } }) {
    const coinTypeX = poolInput.coinTypes[0];
    const coinTypeY = poolInput.coinTypes[1];
  ...
  async swapExactIn(_parent, {
    ...
    const parameters = _.isNil(slippagePct) ? {} : { slippage: new Pct(slippagePct) };
  ...
  async addLiquidity(_parent, {
    ...
    useAuxAccount = useAuxAccount != null ? useAuxAccount : false;
  ...
  async createMarket(_parent, { createMarketInput }) {
    ...
    return createMarketPayload(auxClient, {
      sender: void 0,
      baseCoinType,
      quoteCoinType,
      baseLotSize: DU(createMarketInput.baseLotSize).toAtomicUnits(baseCoinInfo.decimals).toString(),
      quoteLotSize: DU(createMarketInput.quoteLotSize).toAtomicUnits(quoteCoinInfo.decimals).toString()
    });
  },
  async placeOrder(_parent, { placeOrderInput }) {
    ...
    return placeOrderPayload(auxClient, {
      sender: { address: () => placeOrderInput.sender },
      market: market2,
      isBid: placeOrderInput.side === Side.Buy ? true : false,
      limitPriceAu: DU(placeOrderInput.limitPrice).toAtomicUnits(market2.quoteCoinInfo.decimals).toString(),
      quantityAu: DU(placeOrderInput.quantity).toAtomicUnits(market2.baseCoinInfo.decimals).toString(),
  ...
  cancelOrder(_parent, { cancelOrderInput }) {
    const { baseCoinType, quoteCoinType } = cancelOrderInput.marketInput;
    return cancelOrderPayload(auxClient, {
  ...
  createAuxAccount() {
    return createAuxAccountPayload(auxClient);
  },
  async deposit(_parent, { depositInput }) {
    return depositPayload$1(auxClient, {
      coinType: depositInput.coinType,
      sender: depositInput.from,
      to: depositInput.to,
      amountAu: DU(depositInput.amount).toAtomicUnits(
        (await auxClient.getCoinInfo(depositInput.coinType)).decimals
      ).toString()
    });
  },
  async withdraw(_parent, { withdrawInput }) {
    return withdrawPayload$1(auxClient, {
      coinType: withdrawInput.coinType,
      sender: withdrawInput.from,
      amountAu: DU(withdrawInput.amount).toAtomicUnits(
        (await auxClient.getCoinInfo(withdrawInput.coinType)).decimals
      ).toString()
    });
  },
  async transfer(_parent, { transferInput }) {
    return transferPayload(auxClient, {
      sender: transferInput.from,
      recipient: transferInput.to,
      coinType: transferInput.coinType,
      amountAu: DU(transferInput.amount).toAtomicUnits(
        (await auxClient.getCoinInfo(transferInput.coinType)).decimals
      ).toString()
    });
  },
  async createStakePool(_parent, {
    ...
    return createStakePoolPayload(auxClient.moduleAddress, {
      coinTypeStake,
      coinTypeReward,
      rewardAmount: DU(rewardAmount).toAtomicUnits(coinInfoReward.decimals).toU64(),
      durationUs: durationUs.toString()
    });
  },
  async depositStake(_parent, {
    depositStakeInput: {
      amount,
    ...
    return depositPayload(auxClient.moduleAddress, {
      coinTypeStake,
      coinTypeReward,
      amount: DU(amount).toAtomicUnits(coinInfoStake.decimals).toU64()
    });
  },
  async withdrawStake(_parent, {
    amount,
    stakePoolInput: { coinTypeReward, coinTypeStake }
  }) {
    let coinInfoStake = await auxClient.getCoinInfo(coinTypeStake);
    return withdrawPayload(auxClient.moduleAddress, {
      coinTypeStake,
      coinTypeReward,
      amount: DU(amount).toAtomicUnits(coinInfoStake.decimals).toU64()
    });
  },
  async claimStakingReward(_parent, {
    stakePoolInput: { coinTypeReward, coinTypeStake }
  }) {
  ...
  async modifyStakePool(_parent, {
    ...
    return modifyPoolPayload(auxClient.moduleAddress, {
      coinTypeStake,
      coinTypeReward,
      rewardAmount: rewardAmount ? DU(rewardAmount).toAtomicUnits(coinInfoReward.decimals).toU64() : "0",
  ...
  async modifyStakePoolAuthority(_parent, {
    input: {
      stakePoolInput: { coinTypeReward, coinTypeStake },
      newAuthority
    }
...
const pool = {
  async swaps({ coinInfos }) {
    ...
    return swaps.map((swap) => {
      ...
      const coinInfoOut = swap.coinTypeOut === coinTypeY ? coinInfoY : coinInfoX;
      return {
        ...swap,
        coinInfoIn,
        coinInfoOut,
        ...
        time: swap.timestamp.divn(1e3).toString()
      };
    });
  },
  async adds(parent) {
    ...
    return addLiquiditys.map((addLiquidity) => ({
      ...
      amountMintedLP: addLiquidity.lpMinted.toDecimalUnits(parent.coinInfoLP.decimals).toNumber(),
      time: addLiquidity.timestamp.divn(1e3).toString()
    }));
  },
  async removes(parent) {
    const coinInfoX = parent.coinInfos[0];
    const coinInfoY = parent.coinInfos[1];
    ...
    return removeLiquiditys.map((removeLiquidity) => ({
      ...
      amountBurnedLP: removeLiquidity.lpBurned.toDecimalUnits(parent.coinInfoLP.decimals).toNumber(),
      time: removeLiquidity.timestamp.divn(1e3).toString()
    }));
  },
  async position(parent, { owner }) {
    const coinInfoX = parent.coinInfos[0];
    const coinInfoY = parent.coinInfos[1];
  ...
  price(parent, { coinTypeIn, amountIn }) {
    const coinInfoX = parent.coinInfos[0];
  ...
  quoteExactIn(parent, { coinTypeIn, amountIn, slippagePct }) {
    var _a2, _b, _c, _d;
    const coinInfoX = parent.coinInfos[0];
    const coinInfoY = parent.coinInfos[1];
    const amountX = parent.amounts[0];
    ...
    const inReserve = coinTypeIn === coinInfoX.coinType ? amountX : amountY;
    const outReserve = coinTypeIn === coinInfoX.coinType ? amountY : amountX;
    const coinTypeOut = coinTypeIn === coinInfoX.coinType ? coinInfoY.coinType : coinInfoX.coinType;
    const coinInfoIn = coinTypeIn === coinInfoX.coinType ? coinInfoX : coinInfoY;
    if (inReserve === 0 || outReserve === 0) {
      throw new Error("Pool is empty");
    }
    const decimalUnitsInWithFee = amountIn * (1 - parent.feePercent / 100);
    const expectedAmountOutNoFee = amountIn * outReserve / (inReserve + amountIn);
    const expectedAmountOut = decimalUnitsInWithFee * outReserve / (inReserve + decimalUnitsInWithFee);
    const slippage = 1 - (slippagePct != null ? slippagePct : 0.1) / 100;
    const minAmountOut = expectedAmountOut * slippage;
    const feeAmount = amountIn * (parent.feePercent / 100);
    const FAKE_MAPPING = fakeMapping(auxClient);
    const mappedCoinIn = (_a2 = FAKE_MAPPING.get(coinTypeIn)) != null ? _a2 : coinTypeIn;
    const inputCoinSymbol = (_b = COIN_MAPPING.get(mappedCoinIn)) == null ? void 0 : _b.pythSymbol;
    const pythPriceCoinIn = !!inputCoinSymbol ? ALL_USD_STABLES.includes(inputCoinSymbol) ? 1 : LATEST_PYTH_PRICE.get(inputCoinSymbol) : null;
    const feeAmountDollars = !!pythPriceCoinIn ? pythPriceCoinIn * feeAmount : null;
    const instantaneousAmountOut = outReserve / inReserve * amountIn;
    const priceImpactPct = 100 * (instantaneousAmountOut - expectedAmountOutNoFee) / instantaneousAmountOut;
    ...
    if (!!pythPriceCoinIn) {
      ...
      const mappedCoinOut = (_c = FAKE_MAPPING.get(coinTypeOut)) != null ? _c : coinTypeOut;
      const outputCoinSymbol = (_d = COIN_MAPPING.get(mappedCoinOut)) == null ? void 0 : _d.pythSymbol;
      const pythPriceCoinOut = !!outputCoinSymbol ? ALL_USD_STABLES.includes(outputCoinSymbol) ? 1 : LATEST_PYTH_PRICE.get(outputCoinSymbol) : null;
      if (!!pythPriceCoinOut) {
        ratio = (priceOut - pythPriceCoinOut) / pythPriceCoinOut;
      }
    }
    const pythRating = !!ratio ? generatePythRating({ ratio, price: priceOut, redPct: 2, yellowPct: 1 }) : null;
    return {
      expectedAmountOut,
      minAmountOut,
      feeAmount,
      ...
      priceImpactRating: priceImpactPct > PRICE_IMPACT_PCT_RED ? RatingColor.Red : priceImpactPct > PRICE_IMPACT_PCT_YELLOW ? RatingColor.Yellow : RatingColor.Green
    };
  },
  quoteExactOut(parent, { coinTypeOut, amountOut, slippagePct }) {
    var _a2, _b, _c, _d;
    const coinInfoX = parent.coinInfos[0];
    const coinInfoY = parent.coinInfos[1];
    const amountX = parent.amounts[0];
    ...
    const coinInfoIn = coinTypeOut === coinInfoX.coinType ? coinInfoY : coinInfoX;
    const coinTypeIn = coinInfoIn.coinType;
    if (inReserve == 0 || outReserve == 0) {
      throw new Error("Pool is empty");
    }
    ...
    const denominator = (outReserve - amountOut) * (1 - parent.feePercent / 100);
    const expectedAmountIn = numerator / denominator;
    const slippage = (1 + (slippagePct != null ? slippagePct : 0.1)) / 100;
    const maxAmountIn = expectedAmountIn * slippage;
    const maxFeeAmount = maxAmountIn * (parent.feePercent / 100);
    const FAKE_MAPPING = fakeMapping(auxClient);
    const mappedCoinIn = (_a2 = FAKE_MAPPING.get(coinTypeIn)) != null ? _a2 : coinTypeIn;
    const inputCoinSymbol = (_b = COIN_MAPPING.get(mappedCoinIn)) == null ? void 0 : _b.pythSymbol;
    const pythPriceCoinIn = !!inputCoinSymbol ? ALL_USD_STABLES.includes(inputCoinSymbol) ? 1 : LATEST_PYTH_PRICE.get(inputCoinSymbol) : null;
    const maxFeeAmountDollars = !!pythPriceCoinIn ? pythPriceCoinIn * maxFeeAmount : null;
    const instantaneousAmountOut = outReserve / inReserve * expectedAmountIn * (1 - parent.feePercent / 100);
    const priceImpactPct = 100 * (instantaneousAmountOut - amountOut) / instantaneousAmountOut;
  ...
  async summaryStatistics(parent) {
...
async function stat(name, pool2, period) {
  if (name === "tvl") {
    const value = await dataClient.get(
      `${pool2.coinInfos[0].coinType}-${pool2.coinInfos[1].coinType}-${name}`
    );
    return value ? Number(value) : null;
  } else {
    const value = await dataClient.get(
      `${pool2.coinInfos[0].coinType}-${pool2.coinInfos[1].coinType}-${name}-${period}`
    );
    return value ? Number(value) : null;
  }
}
const stakePool = {
  ...
  async pendingUserReward(parent, { owner }) {
    const coinInfoReward = await auxClient.getCoinInfo(
      parent.coinInfoReward.coinType
    );
    const coinInfoStake = await auxClient.getCoinInfo(
    ...
    return (await poolClient.calcPendingUserReward({
      userAddress: owner
    })).toNumber();
  },
  async userPosition(parent, { owner }) {
    const coinInfoReward = await auxClient.getCoinInfo(
      parent.coinInfoReward.coinType
    );
    const coinInfoStake = await auxClient.getCoinInfo(
  ...
  async createEvents(parent) {
    ...
    const events2 = await poolClient.createEvents();
    return events2.map((e2) => {
      return {
        ...e2,
        startTime: e2.startTimeUs.divn(1e3).toString(),
        endTime: e2.endTimeUs.divn(1e3).toString(),
        rewardCoinInfo: coinInfoReward,
        stakeCoinInfo: coinInfoStake,
        time: e2.timestamp.divn(1e3).toString(),
        rewardAmount: e2.rewardAmount.toDecimalUnits(coinInfoReward.decimals).toNumber()
      };
    });
  },
  async depositEvents(parent) {
    const coinInfoReward = await auxClient.getCoinInfo(
      parent.coinInfoReward.coinType
    );
    const coinInfoStake = await auxClient.getCoinInfo(
    ...
    const events2 = await poolClient.depositEvents();
    return events2.map((e2) => {
      return {
        ...e2,
        accRewardPerShare: e2.accRewardPerShare.toNumber(),
        rewardCoinInfo: coinInfoReward,
        stakeCoinInfo: coinInfoStake,
        time: e2.timestamp.divn(1e3).toString(),
        rewardRemaining: e2.rewardRemaining.toDecimalUnits(coinInfoReward.decimals).toNumber(),
        totalAmountStaked: e2.totalAmountStaked.toDecimalUnits(coinInfoStake.decimals).toNumber(),
        userAmountStaked: e2.userAmountStaked.toDecimalUnits(coinInfoStake.decimals).toNumber(),
        userRewardAmount: e2.userRewardAmount.toDecimalUnits(coinInfoReward.decimals).toNumber()
      };
    });
  },
  async withdrawEvents(parent) {
    const coinInfoReward = await auxClient.getCoinInfo(
      parent.coinInfoReward.coinType
    );
    const coinInfoStake = await auxClient.getCoinInfo(
    ...
    const events2 = await poolClient.withdrawEvents();
    return events2.map((e2) => {
      return {
        ...e2,
        accRewardPerShare: e2.accRewardPerShare.toNumber(),
        ...
        userAmountStaked: e2.userAmountStaked.toDecimalUnits(coinInfoStake.decimals).toNumber(),
        userRewardAmount: e2.userRewardAmount.toDecimalUnits(coinInfoReward.decimals).toNumber(),
        withdrawAmount: e2.withdrawAmount.toDecimalUnits(coinInfoStake.decimals).toNumber()
      };
    });
  },
  async claimEvents(parent) {
    const coinInfoReward = await auxClient.getCoinInfo(
      parent.coinInfoReward.coinType
    );
    const coinInfoStake = await auxClient.getCoinInfo(
    ...
    const events2 = await poolClient.claimEvents();
    return events2.map((e2) => {
      return {
        ...e2,
        accRewardPerShare: e2.accRewardPerShare.toNumber(),
  ...
  async modifyPoolEvents(parent) {
    ...
    const events2 = await poolClient.modifyPoolEvents();
    return events2.map((e2) => {
      return {
        ...e2,
        startTime: e2.startTimeUs.divn(1e3).toString(),
...
const subscription = {
  ...
  bar: {
    ...
    subscribe: dist$1.withFilter(
      ...
      (payload, variables) => marketInputsFilterFn(payload, variables) && payload.resolution === resolutionToString(variables.resolution)
    )
  },
  high24h: {
    resolve: _.identity,
    subscribe: dist$1.withFilter(
      ...
      (payload, variables) => marketInputsFilterFn(payload, variables)
    )
  },
  low24h: {
    resolve: _.identity,
...
function DepositView({
  ...
  const coinsQuery = useCoins();
  const balances2 = useBalances();
  const fullBalances = (_b = (_a2 = balances2.data) == null ? void 0 : _a2.account) == null ? void 0 : _b.walletBalances;
        ...
        onClick: () => {
          if (coin)
            deposit({
              ...
              to: account2 == null ? void 0 : account2.address
            }).then(() => {
              var _a3;
              (_a3 = modalRef.current) == null ? void 0 : _a3.closeModal();
...
function SwapPanel({
  ...
  const findBalance = (coin2) => {
    var _a3, _b2;
    return (_b2 = (_a3 = balances2.data) == null ? void 0 : _a3.account) == null ? void 0 : _b2.walletBalances.find((b2) => b2.coinInfo.coinType === coin2);
  };
  const focusInput = () => {
    var _a3;
...
function useBalancesTable() {
  ...
  const tableRef = react.exports.useRef(null);
  const balances2 = (_b = (_a2 = balancesQuery.data) == null ? void 0 : _a2.account) == null ? void 0 : _b.balances;
  const depositTrigger = /* @__PURE__ */ jsx(ur, {
    size: "xs",
    className: "!text-sm",
  ...
  const tableProps = react.exports.useMemo(() => {
    ...
    return {
      ...
      virtualizeOptions: {
        count: (_b2 = balances2 == null ? void 0 : balances2.length) != null ? _b2 : 0,
        estimateSize: () => {
          var _a4;
          return (_a4 = balances2 == null ? void 0 : balances2.length) != null ? _a4 : 0;
        },
        getScrollElement: () => tableRef.current,
        overscan: 20
      }
    };
  }, [balances2, balancesQuery.loading, balancesQuery.error]);
  return [tableProps, tableRef];
}
...
function useOpenOrdersTable() {
  ...
  const wallet = dist.useWallet();
  const marketCoins = useCoins();
  const [cancelOrder2] = useMutation(CancelOrderDocument);
  ...
  const openOrders2 = (_b = (_a2 = orders.data) == null ? void 0 : _a2.account) == null ? void 0 : _b.openOrders;
  const tableProps = react.exports.useMemo(() => {
    var _a3, _b2, _c2;
    return {
      ...
      data: (_b2 = openOrders2 == null ? void 0 : openOrders2.map((order) => {
        const baseCoinInfo = getCoin(order.baseCoinType);
        const quoteCoinInfo = getCoin(order.quoteCoinType);
        const market2 = baseCoinInfo && quoteCoinInfo ? `${baseCoinInfo.symbol}/${quoteCoinInfo.symbol}` : null;
        return {
          ...order,
          baseCoinInfo,
          quoteCoinInfo,
      ...
      virtualizeOptions: {
        count: (_c2 = openOrders2 == null ? void 0 : openOrders2.length) != null ? _c2 : 200,
        estimateSize: () => {
          var _a4;
          return (_a4 = openOrders2 == null ? void 0 : openOrders2.length) != null ? _a4 : 200;
        },
        getScrollElement: () => tableRef.current,
        overscan: 200
      }
...
function useOrderHistoryTable(displayMarket) {
  ...
  const marketCoins = useCoins();
  const tableRef = react.exports.useRef(null);
  const orderHistory2 = (_b = (_a2 = orders.data) == null ? void 0 : _a2.account) == null ? void 0 : _b.orderHistory;
  const getCoin = (a2) => {
    var _a3;
    return (_a3 = marketCoins == null ? void 0 : marketCoins.data) == null ? void 0 : _a3.coins.find((m) => m.coinType === a2);
  };
  const tableProps = react.exports.useMemo(() => {
    ...
    return {
      ...
      data: (_b2 = orderHistory2 == null ? void 0 : orderHistory2.map((order) => {
        const baseCoinInfo = getCoin(order.baseCoinType);
        const quoteCoinInfo = getCoin(order.quoteCoinType);
        const market2 = baseCoinInfo && quoteCoinInfo ? `${baseCoinInfo.symbol}/${quoteCoinInfo.symbol}` : null;
        return {
      ...
      columns: baseColumns,
      virtualizeOptions: {
        count: (_c = orderHistory2 == null ? void 0 : orderHistory2.length) != null ? _c : 200,
        estimateSize: () => {
          var _a4;
          return (_a4 = orderHistory2 == null ? void 0 : orderHistory2.length) != null ? _a4 : 200;
        },
        getScrollElement: () => tableRef.current,
        overscan: 200
      }
...
function WithdrawalView({
  ...
  const balances2 = useBalances();
  const coinsQuery = useCoins();
  const fullBalances = (_b = (_a2 = balances2.data) == null ? void 0 : _a2.account) == null ? void 0 : _b.balances;
  const coins = (_c = fullBalances == null ? void 0 : fullBalances.map((b2) => b2.coinInfo)) != null ? _c : [];
  const [coin, selectCoin] = react.exports.useState(_coin);
  const [balance, setBalance] = react.exports.useState("-");
...
function MarketListItem({
  ...
  const onMarketSelectHandler = react.exports.useCallback(() => onMarketSelect == null ? void 0 : onMarketSelect(market2), [market2, onMarketSelect]);
  return /* @__PURE__ */ jsxs("div", {
    ...
    children: [/* @__PURE__ */ jsxs("div", {
      ...
      children: [/* @__PURE__ */ jsx(x0, {
        coins: [market2 == null ? void 0 : market2.baseCoinInfo.symbol, market2 == null ? void 0 : market2.quoteCoinInfo.symbol].filter(Boolean),
        size: 32
      }), /* @__PURE__ */ jsxs("div", {
        className: "ml-3",
        children: [/* @__PURE__ */ jsxs("div", {
          ...
          children: [/* @__PURE__ */ jsxs("div", {
            className: "",
            children: [market2 == null ? void 0 : market2.baseCoinInfo.symbol, "/", market2 == null ? void 0 : market2.quoteCoinInfo.symbol]
          }), /* @__PURE__ */ jsx("div", {
            className: "text-sm text-primary-400",
            children: market2 == null ? void 0 : market2.name
          })]
        }), /* @__PURE__ */ jsx("div", {
...
function MarketList({
  ...
  return /* @__PURE__ */ jsx(Fragment, {
    children: markets2 == null ? void 0 : markets2.map((item, index2) => /* @__PURE__ */ jsx(MarketListItem, {
      market: item,
      onMarketSelect
    }, `${item.name}-${index2}`))
  });
...
function useMarkets() {
  const markets2 = useQuery(MarketsDocument);
  return markets2;
}
function e(t2, i2) {
  const n2 = { ...t2 };
...
const ResolutionFormats = {
  [Resolution$1.Seconds_15]: "15S",
  [Resolution$1.Days_1]: "1D",
  [Resolution$1.Hours_1]: "1H",
  [Resolution$1.Hours_4]: "4H",
  [Resolution$1.Minutes_1]: "1",
  [Resolution$1.Minutes_15]: "15",
  [Resolution$1.Minutes_5]: "5",
  [Resolution$1.Weeks_1]: "1W"
};
[
  {
    text: "1 Minute",
...
const DataFeedProvider = ({
  ...
  const [markets2, setMarkets] = react.exports.useState([]);
  react.exports.useEffect(() => {
    if (marketsDif.data)
  ...
  const searchSymbols = function searchSymbols2(userInput, exchange, symbolType, onResultReadyCallback) {
    const symbols = getAllSymbols(markets2);
  ...
  const getBars = async function getBars2(symbolInfo, resolution, periodParams, onHistoryCallback, onErrorCallback) {
    ...
    const market2 = markets2 == null ? void 0 : markets2.find((m) => m.name === symbolInfo.ticker);
    const data = market2 && await client.query({
      query: TradingViewQueryDocument,
      variables: {
        resolution: (_a2 = formatResolution(resolution)) != null ? _a2 : Resolution$1.Hours_1,
        marketInputs: [{
          baseCoinType: (_b = market2 == null ? void 0 : market2.baseCoinInfo.coinType) != null ? _b : "",
          quoteCoinType: (_c = market2 == null ? void 0 : market2.quoteCoinInfo.coinType) != null ? _c : ""
        }],
        from,
        to: to2,
        firstDataRequest,
...
function MarketSelector({
  ...
  const markets2 = (_c = marketsQuery.data) == null ? void 0 : _c.markets;
  ...
  const filteredMarkets = markets2 == null ? void 0 : markets2.filter((m) => searchQuery.length > 1 ? m.name.toLowerCase().match(searchQuery.toLowerCase()) : true);
...
function usePool() {
  ...
  const pool2 = useQuery(PoolDocument, {
    variables: {
      poolInput: {
        coinTypes: [(_a2 = firstCoin == null ? void 0 : firstCoin.coinType) != null ? _a2 : "", (_b = secondCoin == null ? void 0 : secondCoin.coinType) != null ? _b : ""]
      }
...
function PoolEventTableContainer() {
  ...
  const swapTableData = ((_a2 = pool2 == null ? void 0 : pool2.swaps) != null ? _a2 : []).map(({
    ...
    var _a3, _b2;
    return {
      lpCoinType: (_a3 = pool2 == null ? void 0 : pool2.coinInfoLP.coinType) != null ? _a3 : "",
      amountIn,
      amountOut,
      totalValue: (_b2 = pool2 == null ? void 0 : pool2.amountLP) != null ? _b2 : 0,
  ...
  const addLiquidityTableData = ((_b = pool2 == null ? void 0 : pool2.adds) != null ? _b : []).map(({
    amountsAdded,
    amountMintedLP,
    time,
    version
    ...
    return {
      ...
      symbolIn: (_b2 = pool2 == null ? void 0 : pool2.coinInfos[0].symbol) != null ? _b2 : "-",
      symbolOut: (_c2 = pool2 == null ? void 0 : pool2.coinInfos[1].symbol) != null ? _c2 : "-",
      type: "Add",
      time,
      version
    };
  });
  const removeLiquidityTableData = ((_c = pool2 == null ? void 0 : pool2.removes) != null ? _c : []).map(({
    amountBurnedLP,
    amountsRemoved,
    time,
    version
    ...
    children: [/* @__PURE__ */ jsx("div", {
      ...
      children: /* @__PURE__ */ jsxs("div", {
        ...
        children: [/* @__PURE__ */ jsxs(ur, {
          ...
          children: [(pool2 == null ? void 0 : pool2.featuredStatus) === "HOT" ? /* @__PURE__ */ jsxs(w0, {
            variant: "error",
            size: "sm",
            className: "self-center inline-flex gap-1 items-center",
            children: [/* @__PURE__ */ jsx(FireIcon, {
              className: "w-4 h-4"
            }), pool2 == null ? void 0 : pool2.featuredStatus]
          }) : (pool2 == null ? void 0 : pool2.featuredStatus) === "PROMOTED" ? /* @__PURE__ */ jsx(w0, {
            variant: "success",
            size: "sm",
            className: "self-center",
            children: pool2 == null ? void 0 : pool2.featuredStatus
          }) : null, /* @__PURE__ */ jsx("div", {
            className: "flex items-center mx-auto",
            children: /* @__PURE__ */ jsx(x0, {
              coins: [(_a2 = pool2 == null ? void 0 : pool2.coinInfos[0].symbol) != null ? _a2 : "", (_b = pool2 == null ? void 0 : pool2.coinInfos[1].symbol) != null ? _b : ""],
              size: 42
            })
          }), /* @__PURE__ */ jsxs("div", {
            className: "flex text-2xl mx-auto",
            children: [pool2 == null ? void 0 : pool2.coinInfos[0].symbol, "/", pool2 == null ? void 0 : pool2.coinInfos[1].symbol]
          }), /* @__PURE__ */ jsx("div", {
            className: "flex gap-2 mx-auto",
            children: /* @__PURE__ */ jsx(k0, {
              title: `Total Liquidity`,
              value: (_d = (_c = pool2 == null ? void 0 : pool2.summaryStatistics.tvl) == null ? void 0 : _c.toLocaleString("en-US", {
                style: "currency",
                currency: "USD"
              })) != null ? _d : "-",
            ...
            children: [/* @__PURE__ */ jsxs(Mt, {
              ...
              children: [/* @__PURE__ */ jsxs("div", {
                ...
                children: [/* @__PURE__ */ jsx("div", {
                  ...
                  className: "font-semibold",
                  children: (_f = (_e2 = pool2 == null ? void 0 : pool2.summaryStatistics.volume24h) == null ? void 0 : _e2.toLocaleString("en-US", {
                    style: "currency",
                    currency: "USD"
                  })) != null ? _f : "-"
                })]
                ...
                children: [/* @__PURE__ */ jsx("div", {
                  ...
                  className: "font-semibold",
                  children: (_h = (_g = pool2 == null ? void 0 : pool2.summaryStatistics.fee24h) == null ? void 0 : _g.toLocaleString("en-US", {
                    style: "currency",
                    currency: "USD"
                  })) != null ? _h : "-"
                })]
                ...
                children: [/* @__PURE__ */ jsx("div", {
                  ...
                  className: "font-semibold",
                  children: (_j = (_i2 = pool2 == null ? void 0 : pool2.summaryStatistics.transactionCount24h) == null ? void 0 : _i2.toLocaleString()) != null ? _j : "-"
                })]
              })]
              ...
              children: [/* @__PURE__ */ jsxs("div", {
                ...
                children: [/* @__PURE__ */ jsx("div", {
                  ...
                  className: "font-semibold",
                  children: (_l = (_k = pool2 == null ? void 0 : pool2.summaryStatistics.volume1w) == null ? void 0 : _k.toLocaleString("en-US", {
                    style: "currency",
                    currency: "USD"
                  })) != null ? _l : "-"
                })]
                ...
                children: [/* @__PURE__ */ jsx("div", {
                  ...
                  className: "font-semibold",
                  children: (_n2 = (_m = pool2 == null ? void 0 : pool2.summaryStatistics.fee1w) == null ? void 0 : _m.toLocaleString("en-US", {
                    style: "currency",
                    currency: "USD"
                  })) != null ? _n2 : "-"
                })]
                ...
                children: [/* @__PURE__ */ jsx("div", {
                  ...
                  className: "font-semibold",
                  children: (_p = (_o = pool2 == null ? void 0 : pool2.summaryStatistics.transactionCount1w) == null ? void 0 : _o.toLocaleString()) != null ? _p : "-"
                })]
              })]
            })]
          }), (pool2 == null ? void 0 : pool2.coinInfos[0]) && (pool2 == null ? void 0 : pool2.coinInfos[1]) ? /* @__PURE__ */ jsxs("div", {
            className: "py-3",
            children: [/* @__PURE__ */ jsx(Mt, {
              ...
              children: [/* @__PURE__ */ jsx(CoinListItem, {
                ...pool2 == null ? void 0 : pool2.coinInfos[0],
                className: "bg-primary-800 p-2 grow",
                tokensLocked: (_q = pool2 == null ? void 0 : pool2.amounts[0].toLocaleString("en-US", {
                  maximumFractionDigits: pool2 == null ? void 0 : pool2.coinInfos[0].decimals
                })) != null ? _q : "-"
              }), /* @__PURE__ */ jsx(CoinListItem, {
                ...pool2 == null ? void 0 : pool2.coinInfos[1],
                className: "bg-primary-800 p-2 grow",
                tokensLocked: (_r2 = pool2 == null ? void 0 : pool2.amounts[1].toLocaleString("en-US", {
                  maximumFractionDigits: pool2 == null ? void 0 : pool2.coinInfos[1].decimals
                })) != null ? _r2 : "-"
              })]
            })]
...
function PortfolioView({}) {
  ...
  const appTitle = window.config.appTitle;
  return /* @__PURE__ */ jsx(Fragment, {
    children: !(account2 == null ? void 0 : account2.address) ? /* @__PURE__ */ jsx(NoWalletUI$1, {}) : /* @__PURE__ */ jsxs("div", {
...
function MarketTradesView() {
  ...
  const cellRendererFactory = (truncate, key) => (val) => {
    ...
    const colorClass = key === "quantity" ? side === Side$1.Buy ? "text-green-400" : "text-red-400" : "";
    return /* @__PURE__ */ jsx("span", {
