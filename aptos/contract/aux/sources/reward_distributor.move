module aux::reward_distributor {
    ...
    ///
    /// RewardDistrubor keeps track of acc_reward_per_share, that is,
    ...
    public fun token_melt<R, W>(l: RedeemToken<R, W>, r: RedeemToken<R, W>): RedeemToken<R, W> {
        assert!(
            l.id == r.id,
        ...
        let RedeemToken {
            id,
            value: l_value,
            last_acc_reward_per_share: l_acc,
        } = l;
        let l_value = (l_value as u128);
        let RedeemToken {
            id: _,
            value: r_value,
        ...
        RedeemToken {
            id,
            value: (total_value as u64),
            last_acc_reward_per_share: new_acc,
        }
    }
}
