...
module aux::stable_3pool_test {
    ...
    fun test_3pool(sender: &signer, aux: &signer, alice: &signer, bob: &signer, aptos_framework: &signer) {
        ...
        stable_3pool::print_pool<
            ...
            FakeCoin<USDCD8>,
        >();
        let alice_lp_balance = coin::balance<stable_3pool::LP<
            FakeCoin<USDC>,
            FakeCoin<USDT>,
            FakeCoin<USDCD8>,
        >>(alice_addr);
        ...
        let bob_lp_balance = coin::balance<stable_3pool::LP<
            FakeCoin<USDC>,
            FakeCoin<USDT>,
            FakeCoin<USDCD8>,
        >>(bob_addr);
        ...
        assert!(total_lp_supply == 307466058484 + 292527494605, total_lp_supply); // total lp
