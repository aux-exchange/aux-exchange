...
module aux::stable_3pool {
    ...
    struct LPRedeemTokenStore<phantom Coin0, phantom Coin1, phantom Coin2> has key {
    ...
    struct Pool<phantom Coin0, phantom Coin1, phantom Coin2> has key {
        ...
        scaler_2: u128,
        /// reward distributor for the fees in 2
    ...
    public entry fun create_pool<Coin0, Coin1, Coin2>(sender: &signer, fee_numerator: u128, amp: u128) {
        ...
        // create the pool
        move_to(amm_signer, Pool<Coin0, Coin1, Coin2>{
            fee_numerator,
            lp_mint,
            lp_burn,
            balanced_reserve: 0,
    ...
    public fun get_quoter<Coin0, Coin1, Coin2>(): Quoter acquires Pool {
        ...
        quoter_3pool::new_quoter(
            ...
            pool.scaler_2,
            reward_distributor::get_quoter(&pool.reward_distributor_2),
            lp_supply,
        )
    }
    ...
    public fun move_fee_into_reward_distributor<Coin0, Coin1, Coin2>() acquires Pool, FeeMoveEventHolder
    {
        let pool = borrow_global_mut<Pool<Coin0, Coin1, Coin2>>(@aux);
        let fee_move_event_holder = borrow_global_mut<FeeMoveEventHolder<Coin0, Coin1, Coin2>>(@aux);
    ...
    public fun add_liquidity<Coin0, Coin1, Coin2>(
        ...
        amount_2: Coin<Coin2>,
        min_lp_amount: u64
    ): LPBundle<Coin0, Coin1, Coin2> acquires Pool, FeeMoveEventHolder, AddLiquidityEventHolder
    {
        move_fee_into_reward_distributor<Coin0, Coin1, Coin2>();
        let pool = borrow_global_mut<Pool<Coin0, Coin1, Coin2>>(@aux);
        let add_liquidity_events = borrow_global_mut<AddLiquidityEventHolder<Coin0, Coin1, Coin2>>(@aux);
        ...
        let before_lp_coins_supply = option::destroy_with_default(coin::supply<LP<Coin0, Coin1, Coin2>>(), 0);
    ...
    acquires Pool, RemoveLiquidityEventHolder, FeeMoveEventHolder
    {
        ...
        let pool = borrow_global_mut<Pool<Coin0, Coin1, Coin2>>(@aux);
        let remove_liquidity_events = borrow_global_mut<RemoveLiquidityEventHolder<Coin0, Coin1, Coin2>>(@aux);
        ...
        let before_reserve_2 = coin::value(&pool.reserve_2);
        let fee_2 = 0u64;
        let after_reserve_2 = before_reserve_2;

        let coin_2 = if (amount_2_to_withdraw > 0) {
            // calculate the fee
            ...
            after_reserve_2 = coin::value(&pool.reserve_2);
            fee_2 = fee;

            coin::extract(&mut pool.reserve_2, amount_2_to_withdraw)
        } else {
            coin::zero<Coin2>()
        };
        ...
        let after_lp_coins_supply = uint256::downcast(
    ...
    acquires Pool, RemoveLiquidityEventHolder, FeeMoveEventHolder
    {
        ...
        let after_balanced_reserve = pool.balanced_reserve;
        let after_lp_coins_supply = option::destroy_with_default(coin::supply<LP<Coin0, Coin1, Coin2>>(), 0);
    ...
    acquires Pool, SwapEventHolder
    {
        ...
        let pool = borrow_global_mut<Pool<Coin0, Coin1, Coin2>>(@aux);
        let swap_events = borrow_global_mut<SwapEventHolder<Coin0, Coin1, Coin2>>(@aux);
        ...
        let amount_2_in = 0u64;
        let amount_2_out = 0u64;
        let fee_2 = 0u64;

        if (out_coin_index != 2) {
            amount_2_in = coin::value(&coin_2);
    ...
    acquires Pool, SwapEventHolder
    {
        ...
        if (is_coin_2_out && requested_quantity_2 > 0) {
            // calculate fee.
            // fee is based on the amount user receives.
            ...
            amount_2_out = requested_quantity_2;
            fee_2 = fee;
        };
    ...
    /// exists.
    public fun delete_pool_in_test<Coin0, Coin1, Coin2>() acquires Pool {
        let Pool {
            amp: _,
            balanced_reserve: _,
            fee_numerator: _,
    ...
    public fun bundle_detach_reward<Coin0, Coin1, Coin2>(
        ...
        Coin<LP<Coin0, Coin1, Coin2>>,
        RedeemToken<Coin0, LP<Coin0, Coin1, Coin2>>,
        RedeemToken<Coin1, LP<Coin0, Coin1, Coin2>>,
        RedeemToken<Coin2, LP<Coin0, Coin1, Coin2>>,
    ) {
        let LPBundle {
            reward_token_0,
            reward_token_1,
    ...
    public fun update_balanced_reserve<Coin0, Coin1, Coin2>(pool: &mut Pool<Coin0, Coin1, Coin2>) {
