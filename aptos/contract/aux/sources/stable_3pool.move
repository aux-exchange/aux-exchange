...
module aux::stable_3pool {
    ...
    public entry fun update_amp<Coin0, Coin1, Coin2>(sender: &signer, amp: u128) acquires Pool {
        ...
        update_balanced_reserve(borrow_global_mut<Pool<Coin0, Coin1, Coin2>>(@aux));
    }
    ...
    public entry fun move_fee_into_reserve<Coin0, Coin1, Coin2>()
        acquires Pool, FeeMoveEventHolder
    {
        ...
        if (fee_moved_2> 0) {
            fee_added = true;
            coin::merge(&mut pool.reserve_2, coin::extract_all(&mut pool.fee_2));
            after_reserve_2 = before_reserve_2 + fee_moved_2;
        };
        ...
        event::emit_event<FeeMoveEvent<Coin0, Coin1, Coin2>>(
            &mut borrow_global_mut<FeeMoveEventHolder<Coin0, Coin1, Coin2>>(@aux).fee_move_events,
    ...
    {
        move_fee_into_reserve<Coin0, Coin1, Coin2>();
        ...
        let lp_minted = coin::mint<LP<Coin0, Coin1, Coin2>>(
            lp_to_mint,
            &pool.lp_mint,
        );
    ...
    public fun remove_liquidity_for_coin<Coin0, Coin1, Coin2>(
        ...
        lp: Coin<LP<Coin0, Coin1, Coin2>>,
    ): (Coin<Coin0>, Coin<Coin1>, Coin<Coin2>, Coin<LP<Coin0, Coin1, Coin2>>)
