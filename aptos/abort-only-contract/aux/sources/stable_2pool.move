...
module aux::stable_2pool {
    ...
    public fun move_fee_into_reward_distributor<Coin0, Coin1>(pool: &mut Pool<Coin0, Coin1>, fee_move_event_holder: &mut FeeMoveEventHolder<Coin0, Coin1>)
    {
        assert!(is_not_emergency(), E_EMERGENCY_ABORT);
        ...
        acquires Pool, FeeMoveEventHolder, AddLiquidityEventHolder
    {
        assert!(is_not_emergency(), E_EMERGENCY_ABORT);
        let pool = borrow_global_mut<Pool<Coin0, Coin1>>(@aux);
        let fee_move_events = borrow_global_mut<FeeMoveEventHolder<Coin0, Coin1>>(@aux);
        move_fee_into_reward_distributor<Coin0, Coin1>(pool, fee_move_events);
    ...
    ): (Coin<LP<Coin0, Coin1>>, RedeemToken<Coin0, LP<Coin0, Coin1>>, RedeemToken<Coin1, LP<Coin0, Coin1>>) {
        assert!(is_not_emergency(), E_EMERGENCY_ABORT);
        let LPBundle {
            reward_token_0,
            reward_token_1,
