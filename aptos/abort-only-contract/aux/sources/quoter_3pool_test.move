...
module aux::quoter_3pool_test {
    ...
    fun test_3pool() {
        ...
        assert!(bob_usdc8_balance == 136891812032, bob_usdc8_balance);
        assert!(bob_usdc_balance == 410168677, bob_usdc_balance);
        assert!(bob_usdt_balance == 1301025882, bob_usdt_balance);
