...
module aux::quoter_3pool {
    ...
    public fun move_fee_into_reserve(pool: &mut Quoter)
    {
        ...
        let fee_moved_2 = pool.fee_2;
        // only merge if there is fee to move
        if (fee_moved_2> 0) {
            fee_added = true;
            pool.reserve_2 = pool.reserve_2 + pool.fee_2;
            pool.fee_2 = 0;
        };
    ...
    ): u64
    {
        ...
        // move the coins into reserve
        pool.reserve_2 = pool.reserve_2 + amount_2;
    ...
    ): (u64, u64, u64, u64)
    {
        ...
        let coin_2 = if (amount_2_to_withdraw > 0) {
            ...
            pool.reserve_2 = pool.reserve_2 - fee;
            pool.fee_2 = pool.fee_2 + fee;
            pool.reserve_2 = pool.reserve_2 - amount_2_to_withdraw;
    ...
    ): (u64, u64, u64)
    {
        ...
        let before_reserve_2 = pool.reserve_2;

        let withdraw_2 = (
            ((before_reserve_2 as u128) * (lp_burnt as u128))
            / before_lp_tokens_supply
             as u64);
        pool.reserve_2 = pool.reserve_2 - withdraw_2;
        let coin_2 = withdraw_2;
    ...
    ): (u64, u64, u64)
    {
        ...
        if (out_coin_index != 2) {
            pool.reserve_2 = pool.reserve_2 + coin_2;
        };

        let after_reserve_2 = pool.reserve_2;
        ...
        if (is_coin_2_out) {
            ...
            coin_2 = coin_2 + amount_2_out;
            pool.reserve_2 = pool.reserve_2 - amount_2_out;
            pool.fee_2 = pool.fee_2 + fee_2;
            pool.reserve_2 = pool.reserve_2 - fee_2;
        };
    ...
    ): (u64, u64, u64)
    {
        ...
        let coin_2 = if (in_coin_index == 2) {
            max_in_coin_amount
        } else if (requested_quantity_2 > 0) {
            // calculate fee.
            // fee is based on the amount user receives.
            ...
            pool.fee_2 = pool.fee_2 + fee;
            pool.reserve_2 = pool.reserve_2 - fee;
            pool.reserve_2 = pool.reserve_2 - requested_quantity_2;
        ...
        if (in_coin_index == 2) {
            ...
            assert!(amount_2_in <= coin_2, E_INPUT_COIN_INSUFFICIENT);
            coin_2 = coin_2 - amount_2_in;
            pool.reserve_2 = pool.reserve_2 + amount_2_in;
        };
    ...
    ): u64
    {
        ...
        let pool = *pool;
        let (_, _, _, leftover_lp) = remove_liquidity_for_coin(
            &mut pool,
            amount_0_to_withdraw,
            amount_1_to_withdraw,
            amount_2_to_withdraw,
    ...
    public fun update_balanced_reserve(
        ...
        let reserve_2_unscaled = pool.reserve_2;
    ...
    public fun get_scaler_2(pool: &Quoter): u128 {
        assert!(is_not_emergency(), E_EMERGENCY_ABORT);
        pool.scaler_2
    }
}
