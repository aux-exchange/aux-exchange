...
> = {
  ...
  isCoinRegistered?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<AccountIsCoinRegisteredArgs, "coinType">
  >;
  openOrders?: Resolver<
    Array<ResolversTypes["Order"]>,
    ParentType,
    ContextType,
    Partial<AccountOpenOrdersArgs>
  >;
  orderHistory?: Resolver<
    Array<ResolversTypes["Order"]>,
    ParentType,
    ContextType,
    Partial<AccountOrderHistoryArgs>
  >;
  poolPositions?: Resolver<
    Array<ResolversTypes["Position"]>,
    ParentType,
    ContextType,
    Partial<AccountPoolPositionsArgs>
  >;
  registeredCoins?: Resolver<
    Array<ResolversTypes["RegisteredCoinInfo"]>,
    ParentType,
    ContextType
  >;
  tradeHistory?: Resolver<
    Array<ResolversTypes["Trade"]>,
    ParentType,
    ContextType,
    Partial<AccountTradeHistoryArgs>
  >;
  transfers?: Resolver<
    ...
    ContextType
  >;
  walletBalances?: Resolver<
    Array<ResolversTypes["Balance"]>,
    ParentType,
    ContextType
  >;
  withdrawals?: Resolver<
    Array<ResolversTypes["Withdrawal"]>,
    ParentType,
    ContextType
  >;
...
export type AddLiquidityResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["AddLiquidity"] = ResolversParentTypes["AddLiquidity"]
> = {
...
export interface EntryFunctionPayloadScalarConfig
  extends GraphQLScalarTypeConfig<ResolversTypes["EntryFunctionPayload"], any> {
  name: "EntryFunctionPayload";
}

export type High24hResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["High24h"] = ResolversParentTypes["High24h"]
> = {
  baseCoinType?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
...
export type LastTradePriceResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["LastTradePrice"] = ResolversParentTypes["LastTradePrice"]
> = {
  baseCoinType?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
...
export type Low24hResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["Low24h"] = ResolversParentTypes["Low24h"]
> = {
  baseCoinType?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
...
> = {
  bars?: Resolver<
    Array<ResolversTypes["Bar"]>,
    ParentType,
    ContextType,
    RequireFields<MarketBarsArgs, "resolution">
  >;
  ...
  isRoundLot?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MarketIsRoundLotArgs, "quantity">
  >;
  isRoundTick?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<MarketIsRoundTickArgs, "quantity">
  >;
  ...
  openOrders?: Resolver<
    ...
    ParentType,
    ContextType,
    Partial<MarketOpenOrdersArgs>
  >;
  orderHistory?: Resolver<
    Array<ResolversTypes["Order"]>,
    ParentType,
    ContextType,
    Partial<MarketOrderHistoryArgs>
  >;
  orderbook?: Resolver<ResolversTypes["Orderbook"], ParentType, ContextType>;
  pythRating?: Resolver<
    Maybe<ResolversTypes["PythRating"]>,
    ParentType,
    ContextType,
    RequireFields<MarketPythRatingArgs, "price" | "side">
  >;
  ...
  tradeHistory?: Resolver<
    ...
    ParentType,
    ContextType,
    Partial<MarketTradeHistoryArgs>
  >;
...
> = {
  addLiquidity?: Resolver<
    ResolversTypes["EntryFunctionPayload"],
    ParentType,
    ContextType,
    RequireFields<MutationAddLiquidityArgs, "addLiquidityInput">
  >;
  addLiquidityWithAccount?: Resolver<
    ResolversTypes["EntryFunctionPayload"],
    ParentType,
    ContextType,
    RequireFields<MutationAddLiquidityWithAccountArgs, "addLiquidityInput">
  >;
  cancelOrder?: Resolver<
    ResolversTypes["EntryFunctionPayload"],
    ParentType,
    ContextType,
    RequireFields<MutationCancelOrderArgs, "cancelOrderInput">
  >;
  createAuxAccount?: Resolver<
    ResolversTypes["EntryFunctionPayload"],
    ParentType,
    ContextType
  >;
  createMarket?: Resolver<
    ResolversTypes["EntryFunctionPayload"],
    ParentType,
    ContextType,
    RequireFields<MutationCreateMarketArgs, "createMarketInput">
  >;
  createPool?: Resolver<
    ResolversTypes["EntryFunctionPayload"],
    ParentType,
    ContextType,
    RequireFields<MutationCreatePoolArgs, "createPoolInput">
  >;
  deposit?: Resolver<
    ResolversTypes["EntryFunctionPayload"],
    ParentType,
    ContextType,
    RequireFields<MutationDepositArgs, "depositInput">
  >;
  placeOrder?: Resolver<
    ResolversTypes["EntryFunctionPayload"],
    ParentType,
    ContextType,
    RequireFields<MutationPlaceOrderArgs, "placeOrderInput">
  >;
  registerCoin?: Resolver<
    ResolversTypes["EntryFunctionPayload"],
    ParentType,
    ContextType,
    RequireFields<MutationRegisterCoinArgs, "registerCoinInput">
  >;
  removeLiquidity?: Resolver<
    ResolversTypes["EntryFunctionPayload"],
    ParentType,
    ContextType,
    RequireFields<MutationRemoveLiquidityArgs, "removeLiquidityInput">
  >;
  removeLiquidityWithAccount?: Resolver<
    ResolversTypes["EntryFunctionPayload"],
    ParentType,
    ContextType,
    RequireFields<
      MutationRemoveLiquidityWithAccountArgs,
      "removeLiquidityInput"
    >
  >;
  swapExactIn?: Resolver<
    ResolversTypes["EntryFunctionPayload"],
    ParentType,
    ContextType,
    RequireFields<MutationSwapExactInArgs, "swapExactInInput">
  >;
  swapExactOut?: Resolver<
    ResolversTypes["EntryFunctionPayload"],
    ParentType,
    ContextType,
    RequireFields<MutationSwapExactOutArgs, "swapExactOutInput">
  >;
  transfer?: Resolver<
    ResolversTypes["EntryFunctionPayload"],
    ParentType,
    ContextType,
    RequireFields<MutationTransferArgs, "transferInput">
  >;
  withdraw?: Resolver<
    ResolversTypes["EntryFunctionPayload"],
    ParentType,
    ContextType,
    RequireFields<MutationWithdrawArgs, "withdrawInput">
  >;
};

export type OhlcvResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["Ohlcv"] = ResolversParentTypes["Ohlcv"]
> = {
...
export type OrderbookResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["Orderbook"] = ResolversParentTypes["Orderbook"]
> = {
...
> = {
  adds?: Resolver<
    Array<ResolversTypes["AddLiquidity"]>,
    ParentType,
    ContextType,
    Partial<PoolAddsArgs>
  >;
  ...
  featuredStatus?: Resolver<
    ResolversTypes["FeaturedStatus"],
    ParentType,
    ContextType
  >;
  ...
  position?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<PoolPositionArgs, "owner">
  >;
  priceX?: Resolver<ResolversTypes["Float"], ParentType, ContextType>;
  priceY?: Resolver<ResolversTypes["Float"], ParentType, ContextType>;
  quoteExactIn?: Resolver<
    ResolversTypes["QuoteExactIn"],
    ParentType,
    ContextType,
    RequireFields<PoolQuoteExactInArgs, "amountIn" | "coinTypeIn">
  >;
  quoteExactOut?: Resolver<
    ResolversTypes["QuoteExactOut"],
    ParentType,
    ContextType,
    RequireFields<PoolQuoteExactOutArgs, "amountOut" | "coinTypeOut">
  >;
  removes?: Resolver<
    Array<ResolversTypes["RemoveLiquidity"]>,
    ParentType,
    ContextType,
    Partial<PoolRemovesArgs>
  >;
  swaps?: Resolver<
    Array<ResolversTypes["Swap"]>,
    ParentType,
    ContextType,
    Partial<PoolSwapsArgs>
  >;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type PythRatingResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["PythRating"] = ResolversParentTypes["PythRating"]
> = {
...
> = {
  account?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryAccountArgs, "owner">
  >;
  address?: Resolver<ResolversTypes["Address"], ParentType, ContextType>;
  ...
  market?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryMarketArgs, "marketInput">
  >;
  markets?: Resolver<
    Array<ResolversTypes["Market"]>,
    ParentType,
    ContextType,
    Partial<QueryMarketsArgs>
  >;
  pool?: Resolver<
    Maybe<ResolversTypes["Pool"]>,
    ParentType,
    ContextType,
    RequireFields<QueryPoolArgs, "poolInput">
  >;
  pools?: Resolver<
  ...
  >;
  summaryMetrics?: Resolver<
    ResolversTypes["SummaryMetrics"],
    ParentType,
    ContextType
  >;
};

export type QuoteExactInResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["QuoteExactIn"] = ResolversParentTypes["QuoteExactIn"]
> = {
  expectedAmountOut?: Resolver<
    ResolversTypes["Float"],
    ParentType,
    ContextType
  >;
  feeAmount?: Resolver<ResolversTypes["Float"], ParentType, ContextType>;
  feeAmountDollars?: Resolver<
...
export type QuoteExactOutResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["QuoteExactOut"] = ResolversParentTypes["QuoteExactOut"]
> = {
...
export type RegisteredCoinInfoResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["RegisteredCoinInfo"] = ResolversParentTypes["RegisteredCoinInfo"]
> = {
  coinInfo?: Resolver<ResolversTypes["CoinInfo"], ParentType, ContextType>;
...
export type RemoveLiquidityResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["RemoveLiquidity"] = ResolversParentTypes["RemoveLiquidity"]
> = {
...
> = {
  addLiquidity?: SubscriptionResolver<
    ResolversTypes["AddLiquidity"],
    "addLiquidity",
    ParentType,
    ContextType,
    Partial<SubscriptionAddLiquidityArgs>
  >;
  bar?: SubscriptionResolver<
    ResolversTypes["Bar"],
    "bar",
    ParentType,
    ContextType,
    RequireFields<SubscriptionBarArgs, "resolution">
  >;
  high24h?: SubscriptionResolver<
    ResolversTypes["High24h"],
    "high24h",
    ParentType,
    ContextType,
    Partial<SubscriptionHigh24hArgs>
  >;
  lastTradePrice?: SubscriptionResolver<
    ResolversTypes["LastTradePrice"],
    "lastTradePrice",
    ParentType,
    ContextType,
    Partial<SubscriptionLastTradePriceArgs>
  >;
  low24h?: SubscriptionResolver<
    ResolversTypes["Low24h"],
    "low24h",
    ParentType,
    ContextType,
    Partial<SubscriptionLow24hArgs>
  >;
  orderbook?: SubscriptionResolver<
    ResolversTypes["Orderbook"],
    "orderbook",
    ParentType,
    ContextType,
    Partial<SubscriptionOrderbookArgs>
  >;
  removeLiquidity?: SubscriptionResolver<
    ResolversTypes["RemoveLiquidity"],
    "removeLiquidity",
    ParentType,
    ContextType,
    Partial<SubscriptionRemoveLiquidityArgs>
  >;
  swap?: SubscriptionResolver<
    ...
    ParentType,
    ContextType,
    Partial<SubscriptionSwapArgs>
  >;
  trade?: SubscriptionResolver<
    ResolversTypes["Order"],
    "trade",
    ParentType,
    ContextType,
    Partial<SubscriptionTradeArgs>
  >;
  volume24h?: SubscriptionResolver<
    ResolversTypes["Volume24h"],
    "volume24h",
    ParentType,
    ContextType,
    Partial<SubscriptionVolume24hArgs>
  >;
};

export type SummaryMetricsResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["SummaryMetrics"] = ResolversParentTypes["SummaryMetrics"]
> = {
...
export type Volume24hResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["Volume24h"] = ResolversParentTypes["Volume24h"]
> = {
  baseCoinType?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  quoteCoinType?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  volume?: Resolver<ResolversTypes["Float"], ParentType, ContextType>;
