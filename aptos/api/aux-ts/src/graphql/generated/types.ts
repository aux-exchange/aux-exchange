...
export type Query = {
  ...
  pools: Array<Pool>;
  routerQuoteExactIn?: Maybe<Scalars["Float"]>;
};
...
export type QueryRouterQuoteExactInArgs = {
...
> = {
  ...
  >;
  routerQuoteExactIn?: Resolver<
    Maybe<ResolversTypes["Float"]>,
    ParentType,
    ContextType,
    RequireFields<QueryRouterQuoteExactInArgs, "input">
  >;
};
