;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [92],
  {
    4270: (t) => {
      t.exports = {
        'close-button': 'close-button-1X92xTLv',
        'close-icon': 'close-icon-1X92xTLv',
        'button-l': 'button-l-1X92xTLv',
        'button-m': 'button-m-1X92xTLv',
        'button-s': 'button-s-1X92xTLv',
        'button-xs': 'button-xs-1X92xTLv',
        'button-xxs': 'button-xxs-1X92xTLv'
      }
    },
    47822: (t) => {
      t.exports = {
        container: 'container-2EQh-XLR',
        'container-danger': 'container-danger-2EQh-XLR',
        icon: 'icon-2EQh-XLR',
        header: 'header-2EQh-XLR',
        'container-warning': 'container-warning-2EQh-XLR',
        'container-success': 'container-success-2EQh-XLR',
        'container-default': 'container-default-2EQh-XLR',
        'text-wrap': 'text-wrap-2EQh-XLR',
        'close-button': 'close-button-2EQh-XLR'
      }
    },
    68174: (t) => {
      t.exports = {
    ...
    38868: (t, e, n) => {
      'use strict'
      n.r(e), n.d(e, { ChartScreenshotHintRenderer: () => k })
      var o = n(67294),
        s = n(73935),
        r = n(99479),
        a = n(94184),
      ...
      var x = n(72344),
        ...
        E = n(47822),
        f = n.n(E)
      const L = { danger: x, warning: x, success: b, default: p }
      function _(t) {
        const {
          informerIntent: e,
          content: n,
        ...
        return o.createElement(
          'div',
          { className: a(f().container, f()['container-' + e], s) },
          c &&
          ...
          o.createElement(
            'div',
            { className: f()['text-wrap'] },
            o.createElement('span', { className: f().header }, r),
            ' ',
            n
          ),
          h &&
      ...
      function M(t) {
        ...
        return (
          ...
          o.createElement(
            'div',
            { className: a(C.container, t.bottomPadding && C.bottomPadding) },
            o.createElement(
              'div',
              ...
              o.createElement(_, {
                ...
                className: a(C.notice, e && C['notice-showed'])
              })
            )
          )
        )
      ...
      class k {
        ...
        show(t) {
          this._wrap &&
            ...
            s.render(
              o.createElement(M, {
                text: t,
                bottomPadding: this._bottomPadding
              }),
              this._wrap
            ),
            this._debouncedHide())
        ...
        hide() {
          this._wrap &&
            ((this._showed = !1),
            s.unmountComponentAtNode(this._wrap),
            this._wrap.remove())
        }
        destroy() {
