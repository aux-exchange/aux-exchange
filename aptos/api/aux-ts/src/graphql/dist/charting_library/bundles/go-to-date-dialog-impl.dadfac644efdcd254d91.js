    ...
    93548: (e, t, n) => {
      ...
      function O(e) {
        ...
        return s.createElement(
          'div',
          { className: k()(P.row, _e && P.mobileRow) },
          t
        )
      }
      var F = n(96404),
      ...
      class U extends s.PureComponent {
        constructor() {
          super(...arguments),
            (this._renderWeekdays = () =>
              z.map((e) => s.createElement('span', { key: e }, e)))
        }
        render() {
          return s.createElement(
            'div',
        ...
        _renderWeeks() {
          ...
          for (let n = 0; n < 6; n++)
            e.push(this._renderWeek(t)), (t = new Date(d(t)))
          return e
        }
        _renderWeek(e) {
          const t = []
          for (let r = 0; r < 7; r++) {
            ...
            a.setDate(a.getDate() + r),
              ((n = a),
              (o = this.props.viewDate),
              Number(u(n)) === Number(u(o))) &&
                t.push(
                  s.createElement(W, {
                    key: r,
                    day: a,
      ...
      class V extends s.PureComponent {
        constructor(e) {
          super(e),
            ...
            (this._onClickDay = (e) => {
              this.setState({ viewDate: new Date(e) }),
        ...
        render() {
          return s.createElement(
            'div',
            {
              className: y(
                H.calendar,
                this.props.popupStyle && H.popupStyle,
            ...
            s.createElement(
              ...
              s.createElement(A.Icon, {
                ...
                className: y(H.switchBtn, H.prev)
              }),
              s.createElement(
                'div',
                { className: H.title },
                `${
                  L[this.state.viewDate.getMonth()]
                } ${this.state.viewDate.getFullYear()}`
              ),
              s.createElement(A.Icon, {
                icon: q,
                onClick: this._nextMonth,
                className: y(H.switchBtn, H.next)
              })
            ),
            s.createElement(U, {
          ...
          super(e),
            ...
            (this._onShowPicker = (e) => {
              if (e && this._inputContainer) {
                ...
                ;(e.style.top = 'auto'),
                  (e.style.bottom = o < t.height ? '0' : s + n.height + 'px')
              }
            }),
            (this._onChange = () => {
                ...
                n && n.length
                  ...
                  : s.createElement(
                      ...
                      s.createElement(A.Icon, {
                        ...
                        className: y(Y.icon, t && Y.disabled)
                      })
                    ),
              className: e,
      ...
      class te extends s.PureComponent {
              ...
              if (/^[0-9]{4}(-[0-9]{2}){2}/.test(e)) {
                ...
                return (
                  ...
                  (!!this.props.noRangeValidation ||
                    p(t, this.props.minDate, this.props.maxDate))
                )
              }
              return !1
            }),
            ...
            (this._getErrors = () => {
              ...
              return (
                this.state.isInvalid &&
                  e.push(
                    (0, S.t)('Please enter the right date format yyyy-mm-dd')
                  ),
                e
              )
            }),
        ...
        _getFontSizeClassName(e) {
          return e
            ? 'large' === e
              ? Z.InputClasses.FontSizeLarge
              : Z.InputClasses.FontSizeMedium
            : void 0
        }
      }
      ...
      function ae(e) {
        ...
        return s.createElement(
          ...
          t &&
            s.createElement(se, {
              text: (0, S.t)('Please enter the right date'),
              className: a.tooltip
            })
        )
      }
      ...
      function ge(e) {
        const {
          ...
          } = e,
          {
            ...
            setDateFrom: l,
            setDateTo: c
          } = (0, r.ensureNotNull)((0, s.useContext)(E)),
          [u, h] = (0, s.useState)('from'),
          d = (0, s.useRef)(null),
          p = (0, s.useRef)(null),
          m = (0, s.useRef)(null),
          v = (0, s.useMemo)(
            () => ('from' === u ? new Date(a) : new Date(i)),
            [u, i, a]
          )
        return (
          (0, s.useEffect)(() => {
      ...
      const _e = F.mobiletouch,
        ...
        Ce = {
          byId: {
            Date: { title: (0, S.t)('Date') },
            CustomRange: { title: (0, S.t)('Custom range') }
          },
      ...
      function Se(e) {
        const { dateOnly: t, onClose: n, onGoToDate: o, onGoToRange: a } = e,
          i = (0, s.useRef)(null),
          [l, c] = (0, s.useState)(
            I().getValue('GoToDialog.activeTab', 'Date')
          ),
          [u, h] = (0, s.useState)(0),
      ...
      function Oe(e) {
        const t = (function (e) {
          ...
          return {
            from: (0, r.ensureNotNull)(t.indexToUserTime(o)),
            to: (0, r.ensureNotNull)(t.indexToUserTime(a))
          }
        })(e)
        return t
          ? { from: v(t.from), to: v(t.to) }
          : { from: v(new Date()), to: v(new Date()) }
      }
    },
    59726: (e, t, n) => {
      'use strict'
      ...
      function d(e) {
        ...
        return s.createElement(
          u,
          {
            ...
            role: n,
            'aria-selected': c,
            className: o(d, P.item, w && P.withIcon, {
              [P.isActive]: D,
              [P.isDisabled]: b || E,
              [P.hovered]: _
            }),
            ...
            onContextMenu: function (t) {
              ...
              n &&
                s &&
                (0, a.trackEvent)(n.category, n.event, n.label + '_rightClick')
            },
            onMouseUp: function (t) {
              ...
              if (1 === t.button && S && n) {
                ...
                s && (e += '_mouseWheelClick'),
                  (0, a.trackEvent)(n.category, n.event, e)
              }
            },
            onMouseOver: M,
            onMouseOut: T
          ...
          void 0 !== x &&
            s.createElement(
              ...
              {
                onClick: R ? h : void 0,
                className: o(P.toolbox, { [P.showOnHover]: y })
              },
              x
            )
        )
