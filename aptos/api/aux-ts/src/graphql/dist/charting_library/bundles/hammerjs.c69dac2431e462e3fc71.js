  ...
  [2377],
  {
    50840: (t, e, i) => {
      ...
      !(function (r, s, o, a) {
        ...
        function _t(t, e) {
          return (
            ((e = e || {}).recognizers = C(e.recognizers, _t.defaults.preset)),
            new Pt(t, e)
          )
        }
        ;(dt.prototype = {
          ...
          recognizeWith: function (t) {
            ...
            return (
              e[(t = Tt(t, this)).id] || ((e[t.id] = t), t.recognizeWith(this)),
              this
            )
          },
          dropRecognizeWith: function (t) {
            return (
              d(t, 'dropRecognizeWith', this) ||
                ((t = Tt(t, this)), delete this.simultaneous[t.id]),
              this
            )
          },
          ...
          E(Et, yt, {
            ...
            attrTest: function (t) {
              return (
                yt.prototype.attrTest.call(this, t) &&
            ...
            process: function (t) {
              ...
              if (n && r && i) {
                ...
                var s = !this.pTime || t.timeStamp - this.pTime < e.interval,
                  o =
                    !this.pCenter || j(this.pCenter, t.center) < e.posThreshold
                if (
