;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [847],
  {
    ...
    38817: (e) => {
      e.exports = {
        'textarea-container': 'textarea-container-1F0MhDpb',
        'change-highlight': 'change-highlight-1F0MhDpb',
        focused: 'focused-1F0MhDpb',
        'resize-vertical': 'resize-vertical-1F0MhDpb',
        'resize-horizontal': 'resize-horizontal-1F0MhDpb',
        'resize-both': 'resize-both-1F0MhDpb',
        textarea: 'textarea-1F0MhDpb'
      }
    },
    81880: (e) => {
      e.exports = {
    ...
    69343: (e) => {
      e.exports = {
        thicknessContainer: 'thicknessContainer-2K1QSVfY',
        thicknessTitle: 'thicknessTitle-2K1QSVfY'
      }
    },
    2626: (e) => {
      e.exports = {
        hasTooltip: 'hasTooltip-2kfQACVg',
        uppercase: 'uppercase-2kfQACVg'
      }
    },
    75671: (e) => {
      e.exports = {
    ...
    22196: (e) => {
      e.exports = { titleWrap: 'titleWrap-3OnZWCnE', title: 'title-3OnZWCnE' }
    },
    37850: (e, t, n) => {
      'use strict'
      n.d(t, { Checkbox: () => c })
      ...
      class c extends o.PureComponent {
        render() {
          const { inputClassName: e, labelClassName: t, ...n } = this.props,
            a = r(this.props.className, i().checkbox, {
          ...
          return (
            ...
            o.createElement(
              'label',
              { className: a },
              o.createElement(s.CheckboxInput, { ...n, className: e }),
              c
            )
          )
        }
        ...
        return r.createElement(p.ControlSkeleton, {
          ...
          middleSlot: r.createElement(
            ...
            r.createElement('textarea', {
              ...B,
              className: a(g().textarea, c),
              ref: t
            })
          )
        })
      })
      b.displayName = 'TextareaView'
      const f = (e, t, n) => (t ? void 0 : e ? -1 : n),
        C = (e, t, n) => (t ? void 0 : e ? n : -1),
        v = r.forwardRef((e, t) => {
          e = (0, i.useControl)(e)
          const {
              className: n,
            ...
            [P, V] = (0, l.useFocus)(),
            _ = (0, u.createSafeMulticastEventHandler)(
              V.onFocus,
              function (e) {
            ...
            F = (0, u.createSafeMulticastEventHandler)(V.onBlur, k),
            z = void 0 !== S && S !== o.None,
            B = null != v ? v : z ? (y ? 'thick' : 'thin') : void 0,
            D = null != y ? y : !z && void 0
          return r.createElement(b, {
            ...w,
            className: a(
              g()['textarea-container'],
              z && g()['change-highlight'],
            ...
            disabled: p,
            isFocused: P,
            containerTabIndex: f(P, p, m),
            tabIndex: C(P, p, m),
            borderStyle: B,
            highlight: D,
            onContainerFocus: function (e) {
              M.current === e.target && null !== x.current && x.current.focus()
            },
            onFocus: _,
            onBlur: F,
            onMouseDown: T,
            ...
            containerReference: (0, s.useMergedRefs)([E, M])
          })
        })
    ...
    82604: (e, t, n) => {
      'use strict'
      n.d(t, { SwitchGroup: () => a, makeSwitchGroupItem: () => s })
      var o = n(67294),
        r = n(45697)
    ...
    66094: (e, t, n) => {
      ...
      function m(e) {
        const {
          ...
          E = b && void 0 !== s ? [s] : void 0,
          N = f && void 0 !== s ? [s] : void 0,
          k = a(d.inputContainer, p[u], t),
          w = C
            ? o.createElement(
                l.StartSlot,
            ...
            : void 0,
          x = m || g || y ? o.createElement(l.EndSlot, null, m, g, y) : void 0
      ...
      var g = n(79881),
        ...
        C = n(76535)
      function v(e) {
        const t = a(C.control, C.controlIncrease),
          n = a(C.control, C.controlDecrease)
              ...
              o.createElement(
                ...
                o.createElement(
                  'button',
                  {
                    type: 'button',
                    tabIndex: -1,
                    'aria-label': (0, g.t)('Increase'),
                    className: t,
                    onClick: e.increaseValue
                  },
                  o.createElement(b.Icon, { icon: f, className: C.controlIcon })
                ),
                o.createElement(
                  'button',
                  {
      ...
      const k = [38],
        w = [40]
      function x(e) {
        const [t, n] = (0, y.useHover)(),
          [a, s] = (0, S.useFocus)(),
          l = (0, E.createSafeMulticastEventHandler)(s.onFocus, e.onFocus),
          i = (0, E.createSafeMulticastEventHandler)(s.onBlur, e.onBlur),
          c = (0, o.useCallback)(
            (t) => {
              !e.disabled &&
                a &&
    ...
    41497: (e, t, n) => {
      ...
      var o = n(67294),
        ...
        a = n(79881),
        s = n(90963)
      const l = (0, n(65447).getLogger)(
          'Platform.GUI.StudyInputPropertyContainer'
        ),
        i = new s.TranslatedString(
          'change {propertyName} property',
          (0, a.t)('change {propertyName} property')
        ),
        ...
        constructor(e) {
          super(e),
            (this._setValue = (e, t, n) => {
              const { property: o, model: c } = this.props,
                u = (0, r.ensureDefined)(o.child(e))
              l.logNormal(
              ...
              const d = new s.TranslatedString(
                n,
                (function (e) {
                  return (0, a.t)(e, { context: 'input' })
                })(n)
              )
              c.setProperty(u, t, i.format({ propertyName: d }))
            })
          const { property: t } = e,
            n = {}
          t.childNames().forEach((e) => {
            const o = (0, r.ensureDefined)(t.child(e))
    ...
    49923: (e, t, n) => {
      'use strict'
      n.d(t, { getSymbolName: () => c, SymbolInput: () => u })
      var o = n(67294),
        r = n(16282),
        a = n(41497),
        s = n(84254),
    ...
    35665: (e, t, n) => {
      ...
      class i extends o.PureComponent {
        render() {
          return o.createElement(
            'div',
            { ref: this.props.reference, className: s.content },
            this.props.children
          )
        }
      }
      ;(i.InlineRowContext = l),
        (i.Row = function (e) {
          ...
          return (0, o.useContext)(l)
            ? o.createElement('span', { className: s.inlineRow }, t)
        ...
        (i.Cell = function (e) {
          const t = (0, o.useContext)(l),
            n = r(
              ...
              e.grouped && s.grouped,
              t && s.inlineCell,
              'top' === e.verticalAlign && s.top,
              'topCenter' === e.verticalAlign && s.topCenter,
              'adaptive' === e.verticalAlign && s.adaptive,
              e.checkableTitle && s.checkableTitle,
              2 === e.colSpan && s.fill,
              'first' === e.placement && 2 !== e.colSpan && s.first,
              'last' === e.placement && 2 !== e.colSpan && s.last
            ),
          ...
          return o.createElement(
            ...
            o.createElement(
              'div',
              { className: r(s.inner, e.className) },
              e.children
            )
          )
        }),
        (i.Separator = function (e) {
          return o.createElement(
            ...
            null,
            o.createElement('div', {
              className: r(s.cell, s.separator, s.fill)
            })
          )
        }),
        (i.GroupSeparator = function (e) {
          ...
          return o.createElement(
            ...
            null,
            o.createElement('div', {
              className: r(s.cell, s.groupSeparator, s.fill, 1 === t && s.big)
            })
          )
        })
    },
    32895: (e, t, n) => {
      ...
      function p(e) {
        ...
        function y() {
          e.disabled || (b((e) => !e), m(!1))
        }
        function S(e) {
          switch ((0, l.hashFromEvent)(e)) {
            case 27:
              g && (e.preventDefault(), E())
          }
        }
        function E() {
          y(), (0, s.ensureNotNull)(v.current).focus(), a && a()
        }
      }
      var h = n(6347),
        m = n(50968),
        ...
        f = n(82604),
        C = n(81880)
      const v = (0, f.makeSwitchGroupItem)(
        class extends o.PureComponent {
          ...
          render() {
            const { name: e, checked: t, value: n } = this.props,
              a = r(C.thicknessItem, { [C.checked]: t }),
              s = r(C.bar, { [C.checked]: t }),
              l = { borderTopWidth: parseInt(n) }
            return o.createElement(
              'div',
              { className: a },
              ...
              o.createElement('div', { className: s, style: l }, ' ')
            )
          }
        }
      )
      function y(e) {
        const { name: t, values: n, selectedValues: r, onChange: a } = e,
          s = n.map((e, t) =>
            o.createElement(v, { key: t, value: e.toString() })
          ),
          ...
          p,
          {
            ...
            button: function (e, t) {
              ...
              return o.createElement(
                ...
                o.createElement(
                  'div',
                  { className: a()(k.colorPicker, l && k.disabled) },
                  s
                    ? (function () {
                        const e = x(s, i),
                          t = i >= 0.95 && M(s)
                        return o.createElement(
                          'div',
                          { className: k.opacitySwatch },
                          o.createElement('div', {
                            style: {
                              backgroundColor: e
                            },
                            className: a()(k.swatch, t && k.white)
                          })
                        )
                      })()
                    : o.createElement(
                        'div',
                        { className: k.placeholderContainer },
                        o.createElement('div', { className: k.placeholder })
                      ),
                  r &&
                    o.createElement('span', {
                      className: a()(k.colorLine, M(s) && k.white),
                      style: { height: r, backgroundColor: x(s, i) }
                    })
                ),
                n && o.createElement('span', { className: k.shadow })
              )
            },
            onPopupClose: g
          },
    ...
    8786: (e, t, n) => {
      ...
      function f(e) {
        ...
        return o.createElement(
          'div',
          {
            className: r(b.wrap, l && b.disabled, a),
            onClick: n,
            'data-name': 'edit-button'
          },
          o.createElement(
            'div',
            { className: r(b.text, 'apply-overflow-tooltip') },
            void 0 !== s && s,
            o.createElement('span', null, t)
          ),
          o.createElement(m.Icon, { icon: g, className: b.icon })
        )
      }
      var C = n(15973),
        v = n(65244),
      ...
      function k(e) {
        const { symbol: t, onSymbolChanged: n, disabled: r, className: l } = e,
          [d, m] = (0, o.useState)(t),
          g = (0, o.useContext)(i.SlotContext),
        ...
        return o.createElement(f, {
          ...
          onClick: function () {
            ...
            ;(0, h.showSymbolSearchItemsDialog)({
              ...
              dialogTitle: (0, s.t)('Change symbol'),
              defaultValue: e,
              manager: g,
              onClose: () => {
                b && b.focus()
          ...
          className: a()(
            l,
            u.enabled('uppercase_instrument_names') && N.uppercase
          )
        })
      }
      function w(e) {
    ...
    65244: (e, t, n) => {
      ...
      function l(e) {
        return o.createElement(
          'div',
          { className: a()(s.wrap, e.className) },
          e.children
        )
      }
    },
    96021: (e, t, n) => {
      ...
      function s(e) {
        const { property: t, ...n } = e,
          [s, l] = (0, a.useDefinitionProperty)({ property: t }),
          i = 'mixed' === s
    ...
    87131: (e, t, n) => {
      'use strict'
      n.d(t, { logger: () => o })
      const o = (0, n(65447).getLogger)('Platform.GUI.PropertyDefinitionTrace')
    },
    86284: (e) => {
      e.exports =
