;(self.webpackChunktradingview = self.webpackChunktradingview || []).push([
  [2704],
  {
    ...
    60499: (e) => {
      e.exports = {
        container: 'container-9xiUj6X_',
        separator: 'separator-9xiUj6X_',
        section: 'section-9xiUj6X_'
      }
    },
    8251: (e) => {
      e.exports = {
      ...
      function l(e, t) {
        return (n, l) => {
          const u = (0, a.ensureNotNull)(e).getBoundingClientRect(),
            ...
            D = {
              x: C - (p === s.FromRightToLeft ? n : 0) + f,
              y: x - (h === r.FromBottomToTop ? l : 0) + E
            }
      ...
      function r(e, t, n) {
        ...
        for (const e of p)
          for (const t of e.units)
            t.id !== c &&
              l.has(t.id) &&
              h.actions.push(s(t.id, t.name, t.description, !1, () => a(t.id)))
        h.actions.length > 0 && r.push(h)
          ...
          for (const e of p) {
            ...
            for (const n of e.units)
              n.id === c ||
                l.has(n.id) ||
                t.actions.push(
                  s(n.id, n.name, n.description, !1, () => a(n.id))
                )
        ...
        for (const e of p) {
          ...
          for (const n of e.units)
            n.id === c ||
              l.has(n.id) ||
              t.actions.push(s(n.id, n.name, n.description, !1, () => a(n.id)))
          t.actions.length > 0 && r.push(t)
        }
        return r
      }
    ...
    23412: (e, t, n) => {
        ...
        return o.createElement(
          ...
          o.createElement(
            ...
            p &&
              o.createElement(
                'span',
                { className: d()(D.description, v) },
                s ? E(s) : ''
              )
          )
        )
        function E(e) {
          return o.createElement(x.HighlightedText, {
            text: e,
            rules: i,
            queryString: r,
            className: d()(l && D.highlighted, l && D.active)
          })
        }
      }
      var S = n(70422),
        ...
        return o.createElement(k.AdaptivePopupDialog, {
          ...
          render: function () {
            return o.createElement(
              o.Fragment,
              null,
              o.createElement(z.DialogSearch, {
                placeholder: (0, h.t)('Search'),
                onChange: f,
                reference: d
              }),
                      ...
                      o.createElement(
                        ...
                        e.actions.map((c, l) => {
                          ...
                          return o.createElement(
                            ...
                            !g &&
                              f &&
                              o.createElement('div', { className: I.separator })
                          )
                        })
                      )
                    )
      ...
      function B(e) {
        const { element: t, ...n } = e,
          ...
          { activeIdx: g, setActiveIdx: v } = (function (
            e,
            t,
            n,
            i = 'keydown'
            ...
            return (
              ...
              (0, o.useEffect)(() => {
                ...
                const o = (e) => {
                  var o
                  e.repeat ||
                    (13 === (0, a.hashFromEvent)(e) &&
                      n(null !== (o = t[r]) && void 0 !== o ? o : null, e))
                }
                return (
        ...
        return o.createElement(
          ...
          (e) =>
            e
              ? o.createElement(_, { ...n, ...E })
              : o.createElement(L, {
                  ...n,
                  ...E,
                  position: (0, l.getPopupPositioner)(t, T),
                  doNotCloseOn: t
                })
        )
        function C() {
      ...
      function M(e, t, n) {
        ...
        return (
          i.render(o.createElement(B, { ...a }), r),
          { close: s, isOpened: () => null !== r }
        )
      }
    },
    65802: (e, t, n) => {
              ...
              n.forEach((e) => {
                ...
                return (
                  ...
                  t && t.toLowerCase() === i.toLowerCase()
                    ? ((u = 3),
                      void (l =
                        null === (n = t.match(h)) || void 0 === n
                          ? void 0
                          : n.index))
                    : (0, o.isString)(t) && h.test(t)
                    ? ((u = 2),
                      void (l =
                        null === (s = t.match(h)) || void 0 === s
                          ? void 0
                          : s.index))
                    : (0, o.isString)(r) && h.test(r)
                    ? ((u = 1),
                      void (l =
                        null === (a = r.match(h)) || void 0 === a
                          ? void 0
                          : a.index))
                    : void (
                        (0, o.isString)(r) &&
