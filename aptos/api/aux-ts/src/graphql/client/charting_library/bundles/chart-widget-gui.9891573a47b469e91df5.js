  ...
  [5093],
  {
    82725: (e) => {
      e.exports = {
        'animation-minimize-corner-left-top':
          'animation-minimize-corner-left-top-1yUqeyiZ',
        'animation-minimize-corner-right-top':
          'animation-minimize-corner-right-top-1yUqeyiZ',
        'animation-minimize-corner-right-bottom':
          'animation-minimize-corner-right-bottom-1yUqeyiZ',
        'animation-minimize-corner-left-bottom':
          'animation-minimize-corner-left-bottom-1yUqeyiZ',
        'animation-maximize-corner-left-top':
          'animation-maximize-corner-left-top-1yUqeyiZ',
        'animation-maximize-corner-right-top':
          'animation-maximize-corner-right-top-1yUqeyiZ',
        'animation-maximize-corner-right-bottom':
          'animation-maximize-corner-right-bottom-1yUqeyiZ',
        'animation-maximize-corner-left-bottom':
          'animation-maximize-corner-left-bottom-1yUqeyiZ'
      }
    },
    48913: (e) => {
      e.exports = {
        wrapper: 'wrapper-1Srpa2Xw',
        timezone: 'timezone-1Srpa2Xw',
        sessionDayWrapper: 'sessionDayWrapper-1Srpa2Xw',
        nowWrapper: 'nowWrapper-1Srpa2Xw',
        now: 'now-1Srpa2Xw',
        sessionDay: 'sessionDay-1Srpa2Xw',
        weekDay: 'weekDay-1Srpa2Xw',
        sessionDaySegments: 'sessionDaySegments-1Srpa2Xw',
        timeMarkWrapper: 'timeMarkWrapper-1Srpa2Xw',
        timeMarkSegment: 'timeMarkSegment-1Srpa2Xw',
        timeMark: 'timeMark-1Srpa2Xw',
        timeMarkSegmentAlignByEnds: 'timeMarkSegmentAlignByEnds-1Srpa2Xw',
        segment: 'segment-1Srpa2Xw',
        small: 'small-1Srpa2Xw',
        start: 'start-1Srpa2Xw',
        end: 'end-1Srpa2Xw',
        active: 'active-1Srpa2Xw',
        green: 'green-1Srpa2Xw',
        orange: 'orange-1Srpa2Xw',
        blue: 'blue-1Srpa2Xw',
        gray: 'gray-1Srpa2Xw',
        tooltip: 'tooltip-1Srpa2Xw',
        time: 'time-1Srpa2Xw'
      }
    },
    92271: (e) => {
      e.exports = {
        ...
        legend: 'legend-1WIwNaDF',
        item: 'item-1WIwNaDF',
        withAction: 'withAction-1WIwNaDF',
        selected: 'selected-1WIwNaDF',
        last: 'last-1WIwNaDF',
        text: 'text-1WIwNaDF',
        noWrapWrapper: 'noWrapWrapper-1WIwNaDF',
        noWrap: 'noWrap-1WIwNaDF',
        series: 'series-1WIwNaDF',
        valuesAdditionalWrapper: 'valuesAdditionalWrapper-1WIwNaDF',
        valueItem: 'valueItem-1WIwNaDF',
        valueTitle: 'valueTitle-1WIwNaDF',
        valueValue: 'valueValue-1WIwNaDF',
        valuesWrapper: 'valuesWrapper-1WIwNaDF',
        directionColumn: 'directionColumn-1WIwNaDF',
        titleWrapper: 'titleWrapper-1WIwNaDF',
        button: 'button-1WIwNaDF',
        statusesWrapper: 'statusesWrapper-1WIwNaDF',
        buttonsWrapper: 'buttonsWrapper-1WIwNaDF',
        buttons: 'buttons-1WIwNaDF',
        noActions: 'noActions-1WIwNaDF',
        title: 'title-1WIwNaDF',
        intervalTitle: 'intervalTitle-1WIwNaDF',
        disabled: 'disabled-1WIwNaDF',
        disabledOnInterval: 'disabledOnInterval-1WIwNaDF',
        withCustomTextColor: 'withCustomTextColor-1WIwNaDF',
        study: 'study-1WIwNaDF',
        mainTitle: 'mainTitle-1WIwNaDF',
        descTitle: 'descTitle-1WIwNaDF',
        hideValues: 'hideValues-1WIwNaDF',
        has5Buttons: 'has5Buttons-1WIwNaDF',
        stayInHoveredMode: 'stayInHoveredMode-1WIwNaDF',
        withTail: 'withTail-1WIwNaDF',
        loading: 'loading-1WIwNaDF',
        loader: 'loader-1WIwNaDF',
        withDot: 'withDot-1WIwNaDF',
        providerTitle: 'providerTitle-1WIwNaDF',
        exchangeTitle: 'exchangeTitle-1WIwNaDF',
        styleTitle: 'styleTitle-1WIwNaDF',
        brandTitle: 'brandTitle-1WIwNaDF',
        minHideIntervalTitle: 'minHideIntervalTitle-1WIwNaDF',
        microHideIntervalTitle: 'microHideIntervalTitle-1WIwNaDF',
        hideExchangeProviderTitles: 'hideExchangeProviderTitles-1WIwNaDF',
        hideBrandingTitle: 'hideBrandingTitle-1WIwNaDF',
        flagged: 'flagged-1WIwNaDF',
        medium: 'medium-1WIwNaDF',
        minimized: 'minimized-1WIwNaDF',
        micro: 'micro-1WIwNaDF',
        onlyOneButtonCanBeStick: 'onlyOneButtonCanBeStick-1WIwNaDF',
        touchMode: 'touchMode-1WIwNaDF',
        buttonIcon: 'buttonIcon-1WIwNaDF',
        flag: 'flag-1WIwNaDF',
        invisibleHover: 'invisibleHover-1WIwNaDF',
        eye: 'eye-1WIwNaDF',
        eyeLoading: 'eyeLoading-1WIwNaDF',
        'eye-animation': 'eye-animation-1WIwNaDF',
        intervalEye: 'intervalEye-1WIwNaDF',
        markerContainer: 'markerContainer-1WIwNaDF',
        flagWrapper: 'flagWrapper-1WIwNaDF',
        sourcesWrapper: 'sourcesWrapper-1WIwNaDF',
        legendMainSourceWrapper: 'legendMainSourceWrapper-1WIwNaDF',
        sources: 'sources-1WIwNaDF',
        toggler: 'toggler-1WIwNaDF pane-button-xPfK7aM7',
        onlyOneSourceShown: 'onlyOneSourceShown-1WIwNaDF',
        counter: 'counter-1WIwNaDF',
        iconArrow: 'iconArrow-1WIwNaDF',
        objectTree: 'objectTree-1WIwNaDF',
        closed: 'closed-1WIwNaDF',
        objectsTreeCanBeShown: 'objectsTreeCanBeShown-1WIwNaDF'
      }
    },
    92176: (e) => {
      e.exports = {
    ...
    37504: (e) => {
      e.exports = {
        ...
        paneControls: 'paneControls-2RChU0rC',
        hasTopMargin: 'hasTopMargin-2RChU0rC',
        hidden: 'hidden-2RChU0rC',
        forceHidden: 'forceHidden-2RChU0rC',
        button: 'button-2RChU0rC pane-button-xPfK7aM7',
        buttonIcon: 'buttonIcon-2RChU0rC',
        minimize: 'minimize-2RChU0rC',
        newButton: 'newButton-2RChU0rC',
        touchMode: 'touchMode-2RChU0rC',
        maximize: 'maximize-2RChU0rC',
        'maximize-animation-up-bracket':
          'maximize-animation-up-bracket-2RChU0rC',
        'maximize-animation-down-bracket':
          'maximize-animation-down-bracket-2RChU0rC',
        'minimize-animation-up-bracket':
          'minimize-animation-up-bracket-2RChU0rC',
        'minimize-animation-down-bracket':
          'minimize-animation-down-bracket-2RChU0rC',
        up: 'up-2RChU0rC',
        'up-animation': 'up-animation-2RChU0rC',
        down: 'down-2RChU0rC',
        'down-animation': 'down-animation-2RChU0rC',
        buttonsWrapper: 'buttonsWrapper-2RChU0rC'
      }
    },
    71996: (e) => {
      e.exports = {
    ...
    34104: (e) => {
      e.exports = {
        ...
        statuses: 'statuses-1NfuygY0',
        statusItem: 'statusItem-1NfuygY0',
        small: 'small-1NfuygY0',
        large: 'large-1NfuygY0',
        blinking: 'blinking-1NfuygY0',
        oneWidgetsVisible: 'oneWidgetsVisible-1NfuygY0',
        twoWidgetsVisible: 'twoWidgetsVisible-1NfuygY0',
        threeWidgetsVisible: 'threeWidgetsVisible-1NfuygY0',
        'blinking-animation': 'blinking-animation-1NfuygY0',
        marketStatusOpen: 'marketStatusOpen-1NfuygY0',
        marketStatusClose: 'marketStatusClose-1NfuygY0',
        marketStatusPre: 'marketStatusPre-1NfuygY0',
        marketStatusPost: 'marketStatusPost-1NfuygY0',
        marketStatusHoliday: 'marketStatusHoliday-1NfuygY0',
        invalidSymbol: 'invalidSymbol-1NfuygY0',
        replayMode: 'replayMode-1NfuygY0',
        notAccurate: 'notAccurate-1NfuygY0',
        delay: 'delay-1NfuygY0',
        eod: 'eod-1NfuygY0',
        dataProblemHigh: 'dataProblemHigh-1NfuygY0',
        dataProblemLow: 'dataProblemLow-1NfuygY0'
      }
    },
    30194: (e, t, s) => {
      'use strict'
      s.r(t), s.d(t, { ControlBarNavigation: () => $ })
      var i = s(16282),
        l = s(79881),
        a = s(96404),
        o = s(27490),
      ...
      const E = (0, c.humanReadableModifiers)(c.Modifiers.Alt, !1),
        ...
        W = (0, h.hotKeySerialize)({ keys: [E, 'R'], text: '{0} + {1}' }),
        T = (0, h.hotKeySerialize)({
          keys: [E, 'Click', E, 'Enter'],
          text: '{0} + {1}, {2} + {3}'
        }),
        x = (0, h.hotKeySerialize)({ keys: [w], text: '{0}' }),
        D = (0, h.hotKeySerialize)({ keys: [y], text: '{0}' }),
        L = (0, h.hotKeySerialize)({ keys: [V, S], text: '{0} + {1}' }),
        A = (0, h.hotKeySerialize)({ keys: [V, M], text: '{0} + {1}' }),
        H = (0, h.hotKeySerialize)({
          keys: [E, k, y],
          text: '{0} + {1} + {2}'
        }),
        B = (0, l.t)('Zoom Out'),
        N = (0, l.t)('Zoom In'),
        P = (0, l.t)('Maximize chart'),
        I = (0, l.t)('Restore chart'),
        z = (0, l.t)('Scroll to the Left'),
        O = (0, l.t)('Scroll to the Right'),
        F = (0, l.t)('Reset Chart'),
        R = (0, l.t)('Scroll to the Most Recent Bar'),
        ...
        j = `<div class="control-bar control-bar__btn control-bar__btn--back-present control-bar__btn--btn-hidden apply-common-tooltip" title="${R}" data-tooltip-hotkey="${H}">\n\t${v}\n</div>`,
        Y = u.CheckMobile.any(),
        G = {
          zoomInOut: !0,
          maximize: !0,
      ...
      class $ {
        constructor(e, t, s) {
          ;(this._widget = (0, i.ensureNotNull)(
            ...
            (this._chart = e),
            (this._parent = t),
            (this._options = Object.assign({}, G, s)),
        ...
        _initHandlers() {
          const e = a.mobiletouch ? 'touchstart' : 'mousedown',
            t = a.mobiletouch ? ['touchend'] : ['mouseup', 'mouseout']
        ...
        _initGroupDescriptions() {
          return [
            ...
            {
              shouldBeHiddenOnMobile: !o.enabled(
    ...
    56786: (e, t, s) => {
      ...
      class M {
        constructor(e, t, s) {
          ...
          ;(this._withActions = s.withActions),
            ...
            this._withActions &&
              ((this._showActionsHandler = (0, p.wrapHandlerWithPreventEvent)(
                this._showActions.bind(this)
              )),
              (this._hideActionsHandler = (0, p.wrapHandlerWithPreventEvent)(
                this._hideActions.bind(this)
              )),
              (this._selectedSourceHandler = (0, p.wrapHandlerWithPreventEvent)(
        ...
        _renderActions() {
          ...
          for (const s of this._model.actions()) {
            const i = (0, c.createActionElement)(
              s,
              y.button,
              y.buttonIcon,
              m.blockHidden,
        ...
        _updateTitlesHandler(e, t) {
          const s = (0, i.ensureNotNull)(this._titleElements[e]),
            l = 0 === t.length
          s.classList.toggle(m.blockHidden, l),
            s.classList.toggle(y.withDot, !l),
            w(s, t)
        }
        _updateStates(e) {
        ...
        _removeValuesSpawnsSubscriptions() {
          for (const e of this._valuesSpawnArray)
            e.value.destroy(), e.color.destroy(), e.visible.destroy()
        ...
        _addStatusesWidget(e, t, s) {
          ;(this._statusesWrapper = document.createElement('div')),
            ...
            (this._resizeObserver = new u.default(
        ...
        _updateStatusWidgetVisibility(e) {
          null !== this._statusesWrapper &&
            this._statusesWrapper.classList.toggle(m.blockHidden, e)
        }
      }
      class f extends M {
        constructor(e, t, s) {
        ...
        _renderValues() {
          ...
          for (const s of t) {
            ...
            t.classList.add(y.valueItem),
              t.classList.toggle(m.blockHidden, !s.visible.value())
            const i = document.createElement('div'),
              l = s.title.value() || ''
            i.classList.add(y.valueTitle),
              i.classList.toggle(m.blockHidden, 0 === l.length),
              i.appendChild(document.createTextNode(l)),
              t.appendChild(i)
            const a = document.createElement('div')
            a.classList.add(y.valueValue),
        ...
        _createTitlesSpawns() {
          ...
          this._titlesSpawns = [
            ...
            { title: e.branding.spawn(), class: y.brandTitle }
          ]
        }
        _createValuesSpawns() {
        ...
        _updateValuesTitleHTMLElHandler(e, t = '') {
          ...
          w(s, t),
            s.classList.toggle(m.blockHidden, 0 === t.length),
            this._updateShowValues()
        }
        _isWidthButtonsMode() {
          return (
      ...
      var T = s(42277),
        ...
        D = s(93741),
        L = s(24335)
      const A = (0, k.t)('Hide Indicator Legend'),
        H = (0, k.t)('Show Indicator Legend'),
        B = (0, k.t)('Show Object Tree')
      class N {
        constructor(e, t, s) {
          ;(this._el = null),
            ...
            (this._toggleStateHandler = (0, p.wrapHandlerWithPreventEvent)(
              s.onCollapseDataSources
            )),
            (this._showObjectTreeHandler = (0, p.wrapHandlerWithPreventEvent)(
        ...
        _render() {
          ;(this._el = document.createElement('div')),
            ...
            (this._arrowIconEL.innerHTML = h.trackingModeIsAvailable ? x : T),
            ...
            (this._objectTreeEl.innerHTML = h.trackingModeIsAvailable ? L : D),
      ...
      class R {
        ...
        addDataSources(e, t) {
          ...
          for (let i = 0; i < e.length; i++) {
            ...
            this._dataSourceRenderers.push(a),
              this._updateLegendVisibility(),
              l.onDestroy().subscribe(
                this,
                () => {
                  const e = this._dataSourceRenderers.indexOf(a)
                  ;-1 !== e &&
        ...
        updateMode(e) {
          const t = F && e < 133 ? 1 : e < 205 ? 2 : e < 222 ? 3 : 4
          null !== this._mainDataSourceRenderer &&
          ...
          const s = h.trackingModeIsAvailable || e < 542
        ...
        _showCollapsedDataSourcesTooltip() {
          ;(0, P.showOnElement)(this._collapsedDataSourcesEl, {
      ...
      var U = s(79039),
        ...
        q = s(45053)
      function K(e) {
        return void 0 !== e ? Y.resetTransparency(e) : e
      }
      const J = new G.TranslatedString(
          'show {title}',
          (0, k.t)('show {title}')
        ),
        Q = new G.TranslatedString('hide {title}', (0, k.t)('hide {title}')),
        ee = (0, k.t)('Show'),
        te = (0, k.t)('Hide')
      class se {
        constructor(e, t, s, i, l) {
          ;(this._values = new (a())([])),
            (this._actions = []),
            (this._onDestroy = new (X())()),
            (this._loading = new (a())(!1)),
            ...
            (this._disabled = new (a())(this._getDisabledState())),
            (this._disabledOnInterval = new (a())(
              this._getDisabledOnIntervalState()
            )),
            (this._selected = new (a())(!1)),
            (this._isTitleHidden = new (a())(this._getTitleHiddenValue())),
            (this._isValuesHidden = new (a())(this._getValuesHiddenValue())),
            (this._isRowHidden = new (a())(this._getRowHiddenValue())),
            (0, q.combine)(
              () => ({}),
              this._isTitleHidden,
        ...
        _calcNewPosition(e) {
          ...
          if (e.hasOwnProperty('touches') && e.touches.length > 0)
            ...
            t = {
              clientX: (0, Z.isRtl)() ? s.right : s.left,
      ...
      class _e extends se {
        constructor(e, t, s, i, l) {
          ...
          o.showSeriesTitle.subscribe(this, () => {
            ...
            (this._valuesVisibleProperty = (0, j.combineProperty)(
              (e, t, s) => e || t || s,
              o.showSeriesOHLC,
              o.showBarChange,
              o.showVolume
        ...
        _updateTitles() {
          ...
          this._titles.title.setValue((0, U.clean)(t.title, !0)),
            this._titles.description.setValue((0, U.clean)(t.description, !0)),
            ce || this._titles.interval.setValue((0, U.clean)(t.interval, !0)),
            this._titles.provider.setValue((0, U.clean)(t.provider, !0)),
            this._titles.exchange.setValue((0, U.clean)(t.exchange, !0)),
            this._titles.chartStyle.setValue((0, U.clean)(t.chartStyle, !0)),
          ...
          if (0 === t.length) {
            ...
            for (let e = 0; e < l.length; e++) {
              ...
              t[e + 1].value.setValue(s.value()),
                t[e + 1].color.setValue(K(s.color())),
        ...
        _createActions() {
          if (ue) {
            const e = {
              ...
              action: (0, p.wrapHandlerWithPreventEvent)(
                this.onToggleDisabled.bind(this)
              ),
              visible: new (a())(!0),
              className: y.eye,
              title: new (a())(this._getEyeTitle()),
        ...
        _symbolActionHandler() {
          null !== this._symbolMarker &&
            (this._updateSymbolMarker(), W('Change flag state'))
        }
        _updateSymbolMarker() {
      ...
      const Ce = (0, k.t)('Settings'),
        ...
        xe = d.enabled('property_pages'),
        De = d.enabled('format_button_in_legend'),
        Le = d.enabled('delete_button_in_legend')
      class Ae extends se {
        constructor(e, t, s, i, l) {
          super(e, t, s, i, l),
            (this._titles = { title: new (a())(''), args: new (a())('') }),
            (this._error = new (a())(!1)),
            (this._isPineScriptDataSource = new (a())(!1)),
            (this._pineAction = null),
            (this._globalVisibility = new (a())(!0)),
            this._createActions()
          const o = this._model
              .model()
              .properties()
        ...
        _updateTitles() {
          ...
          this._titles.title.setValue((0, U.clean)(e[0], !0))
          const t = Array.isArray(e[1]) ? e[1].join(' ') : e[1] || ''
          this._titles.args.setValue((0, U.clean)(t, !0))
        }
        _updateValues() {
          const e = this._source.legendView()
          if (null === e) return
          ...
          if (!this._options.readOnlyMode) {
            if (
              ...
              const e = {
                ...
                visible: new (a())(!this._getDisabledOnIntervalState()),
                className: y.eye,
                title: new (a())(this._getEyeTitle()),
                dataset: { name: 'legend-show-hide-action' }
              }
      ...
      var it = s(49382),
        ...
        dt = s(12125)
      function ht(e) {
        return e === nt.WeekDays.SUNDAY ? nt.WeekDays.SATURDAY : e - 1
      }
      function ut(e) {
        return e === nt.WeekDays.SATURDAY ? nt.WeekDays.SUNDAY : e + 1
      }
      function ct(e, t) {
        const s = ht(t)
      ...
      function pt(e) {
        for (; e > rt.minutesPerDay; ) e -= rt.minutesPerDay
        const t = e % 60,
          s = (e - t) / 60
        return (
      ...
      const mt = {
        [nt.WeekDays.MONDAY]: {
          title: ot.weekDaysShortNames[nt.WeekDays.MONDAY],
          isActive: !1,
          entries: []
        },
        [nt.WeekDays.TUESDAY]: {
          title: ot.weekDaysShortNames[nt.WeekDays.TUESDAY],
          isActive: !1,
          entries: []
        },
        [nt.WeekDays.WEDNESDAY]: {
          title: ot.weekDaysShortNames[nt.WeekDays.WEDNESDAY],
          isActive: !1,
          entries: []
        },
        [nt.WeekDays.THURSDAY]: {
          title: ot.weekDaysShortNames[nt.WeekDays.THURSDAY],
          isActive: !1,
          entries: []
        },
        [nt.WeekDays.FRIDAY]: {
          title: ot.weekDaysShortNames[nt.WeekDays.FRIDAY],
          isActive: !1,
          entries: []
        },
        [nt.WeekDays.SATURDAY]: {
          title: ot.weekDaysShortNames[nt.WeekDays.SATURDAY],
          isActive: !1,
          entries: []
        },
        [nt.WeekDays.SUNDAY]: {
          title: ot.weekDaysShortNames[nt.WeekDays.SUNDAY],
          isActive: !1,
          entries: []
        }
      }
      ...
      function vt(e) {
        const t = e.start(),
          ...
          a = pt(t),
          o = pt(t + s)
        return s > rt.minutesPerDay
          ? `${ot.weekDaysShortNames[i]} ${a} — ${ot.weekDaysShortNames[l]} ${o}`
          : `${a} — ${o}`
      }
      function wt(e, t, s, i) {
        return Math.abs(i - s) > 1
          ? `${ot.weekDaysShortNames[s]} ${e.title} — ${ot.weekDaysShortNames[i]} ${t.title}`
          : `${e.title} — ${t.title}`
      }
      function yt(e, t, s) {
        for (const i of t) {
          ...
          const l = i.start(),
            ...
            o = l + a,
            n = []
          if (o <= rt.minutesPerDay) n.push([l, o])
          else {
            const e = Math.min(rt.minutesPerDay - l, a)
            n.push([l, l + e]), n.push([0, a - e])
          }
          for (let l = 0; l < n.length; l++) {
            const a = n[l],
              [o, r] = a,
              d = o / rt.minutesPerDay,
              h = (0, it.lowerbound)(
                e[t].entries,
                d,
                (e, t) => e.start.value < t
              ...
              u = {
                start: {
                  value: d,
                  title: pt(o),
                  isFirstOrLastPoint: o === i.start()
                },
                end: {
                  value: r / rt.minutesPerDay,
                  title: pt(r),
            ...
            e[t].entries.splice(h, 0, u), (t = ut(t))
          }
        }
      }
      class St {
        constructor(e) {
          ;(this.sessionsDays = new (a())((0, o.clone)(mt))),
            (this.todaySession = new (a())((0, o.clone)({ entries: [] }))),
        ...
        currentTimeValue() {
          return null === this._todayInExchangeTime
            ? -1
            : rt.get_minutes_from_midnight(this._todayInExchangeTime) /
                rt.minutesPerDay
        }
        timezone() {
          const e = this._symbolInfo.value()
          return null === e ? '' : (0, lt.timezoneTitle)(e.timezone)
        }
            ...
            for (const a of Object.keys(e)) {
              ...
              for (let e = 0; e < p; e++) {
                ...
                const r = a
                  ...
                  d = {
                    start: {
                      value: a ? 0 : n[e - 1].end.value,
                      title: a ? t : n[e - 1].end.title,
                      isFirstOrLastPoint:
                        !(a && h.length > 0) || 1 === h[h.length - 1].end.value
                    },
                    end: {
                      value: s.start.value,
                      title: s.start.title,
                    ...
                    type: 3,
                    tooltip: wt(r.end, s.start, c.dayIndex, o),
                    showStartForLastEntry: !1,
                    showEndForFirstEntry: !1
                  }
              ...
              1 !== g.end.value &&
                n.push({
                  start: {
                    ...
                    value: 1,
                    title: pt(rt.minutesPerDay),
                    isFirstOrLastPoint:
                      !(u.length > 0) || 0 === u[0].start.value
                  },
                  type: 3,
                  tooltip: wt(g.end, _.entries[0].start, o, _.dayIndex),
                  showStartForLastEntry: !1,
                  showEndForFirstEntry: !1
                })
            }
              ...
              for (const i of Object.keys(e)) {
                ...
                r.start.isFirstOrLastPoint ||
                  (r.showStartForLastEntry =
                    ((t = a),
                    (s = e[o].entries),
                    gt(t[t.length - 1], s[s.length - 1]))),
                  d.end.isFirstOrLastPoint ||
                    (d.showEndForFirstEntry = bt(a, e[n].entries))
              }
              var t, s
            })(n),
        ...
        _updateTodayWithOffsets(e) {
          ...
          this._todayInExchangeTime = rt.get_cal_from_unix_timestamp_ms(
            rt.get_timezone(e.timezone),
            Date.now() + t
          )
        }
      }
      ...
      function Wt(e) {
        return (
          Vt.has(e) || Vt.set(e, (0, Et.randomHash)()),
          (0, i.ensureDefined)(Vt.get(e))
        )
      }
      const Tt = new Map([
          [0, kt.green],
      ...
      function Lt(e) {
        const { segment: t, forceStart: s, forceEnd: i } = e,
          ...
          o = {
            ...
            width: `calc(${100 * l}% + ${a ? 2 : 0}px)`
          },
          n = ft(
            kt.segment,
            Tt.get(t.type),
            (s || t.start.isFirstOrLastPoint) && kt.start,
            (i || t.end.isFirstOrLastPoint) && kt.end,
            a && kt.small,
            'common-tooltip-html',
            'apply-common-tooltip'
          ),
          r = (function (e, t) {
            return `<div class="${kt.tooltip}">\n\t\t<span class="${Tt.get(
              t
            )}">${xt.get(t)}</span>\n\t\t<span class="${
              kt.time
            }">${e}</span>\n\t</div>`
      ...
      function At(e) {
        const { sessionDay: t } = e,
          ...
          i = ft(kt.sessionDay, t.isActive && kt.active)
        return Mt.createElement(
          'div',
          { className: i },
          Mt.createElement('div', { className: kt.weekDay }, t.title),
          Mt.createElement('div', { className: kt.sessionDaySegments }, s)
        )
      }
      function Ht(e) {
        const { sessionDays: t, currentTimeMark: s } = e,
          ...
          a = t[l],
          o = a.entries.filter((e) => e.start.value <= s && e.end.value >= s)[0]
        !o.start.isFirstOrLastPoint && o.showStartForLastEntry
          ? i.push(a.entries[a.entries.length - 1].start)
          : i.push(o.start)
        const n =
          !o.end.isFirstOrLastPoint && o.showEndForFirstEntry
            ? a.entries[0].end
            : o.end
        ...
        const r = i.map((e) =>
            Mt.createElement(
              'div',
              { key: Wt(e), className: kt.timeMark },
              e.title
            )
          ),
          d = 100 * (2 === i.length ? i[1].value - i[0].value : 0),
          h = ft(d > 12 && kt.timeMarkSegmentAlignByEnds, kt.timeMarkSegment)
        return Mt.createElement(
          'div',
          { className: kt.sessionDay },
          Mt.createElement('div', { className: kt.weekDay }),
          Mt.createElement(
            'div',
            { className: kt.timeMarkWrapper },
            Mt.createElement(
              'div',
              {
                className: h,
      ...
      class Bt {
        constructor(e) {
          this._fullSessionScheduleViewModel = new St(e)
        }
        destroy() {
        ...
        renderer(e, t) {
          return (function (e) {
            const { key: t, className: s, now: i, timezone: l } = e,
              a = (0, Ct.useWatchedValueReadonly)({
                watchedValue: e.sessionDays
              }),
              o = Object.values(a).filter((e) => e.isActive)[0],
              n = ft(s, kt.wrapper)
            return Mt.createElement(
              'div',
              { key: t, className: n },
              Mt.createElement(
                'div',
                { className: kt.sessionDayWrapper },
                Mt.createElement(At, { sessionDay: o }),
                Mt.createElement(
                  'div',
                  { className: kt.nowWrapper },
              ...
              Mt.createElement(Ht, { sessionDays: a, currentTimeMark: i }),
              Mt.createElement('div', { className: kt.timezone }, `${Dt}: ${l}`)
            )
          })({
            key: e,
            className: t,
      ...
      class zt {
        constructor(e) {
          ;(this.isBlinkingMode = new (a())(!1)),
            (this._status = new (a())(null)),
            (this._fullTooltip = new (a())(null)),
            (this._iconClassNames = new (a())(null)),
            (this._visible = new (a())(!1)),
            (this._tooltip = new (a())(null)),
            (this._icon = new (a())(null)),
            (this._className = new (a())(null)),
            (this._infoMaps = e),
        ...
        _updateIconClassName(e) {
          null !== e
            ? this._iconClassNames.setValue([It.statusItem, e])
      ...
      const Ft = []
      function Rt() {
        return Ot.getJSON('tv.alreadyBlinkedStatuses', Ft)
      }
      const Ut = new (a())(Rt())
      function jt(e) {
        const t = Ot.getJSON('tv.alreadyBlinkedStatuses', Ft)
        t.includes(e) ||
          (t.push(e),
          Ot.setJSON('tv.alreadyBlinkedStatuses', t),
          Ut.setValue(Rt()))
      }
      Ot.onSync.subscribe(null, () => Ut.setValue(Rt()))
      const Yt = Ut
      var Gt = s(97849),
        $t = s(38531),
        Xt = s(11483),
        ...
        Kt = s(70034),
        Jt = s(5749)
      const Qt = (0, be.getLogger)('Chart.LegendWidget'),
        es = [
          'TFEXDelayForGuest',
          'MOEXDelayForGuest',
          'CHIXAuDelayForGuest',
        ...
        ss = new Map([
          ...
          ['CHIXAuDelayForGuest', It.delay],
          ['LSEDelayForGuest', It.delay],
          ['NGMDelayForGuest', It.delay],
          ['ICESGDelayForGuest', It.delay],
          ['DEForGuest', It.delay],
          ['EOD', It.eod],
          ['TickByTick', It.notAccurate],
          ['BATSToRealtime', It.notAccurate],
          ['DelayWithoutMarketAgreement', It.delay]
        ]),
        is = new Map([
          ['DelayToRealtime', Nt.colorsPalette['color-delay-mode']],
          ['DelayNoRealtime', Nt.colorsPalette['color-delay-mode']],
          ['TFEXDelayForGuest', Nt.colorsPalette['color-delay-mode']],
          ['MOEXDelayForGuest', Nt.colorsPalette['color-delay-mode']],
          ['CHIXAuDelayForGuest', Nt.colorsPalette['color-delay-mode']],
          ['LSEDelayForGuest', Nt.colorsPalette['color-delay-mode']],
          ['NGMDelayForGuest', Nt.colorsPalette['color-delay-mode']],
          ['ICESGDelayForGuest', Nt.colorsPalette['color-delay-mode']],
          ['DEForGuest', Nt.colorsPalette['color-delay-mode']],
          ['EOD', Nt.colorsPalette['color-eod-mode']],
          ['TickByTick', Nt.colorsPalette['color-notaccurate-mode']],
          ['BATSToRealtime', Nt.colorsPalette['color-notaccurate-mode']],
          ['DelayWithoutMarketAgreement', Nt.colorsPalette['color-delay-mode']]
        ]),
        ls = (0, k.t)('Data is delayed'),
        as = (0, k.t)('End of day data'),
        os = (0, k.t)('One update per second'),
        ns = (0, k.t)('Cboe BZX'),
        rs = (0, k.t)('{exchange} by {originalExchange}'),
        ds = (0, Pt.htmlEscape)(
        ...
        _s = (0, Pt.htmlEscape)((0, k.t)('Data is updated once a day.')),
        ps = (0, Pt.htmlEscape)(
          (0, k.t)(
      ...
      ;(0, k.t)('Create a free account'),
        (0, k.t)('Learn more'),
        (0, Pt.htmlEscape)((0, k.t)('Fill out Exchange Agreements'))
      class Ss extends zt {
        constructor(e, t, s) {
          super({ iconMap: ts, classNameMap: ss, titleColorMap: is, size: t }),
            (this._dataUpdatedMode = new (a())(null).spawn()),
            (this._options = s),
            (this._model = e),
            (this._dataModeBlinkingStatuses = Yt.spawn()),
        ...
        setModel(e) {
          if ((this._dataUpdatedMode.destroy(), null === e))
            return (
              (this._model = e),
              void (this._dataUpdatedMode = new (a())(null).spawn())
            )
        ...
        async _updateFullTooltipByStatus() {
          ...
          for (const a of e)
            l.push({
              icon: this._getIcon(a),
              iconClassName: this._iconClassNames.value(),
              title: t && t[a],
              titleColor: this._getTitleColor(a),
              html: s && s[a],
              size: this._size,
              action: i && i[a]
            })
            ...
            if (
              ...
              [
                ...
                this._options.subscriptionFullInfo &&
                  null !== i &&
                  'DelayToRealtime' === a &&
                  t[a].push(us.format({ description: `<b>${i}</b>` })),
                null !== i &&
                  'DelayNoRealtime' === a &&
                  t[a].push(cs.format({ description: `<b>${i}</b>` })),
                'DelayWithoutMarketAgreement' === a &&
                  t[a].push(
                ...
                this._options.subscriptionFullInfo &&
                  es.includes(a) &&
                  t[a].push(
                    hs.format({ listedExchange: this._model.listedExchange() })
                  )),
              'EOD' === a && (t[a] = [_s]),
              'TickByTick' === a &&
                (t[a].push(this._options.subscriptionFullInfo ? ps : ms),
                this._options.subscriptionFullInfo && t[a].push(gs)),
              null !== l && 'BATSToRealtime' === a)
            ) {
              let e = this._model.listedExchange()
              0,
                t[a].push(
                  bs.format({ symbolName: s, exchange: l }),
                  '' !== e ? ws.format({ exchange: e }) : vs
                )
            }
          ...
          for (const i of t)
            if (
              ...
              0,
                (s[i] =
                  '' !== t
                    ? rs.format({ exchange: t, originalExchange: ns })
                    : ns)
            }
        ...
        _turnOffBlinking() {
          const e = this._dataUpdatedMode.value()
          if (null !== e) for (const t of e) jt(t)
        }
      }
      var Ms = s(24453),
        fs = s(30336)
      const Cs = (0, k.t)('Study Error'),
        Es = new Map([
          [
            !0,
            new Map([
        ...
        Ts = new Map([
          [!0, Nt.colorsPalette['color-data-problem']],
          [!1, null]
        ])
      class xs extends zt {
        constructor(e, t, s) {
          super({
            ...
            (this._dataSourceErrorStatus = new (a())(null).spawn()),
        ...
        async _getHtml(e) {
          const t = this._dataSourceErrorStatus.value()
          return null !== t ? [(0, Pt.htmlEscape)(t.error)] : null
        }
        _getAction(e) {
      ...
      const Ds = (0, k.t)('Data error'),
        ...
        Bs = new Map([
          ['high', Nt.colorsPalette['color-data-problem']],
          ['low', Nt.colorsPalette['color-data-problem']]
        ])
      class Ns extends zt {
        constructor(e, t) {
          super({
            ...
            (this._dataProblem = new (a())(null).spawn()),
            (this._isDataProblemCritical = new (a())(!1)),
            this.setModel(e)
        }
        destroy() {
        ...
        async _getHtml(e) {
          ...
          return null === t ? null : [(0, Pt.htmlEscape)(t.text)]
        }
        _updateStatus(e) {
          var t
          const s =
      ...
      class Ps extends zt {
        constructor(e, t) {
          super(t),
            (this._booleanStatus = new (a())(!1).spawn()),
            this.updateStatus(e)
        }
        destroy() {
      ...
      var Is = s(13008),
        zs = s(22226)
      const Os = (0, k.t)('Invalid Symbol'),
        Fs = (0, k.t)("This symbol doesn't exist, please pick another one."),
        Rs = new Map([
          [
            !0,
            new Map([
        ...
        Gs = new Map([
          [!0, Nt.colorsPalette['color-invalid-symbol']],
          [!1, null]
        ]),
        $s = new Map([
          [!0, [Fs]],
      ...
      class Zs {
        ...
        _updateBlinkingMode(e) {
          this._el.classList.toggle(It.blinking, e)
        }
      }
      class qs {
        constructor(e, t, s, i) {
          ...
          const l = [It.statuses, 'apply-common-tooltip', 'common-tooltip-wide']
          h.trackingModeIsAvailable && l.push(It.touchMode),
            this.element.classList.add(...l, It[e]),
        ...
        _updateSpecialClassAndTooltip() {
          ...
          this.element.classList.toggle(It.oneWidgetsVisible, 1 === e),
            this.element.classList.toggle(It.twoWidgetsVisible, 2 === e),
            this.element.classList.toggle(It.threeWidgetsVisible, 3 === e),
            this._updateTooltip()
        }
        _updateBlinkingMode() {
          const e = this._blinkingSpawns.some((e) => e.value())
          this.element.classList.toggle(It.blinking, e)
        }
      }
      var Ks = s(36973),
        Js = s(12633),
      ...
      const ai = (0, k.t)('Market open'),
        oi = (0, k.t)('Pre-market'),
        ni = (0, k.t)('Post-market'),
        ri = (0, k.t)('Market closed'),
        di = (0, k.t)('Holiday'),
        hi = (0, k.t)("All's well — Market is open."),
        ui = (0, k.t)('Morning. Market is open for pre-market trading.'),
        ci = (0, k.t)('Evening. Market is open for post-market trading.'),
        _i = (0, k.t)('Time for a walk — this market is closed.'),
        pi = (0, k.t)('Market is currently on holiday. Lucky them.'),
        mi = (0, k.t)('less than 1 minute'),
        gi = (0, k.t)('{days} and {hours}'),
        bi = (0, k.t)('{hours} and {minutes}'),
        vi = (0, k.t)('Market opens in {remainingTime}.'),
        wi = (0, k.t)('Market closes in {remainingTime}.'),
        yi = (0, k.t)("It'll go to post-market trading in {remainingTime}."),
        Si = (0, k.t)("It'll open for pre-market trading in {remainingTime}."),
        Mi = new Map([
          [
            'market',
            new Map([
        ...
        ki = new Map([
          ['market', Nt.colorsPalette['color-market-open']],
          ['pre_market', Nt.colorsPalette['color-pre-market']],
          ['post_market', Nt.colorsPalette['color-post-market']],
          ['out_of_session', Nt.colorsPalette['color-market-closed']],
          ['holiday', Nt.colorsPalette['color-market-holiday']]
        ]),
        Vi = {
          market: hi,
          pre_market: ui,
      ...
      function xi(e) {
        ...
        return 0 === t && 0 === s && 0 === i
          ...
          : s > 0
          ? bi.format({ hours: Ti(s), minutes: Wi(i) })
          : Wi(i)
        var l
      }
      const Di = {
          market: (e) =>
            ('post_market' === e.status ? yi : wi).format({
              remainingTime: xi(e.remainingSeconds)
            }),
          pre_market: (e) =>
            vi.format({ remainingTime: xi(e.remainingSeconds) }),
          post_market: (e) =>
            wi.format({ remainingTime: xi(e.remainingSeconds) }),
          out_of_session: (e) =>
            ('pre_market' === e.status ? Si : vi).format({
              remainingTime: xi(e.remainingSeconds)
            }),
          holiday: (e) =>
            ('pre_market' === e.status ? Si : vi).format({
      ...
      class Ai extends zt {
        constructor(e, t) {
          super({
            ...
            (this._model = null),
            (this._marketStatus = new (a())(null).spawn()),
            (this._sessionEdge = new (a())(null).spawn()),
            (this._updateTooltip = () => {
        ...
        setModel(e) {
          if (
            ...
            return (
              (this._marketStatus = new (a())(null).spawn()),
              void (this._sessionEdge = new (a())(null).spawn())
            )
          ;(this._model = e),
      ...
      class Hi {
        constructor(e, t) {
          var s, i
          ;(this.visibleWidgetsCount = new (a())(0)),
            (this.errorWidgetIsShown = new (a())(!1)),
            (this._size = h.trackingModeIsAvailable ? 'large' : 'small'),
            (this._tooltips = new (a())([])),
            (this._visibilitySpawns = []),
            (this._tooltipSpawns = []),
            (this._statusWidgetInfos = []),
            (this._renderer = new qs(
              this._size,
            ...
            (this._dataSourceErrorCanBeShown = new (a())(!1)),
            (this._marketStatusCanBeShown = new (a())(!1)),
            (this._dataUpdatedModeCanBeShown = new (a())(!1)),
            (this._dataProblemCanBeShown = new (a())(!1)),
        ...
        _recreateWidgets() {
          ...
          if (this._options.sourceStatusesEnabled) {
            ...
            if (null !== e)
              if (null === this._symbolInvalidViewModel) {
                this._symbolInvalidViewModel = new Ps(e, {
                  tooltipMap: js,
                  iconMap: Rs,
                  classNameMap: Us,
                  titleMap: Ys,
            ...
            if (null === this._dataSourceErrorStatusViewModel) {
              ;(this._dataSourceErrorStatusViewModel = new xs(
                this._source,
                this._size,
                this._options.sourceStatuses
              )),
                (this._dataSourceHasErrorVisible = (0, q.combine)(
                  () =>
          ...
          if (this._options.marketStatusEnabled) {
            ...
            if (null === this._marketStatusViewModel) {
              this._marketStatusViewModel = new Ai(t, this._size)
              const e = (0, q.combine)(
                () =>
              ...
              null !== t &&
                ((this._sessionWidget = new Bt(this._source)),
          ...
          if (this._options.dataUpdateModeEnabled) {
            ...
            if (null === this._dataUpdatedModeViewModel) {
              this._dataUpdatedModeViewModel = new Ss(
                e,
                this._size,
          ...
          if (this._options.dataProblemEnabled) {
            ...
            if (null === this._dataProblemViewModel) {
              ;(this._dataProblemViewModel = new Ns(e, this._size)),
        ...
        _updateErrorWidgetIsShown() {
          ...
          const l =
            ...
            a =
              ...
              void 0 !== i &&
              i
          this.errorWidgetIsShown.setValue(l || a)
        }
      ...
      class Ni {
        constructor(e, t) {
          ;(this._symbol = null),
            (this._symbolInfo = new (a())(null).spawn()),
            (this._source = e),
            e.properties().hasChild('symbol') &&
              (this._symbol = (0, j.createWVFromGetterAndSubscription)(
                () => e.properties().symbol.value(),
                e.properties().symbol.listeners()
              ))
          const s = []
          if ((0, pe.isStudy)(e) || (0, pe.isStudyStub)(e))
            (this._isSymbolInvalid = (0, Bi.createWVFromGetterAndSubscriptions)(
            ...
            ;(this._isSymbolInvalid = (0, j.createWVFromGetterAndSubscription)(
              () => l.isSymbolInvalid(),
              l.onStatusChanged()
            )),
              s.push(l.onStatusChanged()),
              (this._symbolInfo = (0, j.createWVFromGetterAndSubscription)(
                l.symbolInfo.bind(l),
                l.dataEvents().symbolResolved()
              ))
          }
          this._dataSourceErrorStatus = (0,
          Bi.createWVFromGetterAndSubscriptions)(
      ...
      new Map([
        ...
        new Map([
          [!0, Nt.colorsPalette['color-replay-mode']],
          [!1, null]
        ]),
        new Map([
          [!0, [zi]],
      ...
      class Oi extends Hi {
        constructor(e, t, s) {
          super(new Ni(e, t), s),
            (this._isInReplay = new (a())(!1).readonly().spawn()),
      ...
      const Ui = {
        ...
        Gi = 2 * parseInt(y.marginlegendhoriz)
      class $i {
        constructor(e, t, s, i, l, n, r) {
          ;(this._mainSeriesViewModel = null),
            (this._dataSourceViewModels = []),
            (this._visibleDataSourceCount = new (a())(0)),
            (this._themedColor = new (a())('')),
            (this._mainSeriesRowHidden = null),
            (this._dataSourceRowsHidden = []),
            (this._customWidgetsVisibilities = []),
            (this._allLegendHidden = new (a())(!1)),
            (this._studiesLegendHidden = new (a())(!1)),
            (this._customWidgetsHeights = []),
            (this._onLegendVisibilityToggled = null),
            (this._availableHeight = 0),
            (this._collapsedDataSourcesCount = new (a())(0)),
            (this._collapsedDataSourcesTitle = new (a())('')),
            ...
            (this._model = e),
            (this._paneWidget = t),
            (this._options = (0, o.merge)((0, o.clone)(Ui), n)),
            (this._callbacks = r),
          ...
          ;(this._isDataSourcesCollapsed = new (a())(d.value())),
            d.subscribe(this, () => {
              this._isDataSourcesCollapsed.setValue(d.value())
            })
          const h = new (a())(this._getCustomTextColorValue()),
            u = this._model.model().properties().childs()
          u.scalesProperties.childs().textColor.subscribe(this, () => {
            h.setValue(this._getCustomTextColorValue())
          })
          const c = u.paneProperties
              .childs()
          ...
          p.subscribe(this, () => {
            ...
            (this._hideWholeLegend = l.spawn()),
            this._hideWholeLegend.subscribe(
              this._updateLegendVisibilities.bind(this)
            ),
            (this._isPaneMain = new (a())(this._getIsPaneMainValue())),
            (this._updateCollapsedSourcesModeThrottle = (0, Ri.default)(
            ...
            (this._renderer = new R(
              {
                ...
                backgroundTransparency: m.readonly(),
        ...
        onShowLegendWidgetContextMenu(e, t) {
          if (this._options.readOnlyMode || !Yi) return Promise.resolve()
          W('Show legend context menu')
          const s = new Map()
          for (const e of Array.from(this._customLegendWidgetsMap.keys())) {
            ...
            for (const e of Array.from(t.keys())) {
              const s = (0, i.ensureDefined)(t.get(e)),
                a = l.get(e) || []
              for (const e of s) a.push(...e.contextMenuActions())
              l.set(e, a)
            }
            s.set(e, l)
          }
          return (function (e, t, s, i, l, a) {
            const o = [],
              n = i.get(0)
            if (void 0 !== n) {
              const e = n.get(1)
              void 0 !== e &&
                e.length > 0 &&
                (o.push(...e), o.push(new He.Separator()))
            }
            const r = e
              .model()
              .properties()
            ...
            if (
              (o.push(
                new He.Action({
                  ...
                  onExecute: () => ze(e, r.showSeriesTitle, Oe)
                })
              ),
              t.showOpenMarketStatus &&
                o.push(
                  new He.Action({
                    ...
                    checkable: !0,
                    checked: Ne.showMarketOpenStatusProperty.value(),
                    label: Ze,
                    statName: 'Show Open market status',
                    onExecute: () => ze(e, Ne.showMarketOpenStatusProperty, Fe)
                  })
                ),
              o.push(
                new He.Action({
                  ...
                  onExecute: () => ze(e, r.showSeriesOHLC, Re)
                })
              ),
              o.push(
                new He.Action({
                  ...
                  onExecute: () => ze(e, r.showBarChange, Ue)
                })
              ),
              o.push(
                new He.Action({
                  ...
                  onExecute: () => ze(e, r.showVolume, $e)
                })
              ),
              o.push(new He.Separator()),
              void 0 !== n)
            ) {
              const e = n.get(0)
              void 0 !== e &&
            ...
            if (
              (o.push(
                new He.Action({
                  ...
                  onExecute: () => ze(e, r.showStudyTitles, je)
                })
              ),
              o.push(
                new He.Action({
                  ...
                  onExecute: () => ze(e, r.showStudyArguments, Ye)
                })
              ),
              o.push(
                new He.Action({
                  ...
                  onExecute: () => ze(e, r.showStudyValues, Ge)
                })
              ),
              void 0 !== d)
            ) {
            ...
            return (
              ...
              Be.ContextMenuManager.showMenu(
                o,
                l,
                void 0,
          ...
          s > -1
            ? (e.splice(s, 1),
              ji ||
                ...
                (this._mainSeriesStatusWidget = new Oi(
                  t,
                  this._model.model(),
        ...
        addMargin(e) {
          ...
          ;(this._renderer.getElement().style.maxWidth =
            0 === this._margin ? '' : `calc(100% - ${this._margin + Gi}px)`),
        ...
        _updateCollapsedSourcesMode() {
          ...
          if (this._availableHeight > 0 && e > 2) {
            const t = Number(this._renderer.getMainSourceHeight()),
              s = this._renderer.getDataSourceHeight(),
              i = this._getCustomWidgetsHeight()
            if (null !== s) {
              const l = Math.floor((this._availableHeight - t - i) / s),
                a = Math.max(l, 2) - 1
              if (e > a + 1) {
                let t = ''
                for (let s = 0; s < e; s++) {
                ...
                return (
                  this._collapsedDataSourcesTitle.setValue(t),
        ...
        _getCustomTextColorValue() {
          const e = this._model
            ...
            .textColor.value()
          return (0, Fi.isStdThemedDefaultValue)(
            'chartProperties.scalesProperties.textColor',
            e,
            (0, Fi.getCurrentTheme)().name
          )
            ? null
            : e
        }
        ...
        _addCustomWidgetForLayerBlock(e) {
          ...
          for (const l of Array.from(t.keys())) {
            const a = s.get(l) || [],
              o = t.get(l) || []
            for (let t = a.length; t < o.length; t++) {
              const s = o[t](this._model.model(), this._backgroundThemeName)
              0 === e &&
                0 === l &&
                s.setGlobalVisibility(this._hideNotMainSources.opposite()),
                a.push(s),
        ...
        _availableWidth() {
          return null === this._size ? 0 : this._size.w - this._margin - Gi
        }
      }
    },
    17904: (e, t, s) => {
      'use strict'
      s.r(t), s.d(t, { PaneControlsWidget: () => F })
      var i = s(96404),
        l = s(79881),
        a = s(42028),
        o = s(17e3),
      ...
      class _ {
        ...
        updateWidgetModeByWidth(e) {
          const t = !this._doNotSwitchToContextMenuMode.value() && e < 356,
            ...
            i = (0, n.ensureNotNull)(this._listActionsWrapperEl),
            l = (0, n.ensureNotNull)(this._listActionsElements.more)
          i.classList.toggle(c.blockHidden, t || s),
            l.classList.toggle(
              c.blockHidden,
        ...
        _renderActions() {
          ...
          const e = d.trackingModeIsAvailable ? 'large' : 'small'
          ...
          for (const e of Object.keys(this._listActionsElements))
            (0, n.ensureNotNull)(this._listActionsElements[e]).classList.add(
              u.newButton
            )
          this._parentEl.append(this._listActionsElements.more)
        }
        _updateActionVisibilities(e, t) {
          ;(0, n.ensureNotNull)(this._listActionsElements[e]).classList.toggle(
            c.blockHidden,
            !t
          )
        }
        _updateActionTitle(e, t) {
          ;(0, n.ensureNotNull)(this._listActionsElements[e]).setAttribute(
            'title',
            t
          )
        }
        ...
        _updatePaneControlsWidgetVisibility() {
          ...
          this._parentEl.classList.toggle(u.hidden, !e),
            this._parentEl.classList.toggle(
              u.forceHidden,
        ...
        _updateThemedColor(e) {
          if (e.length > 0) {
            const [t, s, i] = (0, r.parseRgb)(e)
            this._parentEl.style.color = (0, r.rgbaToString)([
              t,
              s,
              i,
              (0, r.normalizeAlphaComponent)(0.8)
      ...
      var S = s(32856),
        ...
        x = s(63970),
        D = s(72110)
      const L = i.mobiletouch,
        A = (0, l.t)('Delete pane'),
        H = (0, l.t)('Move pane up'),
        B = (0, l.t)('Move pane down'),
        N = (0, l.t)('Maximize pane'),
        P = (0, l.t)('Restore pane'),
        I = (0, l.t)('Manage panes'),
        z = (0, l.t)('Double click'),
        O = (0, C.hotKeySerialize)({ keys: [''], text: z })
      class F {
        constructor(e, t, s, i, l) {
          ;(this._actions = {}),
            (this._moreCMShown = !1),
            (this._themedColor = new (M())('')),
            (this._model = e),
            (this._paneWidget = t),
            (this._callbacks = i),
            (this._closeButtonVisibility = new (M())(
              this._getCloseButtonVisibility()
            )),
            (this._upButtonVisibility = new (M())(
              this._getUpButtonVisibility()
            )),
            (this._downButtonVisibility = new (M())(
              this._getDownButtonVisibility()
            )),
            (this._maximizeButtonVisibility = new (M())(
              this._getMaximizeButtonVisibility()
            )),
            (this._minimizeButtonVisibility = new (M())(
            ...
            (this._visibilityType = new (M())(
              this._visibilityTypeProperty.value()
            )),
            (this._isPaneMaximize = new (M())(this._getIsPaneMaximizeValue())),
            (this._isWidgetShow = new (M())(this._getIsWidgetShow())),
            (this._backgroundThemeName = s.backgroundThemeName),
            (this._renderer = new _(l, this._actions, {
        ...
        _getCloseButtonVisibility() {
          ...
          return (
            e.containsMainSeries() ||
              e.isMaximized() ||
              L ||
              (t = e.dataSources().some((e) => (0, o.isStudy)(e))),
            t
          )
        }
        _onCloseButton() {
        ...
        _getUpButtonVisibility() {
          const e = this._paneWidget.state()
          return (
            this._model.model().panes().indexOf(e) > 0 && !e.isMaximized() && !L
          )
        }
        _getDownButtonVisibility() {
          const e = this._paneWidget.state(),
            t = this._model.model().panes()
          return t.indexOf(e) < t.length - 1 && !e.isMaximized() && !L
        }
        _onUpDownButton(e) {
          const t = this._model
            .model()
        ...
        _getMaximizeButtonVisibility() {
          const e = this._paneWidget.state()
          return (
            this._model.model().panes().length > 1 && !e.isMaximized() && !L
          )
        }
            ...
            this._moreCMShown ||
              (function (e, t, s) {
                ...
                if (e.maximize.visible.value()) {
                  const t = (0, n.ensure)(e.maximize.title),
                    s = (0, n.ensureNotNull)(e.maximize.action)
                  i.push(
                    new p.Action({
                  ...
                  const t = (0, n.ensure)(e.minimize.title),
                    s = (0, n.ensureNotNull)(e.minimize.action)
                  i.push(
                    new p.Action({
                ...
                if (e.up.visible.value()) {
                  const t = (0, n.ensure)(e.up.title),
                    s = (0, n.ensureNotNull)(e.up.action)
                  i.push(
                    new p.Action({
                ...
                if (e.down.visible.value()) {
                  const t = (0, n.ensure)(e.down.title),
                    s = (0, n.ensureNotNull)(e.down.action)
                  i.push(
                    new p.Action({
                ...
                if (e.close.visible.value()) {
                  const t = (0, n.ensure)(e.close.title),
                    s = (0, n.ensureNotNull)(e.close.action)
                  i.push(
                    new p.Action({
                ...
                const l = (0, n.ensureNotNull)(t.target).getBoundingClientRect()
                return m.ContextMenuManager.showMenu(
                  i,
                  {
                    clientX: l.right,
    ...
    3330: (e, t, s) => {
      ...
      var i = s(47903)
      function l(e, t, s, l, a) {
        const o = document.createElement('div')
        ;(o.className = t),
          o.classList.toggle(l, !e.visible.value()),
          Object.assign(o.dataset, e.dataset),
          void 0 !== e.className && o.classList.add(e.className),
          void 0 !== e.title &&
            (o.classList.add('apply-common-tooltip'),
            o.setAttribute('title', e.title.value()),
            void 0 !== e.hotKeyTitle &&
              (o.dataset.tooltipHotkey = e.hotKeyTitle)),
          o.addEventListener('touchend', e.action),
          o.addEventListener('mousedown', (t) => {
            0 === t.button && e.action(t)
          })
        const n = document.createElement('div')
        n.classList.add(s)
        const r = e.iconMap.get(a) || ''
        return (
    ...
    92882: (e, t, s) => {
      ...
      const i = s(43367).CheckMobile.any()
    },
    59726: (e, t, s) => {
      'use strict'
      function i(e, t, s, i, l) {
        ...
        return (
          l.click && i.addEventListener('click', a, !1),
          l.mouseDown && i.addEventListener('mousedown', a, !1),
          l.touchEnd && i.addEventListener('touchend', a, !1),
          l.touchStart && i.addEventListener('touchstart', a, !1),
          () => {
    ...
    75533: (e, t, s) => {
      'use strict'
      s.d(t, { weekDaysShortNames: () => a, weekDaysMiniNames: () => o })
      var i = s(79881),
        l = s(10165)
      l.Months.JANUARY,
        (0, i.t)('January'),
