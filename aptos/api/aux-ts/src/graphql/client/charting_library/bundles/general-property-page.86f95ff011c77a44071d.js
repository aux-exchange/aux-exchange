  ...
  [3596],
  {
    24249: (e, t, i) => {
      ...
      const P = new u.TranslatedString(
        ...
        f = new u.TranslatedString(
          'change symbol legend format',
          (0, n.t)('change symbol legend format')
        ),
        ...
        w = new u.TranslatedString(
          ...
          (0, n.t)('change OHLC values visibility')
        ),
        S = new u.TranslatedString(
          'change bar change visibility',
          (0, n.t)('change bar change visibility')
        ),
        ...
        L = new u.TranslatedString(
          'change volume values visibility',
          (0, n.t)('change volume values visibility')
        ),
        V = (0, n.t)('Symbol'),
        M = (0, n.t)('OHLC values'),
      ...
      function N(e, t, i, r, n) {
        ...
        const g = (function (e, t) {
          return null !== t && o.enabled('buy_sell_buttons')
            ? (0, l.createCheckablePropertyDefinition)(
                {
                  checked: (0, l.convertFromWVToDefinitionProperty)(
                    e,
        ...
        null !== g &&
          a.push(
            (0, l.createPropertyDefinitionsGeneralGroup)(
              [g],
              'sellBuyButtonsLegendVisibilityGroup'
            )
          )
        const y = [],
      ...
      const U = new u.TranslatedString(
        ...
        Y = new u.TranslatedString(
          'change no overlapping labels',
          (0, n.t)('change no overlapping labels')
        ),
        ...
        $ = new u.TranslatedString(
          ...
          (0, n.t)('change currency label visibility')
        ),
        ee = new u.TranslatedString(
          'change unit label visibility',
          (0, n.t)('change unit label visibility')
        ),
        te = new u.TranslatedString(
          'change plus button visibility',
          (0, n.t)('change plus button visibility')
        ),
        ie = new u.TranslatedString(
          'toggle lock scale',
          (0, n.t)('toggle lock scale')
        ),
        re = new u.TranslatedString(
          'change price to bar ratio',
          (0, n.t)('change price to bar ratio')
        ),
        ne = new u.TranslatedString(
          'change date format',
          (0, n.t)('change date format')
        ),
        ...
        le =
          ((0, n.t)('Indicators and financials value labels'),
          (0, n.t)('Indicators value labels')),
        ce =
          ((0, n.t)('Bid and ask labels'),
          (0, n.t)('Pre/post market price label'),
          (0, n.t)('Countdown to bar close')),
        he = (0, n.t)('Currency'),
        pe = (0, n.t)('Unit'),
        ...
        ve = [
          ...
          {
            value: j.PriceAxisLastValueMode.LastValueAccordingToScale,
            title: (0, n.t)('Value according to scale')
          }
        ]
      const Pe = new u.TranslatedString(
          'change chart background color',
          (0, n.t)('change chart background color')
        ),
        fe = new u.TranslatedString(
          'change chart background type',
          (0, n.t)('change chart background type')
        ),
        me = new u.TranslatedString(
          'change vert grid lines color',
          (0, n.t)('change vert grid lines color')
        ),
        we = new u.TranslatedString(
          'change vert grid lines style',
          (0, n.t)('change vert grid lines style')
        ),
        Se = new u.TranslatedString(
          'change horz grid lines color',
          (0, n.t)('change horz grid lines color')
        ),
        De = new u.TranslatedString(
          'change horz grid lines style',
          (0, n.t)('change horz grid lines style')
        ),
        Te = new u.TranslatedString(
          'change intraday interval property',
          (0, n.t)('change intraday interval property')
        ),
        _e = new u.TranslatedString(
          'change sessions breaks visibility',
          (0, n.t)('change sessions breaks visibility')
        ),
        ke = new u.TranslatedString(
          'change sessions breaks color',
          (0, n.t)('change sessions breaks color')
        ),
        Ce = new u.TranslatedString(
          'change sessions breaks width',
          (0, n.t)('change sessions breaks width')
        ),
        Le = new u.TranslatedString(
          'change sessions breaks style',
          (0, n.t)('change sessions breaks style')
        ),
        Ve = new u.TranslatedString(
          'change scales text color',
          (0, n.t)('change scales text color')
        ),
        Me = new u.TranslatedString(
          'change scales font size',
          (0, n.t)('change scales font size')
        ),
        xe = new u.TranslatedString(
          'change scales lines color',
          (0, n.t)('change scales lines color')
        ),
        Oe = new u.TranslatedString(
          'change crosshair color',
          (0, n.t)('change crosshair color')
        ),
        ze = new u.TranslatedString(
          'change crosshair width',
          (0, n.t)('change crosshair width')
        ),
        Ge = new u.TranslatedString(
          'change crosshair style',
          (0, n.t)('change crosshair style')
        ),
        ...
        He = new u.TranslatedString(
          ...
          (0, n.t)('change symbol watermark color')
        ),
        ...
        Ne = new u.TranslatedString(
          ...
          (0, n.t)('change pane buttons visibility')
        ),
        Ee = new u.TranslatedString(
          'change top margin',
          (0, n.t)('change top margin')
        ),
        Re = new u.TranslatedString(
          'change bottom margin',
          (0, n.t)('change bottom margin')
        ),
        je = new u.TranslatedString(
          'change right margin',
          (0, n.t)('change right margin')
        ),
        We = (0, n.t)('Background'),
      ...
      function dt() {
        ...
        return it.availableDateFormats.map((t) => ({
          value: t,
          title: new nt.DateFormatter(t).format(e)
        }))
      }
      const gt = [
        {
      ...
      class yt {
        ...
        destroy() {
          ...
          null !== this._propertyPages &&
            ...
            null === (e = this._pipValueTypeSpawn) ||
              void 0 === e ||
              e.destroy(),
            this._series
              .onStyleChanged()
        ...
        _createSeriesViewModel() {
          ...
          return new g.SeriesPropertyDefinitionsViewModel(
            this._series,
            this._undoModel,
            'symbol',
            st,
          ...
          const e = this._chartWidgetProperties
            ...
            i = N(
              ...
              this._options.marketStatusWidgetEnabled
                ? y.showMarketOpenStatusProperty
                : null,
              pt
            )
        ...
        _createScalesDefinitions() {
          const e = this._chartWidgetProperties
            ...
            t = {
              ...
              values: (0, d.allPriceScaleSelectionStrategyInfo)().map((e) => ({
                value: e.name,
                title: e.title
              }))
            },
          ...
          return (function (e, t, i, r) {
              ...
              d = (0, l.createCheckablePropertyDefinition)(
                {
                  checked: (0, l.convertToDefinitionProperty)(
                    ...
                    (t) => {
                      e.beginUndoMacro(K),
                        e.setProperty(h.highLowPriceLabelsVisible, t, null),
                        e.endUndoMacro()
                    },
                    () => p.destroy()
                  )
                ...
                {
                  id: 'highLowAverageClosePriceLabels',
            ...
            a.push(
              (0, l.createPropertyDefinitionsGeneralGroup)(
                c,
                'generalScalesLabelsGroup'
              )
            )
            const y = (0, l.createNumberPropertyDefinition)(
                {
                  checked: (0, l.getLockPriceScaleDefinitionProperty)(
                    e,
                    n.lockScale,
                    r.seriesPriceScale,
                    ie
                  ),
                  value: (0, l.getScaleRatioDefinitionProperty)(
                    e,
                    r.mainSeriesScaleRatioProperty,
                    re,
                    [(0, W.limitedPrecision)(7), (e) => e]
                  )
                },
                {
                  id: 'lockScale',
              ...
              u = (0, l.createOptionsPropertyDefinition)(
                {
                  option: (0,
                  l.getPriceScaleSelectionStrategyDefinitionProperty)(
                    e,
                ...
                },
                {
                  id: 'scalesPlacement',
                  title: ge,
                  options: new (s())(r.scalesPlacementPropertyObj.values)
                }
              )
            if ((a.push(y, u), o.enabled('scales_date_format'))) {
              const t = (0, l.createOptionsPropertyDefinition)(
                ...
                },
                {
                  id: 'dateFormat',
                  title: ye,
                  options: new (s())(r.dateFormatPropertyObj.values)
                }
              )
              a.push(t)
            }
            ...
            b = (function (e, t, i, r, n, a, c, h, p) {
                ...
                g = (0, l.createColorPropertyDefinition)(
                  {
                    ...
                    gradientColor1: (0, l.getColorDefinitionProperty)(
                      e,
                      t.backgroundGradientStartColor,
                      null,
                      Pe
                    ),
                    gradientColor2: (0, l.getColorDefinitionProperty)(
                      e,
                      t.backgroundGradientEndColor,
                      null,
                      Pe
                    ),
                    type: (0, l.convertToDefinitionProperty)(
                      e,
                      t.backgroundType,
                      fe
                    )
              ...
              const _ = (0, l.createNumberPropertyDefinition)(
                ...
                C = (0, l.createNumberPropertyDefinition)(
                  {
                    value: (0, l.convertFromWVToDefinitionProperty)(
                      e,
                      c.value,
                      je,
                      [W.floor]
              ...
              return (
                o.enabled('chart_property_page_right_margin_editor') &&
                  L.push(C),
                L
              )
            })(
