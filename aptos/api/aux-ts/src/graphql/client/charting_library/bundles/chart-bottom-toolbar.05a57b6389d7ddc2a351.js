          ...
          const { className: e, withMenu: t } = this.props,
            ...
            s =
              void 0 !== this._timezone
                ? (0, se.parseTzOffset)(this._timezone.name()).string
                : null
          return i.createElement(
            le,
              ...
              super(e, t),
                ...
                (this._handleSelect = () => {
                  ...
                  t.priceScale().isLockScale() ||
                    e.setPriceScaleMode({ log: !i.log }, n, ye)
                }),
                (0, _.validateRegistry)(t, { chartWidget: o.any.isRequired }),
                (this.state = { isActive: !1, series: null }),
                (this._priceAxisHighlighter = new fe(
                ...
                super(e, t),
                  ...
                  (this._handleSelect = () => {
                    const e = this.context.chartWidget.model(),
                      ...
                      i = n.mode()
                    t.priceScale().isLockScale() ||
                      e.setPriceScaleMode({ percentage: !i.percentage }, n, Me)
                  }),
                  (0, _.validateRegistry)(t, { chartWidget: o.any.isRequired }),
                  (this.state = { isActive: !1, series: null }),
                  (this._priceAxisHighlighter = new fe(
            ...
            i.createElement(
              ...
              n &&
                i.createElement(
                  ...
                  i.createElement(
                    'div',
                    {
                      className: r(Ne.inline, e.timeZones && Ne.collapsed),
              ...
              i.createElement(
                'div',
                {
                  ...
                  className: r(Ne.inline, e.separator && Ne.collapsed)
                },
              ...
              i.createElement(
                ...
                s &&
                  ...
                  i.createElement(ze, { className: Ne.icon }),
    ...
    10284: (e, t, n) => {
      ...
      function o(e) {
        return i.createElement('div', {
          className: s(a.separator, e.className)
        })
      }
    },
    95860: (e, t, n) => {
      ...
      function u(e) {
        ...
        return i.createElement(
          h,
          {
            ...
            role: n,
            'aria-selected': c,
            className: s(u, W.item, _ && W.withIcon, {
              [W.isActive]: f,
              [W.isDisabled]: C || E,
              [W.hovered]: y
            }),
          ...
          void 0 !== R &&
            i.createElement(
              ...
              {
                onClick: B ? d : void 0,
                className: s(W.toolbox, { [W.showOnHover]: M })
              },
              R
            )
        )
