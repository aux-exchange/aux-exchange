  ...
  [731],
  {
    ...
    42857: (e, t, n) => {
          ...
          o.createElement(S.SymbolSearchDialogContentItem, {
            ...
            onClick: function (t) {
              ...
              if ((a.mobiletouch ? A : !D) && n) {
                ;(0, i.getSymbolSearchCompleteOverrideFunction)()(n).then(
                  (e) => {
      ...
      var B = n(58726),
        ...
        W = n(32526)
      function H(e) {
        const { handleListWidth: t } = (0, m.ensureNotNull)(
            (0, o.useContext)(w.SymbolSearchItemsDialogContext)
          ),
          {
            compareModel: n,
            selectedCompareIndex: a,
            selectedItemRef: l
          } = (0, m.ensureNotNull)((0, o.useContext)(C)),
            ...
            o.createElement(
              ...
              (function () {
                if (!i)
                  return o.createElement(
                    'div',
                    { className: W.spinnerWrap },
                    o.createElement(f.Spinner, null)
                  )
                if (!Boolean(x.length) && !Boolean(y.length)) {
                  ...
                  return o.createElement(
                    ...
                    o.createElement(
                      'div',
                      { className: W.text },
                      (0, r.t)('No symbols here yet — why not add some?')
                    )
                  )
                }
                return o.createElement(
        ...
        constructor(e) {
          super(e),
            ...
            (this._toggleAllowExtendTimeScale = () => {
              ...
              F.setValue('showAddSymbolDialog.extendCheckboxState', e),
            ...
            (this.state = {
              ...
              allowExtendTimeScale: Boolean(
                F.getBool('showAddSymbolDialog.extendCheckboxState')
              )
            })
        }
        render() {
            ...
            onKeyDown: function (e) {
              ...
              switch (c) {
                ...
                case 13: {
                  ...
                  e.preventDefault()
                  const r =
                    null === (o = null == n ? void 0 : n.current) ||
                    void 0 === o
                      ? void 0
                      : o.value.trim()
                  r &&
      ...
      var $ = n(3627),
        ...
        te = n(94905)
      function ne(e) {
        const { searchRef: t, setMode: n } = (0, y.useEnsuredContext)(
            w.SymbolSearchItemsDialogContext
          ),
          { currentMode: r } = (0, y.useEnsuredContext)(
            te.SymbolSearchDialogBodyContext
          )
        return (
          (0, o.useEffect)(() => {
            const e = t.current
            ...
            '' ===
              ...
              ? 'symbolSearch' === r.current &&
                '' ===
                  (null ===
                    (l =
                      null === (a = null == t ? void 0 : t.current) ||
                      void 0 === a
                        ? void 0
                        : a.value) || void 0 === l
                    ? void 0
      ...
      function le(e) {
        ...
        m.ensureNotNull)((0, o.useContext)(C))
        return o.createElement(
          ...
          o.createElement(
            'label',
            null,
            o.createElement(oe.CheckboxInput, {
              checked: t,
              value: t ? 'on' : 'off',
              onChange: n
            }),
      ...
      function ce(e) {
        return new Z({
          wrapper:
            ((t = e), (e) => o.createElement(V, { ...e, compareModel: t })),
          dialog: Q,
          contentItem: A,
          initialScreen: H,
          searchInput: ne,
          ...
          (0, o.useEffect)(() => {
            ...
            return (
              ...
              () => {
                ...
                d.CheckMobile.iOS() && (0, l.enableBodyScroll)(e),
                  0 === t && (0, i.setFixedBodyState)(!1)
              }
            )
          }, []),
          o.createElement(
      ...
      function m(e) {
        ...
        return o.createElement(
          d,
          {
            ...
            role: n,
            'aria-selected': s,
            className: r(m, P.item, g && P.withIcon, {
              [P.isActive]: w,
              [P.isDisabled]: S || x,
              [P.hovered]: C
            }),
          ...
          void 0 !== M &&
            o.createElement(
              ...
              {
                onClick: O ? u : void 0,
                className: r(P.toolbox, { [P.showOnHover]: I })
              },
              M
            )
        )
