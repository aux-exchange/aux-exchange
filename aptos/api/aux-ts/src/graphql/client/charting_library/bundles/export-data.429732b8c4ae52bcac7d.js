    ...
    70867: (e, t, s) => {
      ...
      function d(e, t = {}) {
        ...
        const g = (function (e, t, s, l) {
            const o = (0, i.ensureNotNull)(
                void 0 !== s ? e.indexOf(s, !0) : e.firstIndex()
              ),
              c = (0, i.ensureNotNull)(
            ...
            return (
              (0, i.assert)(r <= u, 'Range must contain at least 1 time point'),
              new n.BarsRange(r, u)
            )
          })(o, T, s.from, s.to),
          y = g.firstBar(),
        ...
        for (let e = y; e <= P; ++e) {
          ...
          e.fill(NaN),
            l.data.push(e),
            s.includeDisplayedValues &&
              l.displayedData.push(new Array(x).fill(''))
        }
        if (s.includeTime || s.includeUserTime) {
          ...
          for (let e = y; e <= P; ++e) {
            s.includeTime &&
              (l.data[e - y][0] = (0, i.ensureNotNull)(o.valueAt(e)))
            const a = (0, i.ensureNotNull)(t.indexToUserTime(e))
            if (
              (s.includeUserTime && (l.data[e - y][S] = a.getTime() / 1e3),
              s.includeDisplayedValues)
            ) {
              const t = n.format(a)
              s.includeTime && (l.displayedData[e - y][0] = t),
                s.includeUserTime && (l.displayedData[e - y][S] = t)
            }
          }
        }
        if (s.includeSeries) {
      ...
      function f(e) {
        ...
        for (let c = 0; c < t.plots.length; ++c) {
          ...
          const f = `${u.title}${d}`
          s.fields.push(h(n, a, f)),
            s.fieldToPlotIndex.push(c + 1),
            s.fieldPlotOffsets.push(e.offset(r.id))
        }
        return s
      }
      function h(e, t, s) {
