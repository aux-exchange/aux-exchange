const config = {
  ...
  environments: {
    mainnet: {
      title: 'Mainnet',
      url: 'https://aptos-mainnet.vybenetwork.xyz/',
      rest_graphql_endpoint: 'https://aptos-mainnet.vybenetwork.xyz/graphql',
      ws_graphql_endpoint: 'wss://aptos-mainnet.vybenetwork.xyz/graphql',
